...
"GET_DDL('DATABASE', 'DB_IAW_ACCP_STG',TRUE)"
create or replace database DB_IAW_ACCP_STG;

create or replace schema DB_IAW_ACCP_STG.DATALAKE;

create or replace schema DB_IAW_ACCP_STG.EXTERNAL_KPI;

create or replace TABLE DB_IAW_ACCP_STG.EXTERNAL_KPI.REF_MASTER_KPI_DATA_CLARINGTON (
...
create or replace TABLE DB_IAW_ACCP_STG.EXTERNAL_KPI.REF_MASTER_KPI_DATA_IAPW (
	HK_HUB VARCHAR(40) COMMENT ' Hash key for the Hub ',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT ' Start Date of the image/version ',
	MD_HASHDIFF VARCHAR(40) COMMENT ' Represents the whole set of hashed attributes to be historized for an occurrence ',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT ' Creation Date Time of the occurrence ',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.EXTERNAL_KPI.REF_MASTER_KPI_DATA_INVESTIA (
	HK_HUB VARCHAR(40) COMMENT ' Hash key for the Hub ',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT ' Start Date of the image/version ',
	MD_HASHDIFF VARCHAR(40) COMMENT ' Represents the whole set of hashed attributes to be historized for an occurrence ',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT ' Creation Date Time of the occurrence ',
...
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.EXTERNAL_KPI.CSV_UTF8
	TYPE = csv
	FIELD_DELIMITER = ';'
	SKIP_HEADER = 1
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.EXTERNAL_KPI.SP_CONV_LOADSTG_PSA_IAPW_TO_STG_MASTER_KPI_DATA_CLARINGTON(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.EXTERNAL_KPI.SP_CONV_LOADSTG_PSA_IAPW_TO_STG_MASTER_KPI_DATA_IAPW(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.EXTERNAL_KPI.SP_CONV_LOADSTG_PSA_IAPW_TO_STG_MASTER_KPI_DATA_INVESTIA(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.EXTERNAL_KPI.SP_CONV_LOADSTG_PSA_IAPW_TO_STG_REF_MASTER_KPI_DATA_CLARINGTON(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.EXTERNAL_KPI.SP_CONV_LOADSTG_PSA_IAPW_TO_STG_REF_MASTER_KPI_DATA_IAPW(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.IAPW_PORTAL_API;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ACCOUNTS_CLIENTS_SUMMARY (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ACCOUNTS_CLIENTS_SUMMARY_RVP (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYACCOUNTTYPE (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYACCOUNTTYPE_RVP (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYCOMMISSIONTYPE (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYCOMMISSIONTYPE_AND_PRODUCT (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYCOMMISSIONTYPE_AND_PRODUCT_RVP (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYCOMMISSIONTYPE_RVP (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYPRODUCT (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYPRODUCT_RVP (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYPROVINCE (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAPW_PORTAL_API.ASSETS_SUMMARY_BYPROVINCE_RVP (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
...
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ACCOUNTS_CLIENTS_SUMMARY(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ACCOUNTS_CLIENTS_SUMMARY_RVP(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYACCOUNTTYPE(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYACCOUNTTYPE_RVP(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYCOMMISSIONTYPE(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYCOMMISSIONTYPE_AND_PRODUCT(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYCOMMISSIONTYPE_AND_PRODUCT_RVP(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYCOMMISSIONTYPE_RVP(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYPRODUCT(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYPRODUCT_RVP(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYPROVINCE(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
create or replace view DB_IAW_ACCP_STG.IAPW_PORTAL_API.VW_ASSETS_SUMMARY_BYPROVINCE_RVP(
	MD_START_DT,
	MD_SOURCE,
	MD_CREATION_DT,
	MD_SRC_SYSTEM,
...
LATERAL FLATTEN(INPUT => a.CONTENT, PATH => '""data""') ft;
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.IAPW_PORTAL_API.JSON_FORMAT
	TYPE = json
	NULL_IF = ()
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ACCOUNTS_CLIENTS_SUMMARY(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ACCOUNTS_CLIENTS_SUMMARY_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_BYCOMMISSIONTYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_BYCOMMISSIONTYPE_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_BYPRODUCT(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_BYPRODUCT_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_BY_COMMISSIONTYPE_AND_PRODUCT(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_BY_COMMISSIONTYPE_AND_PRODUCT_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_LAST_13_MONTHS_BYCOMMISSIONTYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAPW_PORTAL_API_TO_ASSETS_SUMMARY_LAST_13_MONTHS_BYPRODUCT(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAWP_PORTAL_API_TO_ASSETS_SUMMARY_BYACCOUNTTYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAWP_PORTAL_API_TO_ASSETS_SUMMARY_BYACCOUNTTYPE_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAWP_PORTAL_API_TO_ASSETS_SUMMARY_BYPROVINCE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAPW_PORTAL_API.SP_CONV_LOADSTG_PSA_IAWP_PORTAL_API_TO_ASSETS_SUMMARY_BYPROVINCE_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.IAS;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS.ACCOUNT_HOLDER (
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS.CASH_HOLDINGS (
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS.CONTRACT (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS.FINANCIAL_TRANSACTIONS_IAVMBK (
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS.HOLDINGS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(40) COMMENT 'Hash key for HUB_REGISTERED_REPRESENTATIVE',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS.INVESTMENT_PRODUCT_TYPE (
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS.REF_INVESTMENT_SAVING_PROGRAM_TYPES (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace view DB_IAW_ACCP_STG.IAS.VW_CONTRACT(
	HK_LINK,
	MD_HASHDIFF,
	HK_HUB_CONTRACT,
...
MD_EXTRACT_DT
FROM IAS.CONTRACT;
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.IAS.PIPE_UTF16
	TYPE = csv
	FIELD_DELIMITER = '|'
	...
	ENCODING = 'UTF-16'
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_IAS_NBIN_TO_STG_FINANCIAL_TRANSACTIONS_IAVMBK(""ENV"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_IAS_NBIN_TO_STG_FINANCIAL_TRANSACTIONS_IAVMBK_IAPW(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_REVENUE_PAYABLE(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_FUNDATA_TO_STG_FUND(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_POSITION_PRICE_IAS_IAVM_IAPW(""ENV"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_REF_HOLIDAYS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_NBIN_TO_STG_CASH_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_NBIN_TO_STG_CLIENTS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_NBIN_TO_STG_CONTRACT(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_NBIN_TO_STG_FINANCIAL_TRANSACTIONS_IAVMBK(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_NBIN_TO_STG_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_NBIN_TO_STG_INVESTMENT_PRODUCT_TYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_CONV_LOADSTG_PSA_IAS_NBIN_TO_STG_PLANS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_LOADSTG_PSA_IAS_COMMISSION_TO_STG_REVENUES(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_LOADSTG_PSA_IAS_NBIN_TO_STG_CASH_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_LOADSTG_PSA_IAS_NBIN_TO_STG_CLIENTS(""ENV"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.SP_LOADSTG_PSA_IAS_NBIN_TO_STG_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS.TEST1(""ENV"" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '';
create or replace schema DB_IAW_ACCP_STG.IAS_CERTS;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_CERTS.REGISTERED_REPRESENTATIVE (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	...
	FIRST_NAME VARCHAR(500) MASKING POLICY #unknown_policy COMMENT 'Representative first name',
	LAST_NAME VARCHAR(500) MASKING POLICY #unknown_policy COMMENT 'Representative last name',
	FULL_NAME VARCHAR(1000) MASKING POLICY #unknown_policy COMMENT 'Representative full name',
	...
	BRANCH_NAME VARCHAR(500) MASKING POLICY #unknown_policy COMMENT 'Name of the representative branch',
	...
	TRADE_NAME VARCHAR(2000) MASKING POLICY #unknown_policy COMMENT 'Trade name exp: Tradenames_#118048',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_CERTS.REGISTERED_REPRESENTATIVE_RECEPTION (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_EXTRACT_DT TIMESTAMP_NTZ(9) COMMENT 'Extraction date of the occurrence',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	CID VARCHAR(500) COMMENT 'Source Account ID exp: #100002',
...
create or replace view DB_IAW_ACCP_STG.IAS_CERTS.VW_REGISTERED_REPRESENTATIVE_SPLIT(
	MD_START_DT,
	MD_EXTRACT_DT,
	MD_SOURCE,
	CID,
...
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.IAS_CERTS.PIPE_UTF16
	TYPE = csv
	FIELD_DELIMITER = '|'
	ESCAPE_UNENCLOSED_FIELD = 'NONE'
	NULL_IF = ('0000-00-00')
	ENCODING = 'UTF-16'
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_CERTS.SP_CONV_LDSTG_PSA_IAS_CERT_TO_STG_REG_REP_REC_IAS_CERTS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_CERTS.SP_CONV_LOADSTG_SPLIT_VIEW_TO_STG_REG_REP_IAS_CERTS(""ENV"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.IAS_COMMISSION;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_COMMISSION.INSURANCE_REVENUES (
	HK_LINK VARCHAR(40) COMMENT 'Hash of the business keys',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_COMMISSION.REGISTERED_REPRESENTATIVE (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	HK_SAT VARCHAR(40) COMMENT 'Hash of the Satellite for the multi-active keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	...
	REPNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Representative name',
	FIRSTNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Representative first name',
	LASTNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Representative last name',
	BRANCHCODE VARCHAR(50) COMMENT 'Code of the representative branch code',
	BRANCHNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Name of the representative branch',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_COMMISSION.REGISTERED_REPRESENTATIVE_RECEPTION (
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
	MD_EXTRACT_DT TIMESTAMP_NTZ(9) COMMENT 'Extraction date of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_COMMISSION.REVENUES (
	HK_LINK VARCHAR(40) COMMENT 'Hash of the business keys',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_COMMISSION.SHARE (
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_COMMISSION.SHAREHIST (
...
create or replace view DB_IAW_ACCP_STG.IAS_COMMISSION.REGISTERED_REPRESENTATIVE_CLEAN(
	MD_START_DT,
	MD_SOURCE,
	MD_SRC_SYSTEM,
	MD_EXTRACT_DT,
...
create or replace view DB_IAW_ACCP_STG.IAS_COMMISSION.VW_HUB_REGISTERED_REPRESENTAVIVE(
	HK_HUB,
	REPID,
	MD_SRC_SYSTEM,
	MD_SOURCE,
...
create or replace view DB_IAW_ACCP_STG.IAS_COMMISSION.VW_SHARE_AUD(
	HK_LINK,
	HK_HUB_FROM,
	HK_HUB_TO,
	MD_HASHDIFF,
...
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.IAS_COMMISSION.PIPE_UTF16
	TYPE = csv
	FIELD_DELIMITER = '|'
	ESCAPE_UNENCLOSED_FIELD = 'NONE'
	NULL_IF = ('0000-00-00')
	ENCODING = 'UTF-16'
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.""DB_IAW_ACCP_STG.IAS.SP_LOADSTG_PSA_IAS_COMMISSION_TO_STG_REVENUES""(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.""DB_IAW_ACCP_STG.IAS_COMMISSION.SP_LOADSTG_PSA_IAS_COMMISSION_TO_STG_REVENUES""(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LDSTG_PSA_IAS_COMSN_TO_STG_REG_REP_COMM_REC(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LOADSTG_IAS_COMMISSION_TO_STG_REVENUES(""ENV"" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS ' 
...
INS_QUERY = ""INSERT INTO DB_IAW_<env>_stg.IAS_COMMISSION.REVENUES(MD_START_DT	,	"" +
""MD_SRC_SYSTEM,		"" +
""REPID	,"" +
""ADVISOR_ID	,"" +	
""PROGRAM_TYPE,	"" +	
...
""NETCOMMISSION,	"" +
""TRANSFEE"" +
"" FROM DB_IAW_<env>_stg.IAS_COMMISSION.PRODUCTION_SHARE_TEST_REVENUES)"" ;
...
var sql_statement2 = snowflake.createStatement({
 ...
 var update_query = ""UPDATE DB_IAW_<env>_stg.IAS_COMMISSION.REVENUES 	"" +
""SET 	"" +
...
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LOADSTG_IAS_COMMISSION_TO_STG_SHARE(""ENV"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LOADSTG_IAS_COMMISSION_TO_STG_SHAREHIST_IAS_COMMISSION(""ENV"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD''''),
STAMP,
''''DB_IAW_''||ENV||''_STAGING_POCIA.IAS_COMMISSION.SHAREHIST'''',
HISTID,
HISTOPERATION ,
HISTSTAMP ,
HISTUSERID ,
...
''''IAS''''
FROM DB_IAW_''||ENV||''_STAGING_POCIA.IAS_COMMISSION_POCIA.SHAREHIST;
'';
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LOADSTG_PSA_IAS_COMMISSION_TO_STG_INSURANCE_REVENUES(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LOADSTG_PSA_IAS_COMMISSION_TO_STG_REGREP(""ENV"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LOADSTG_PSA_IAS_COMMISSION_TO_STG_REVENUES(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_CONV_LOADSTG_PSA_IAS_COMMISSION_TO_STG_SHARE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_COMMISSION.SP_LOADSTG_PSA_IAS_COMMISSION_TO_STG_REVENUES(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.IAS_FUNDATA;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_FUNDATA.FUND (
	HK_HUB VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.IAS_FUNDATA.PIPE_UTF16
	TYPE = csv
	FIELD_DELIMITER = '|'
	ESCAPE_UNENCLOSED_FIELD = 'NONE'
	NULL_IF = ('0000-00-00')
	ENCODING = 'UTF-16'
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_FUNDATA.SP_CONV_LOADSTG_PSA_IAS_FUNDATA_TO_STG_FUND(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_FUNDATA.SP_LOADSTG_PSA_IAS_FUNDATA_TO_STG_FUND(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.IAS_IAVM;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_IAVM.ACCRUED_INTEREST (
	HK_LINK VARCHAR(40) COMMENT 'Hash of the business keys',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_IAVM.POSITION_PRICE (
	HK_LINK VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_IAVM.REF_EXCHANGE_RATE (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_IAVM.REF_HOLIDAYS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_IAVM.REF_MAPPING_PRODUCT_TYPE (
	HK_HUB VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_IAVM.REGISTERED_REPRESENTATIVE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	...
	TEAMNAME VARCHAR(256) MASKING POLICY #unknown_policy COMMENT 'The advisor team name: IA HOUSE',
	RVPID NUMBER(38,0) COMMENT 'VP Rep ID',
	RVPNAME VARCHAR(256) MASKING POLICY #unknown_policy COMMENT 'VP Name',
	REPID VARCHAR(12) COMMENT 'Representative ID',
	REPNAME VARCHAR(250) MASKING POLICY #unknown_policy COMMENT 'Representative Name: SMITH JOHN',
	PROVINCE VARCHAR(12) COMMENT 'Province Code : ON'
);
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.IAS_IAVM.PIPE_UTF16
	TYPE = csv
	FIELD_DELIMITER = '|'
	ESCAPE_UNENCLOSED_FIELD = 'NONE'
	NULL_IF = ('0000-00-00')
	ENCODING = 'UTF-16'
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_IAVM.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_ACCRUED_INTEREST(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_IAVM.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_POSITION_PRICE_IAS_IAVM(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_IAVM.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_REF_EXCHANGE_RATE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_IAVM.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_REF_HOLIDAYS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_IAVM.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_REF_HOLIDAYSS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_IAVM.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_REF_MAPPING_PRODUCT_TYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_IAVM.SP_CONV_LOADSTG_PSA_IAS_IAVM_TO_STG_REGISTERED_REPRESENTATIVE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.IAS_UNIVERIS;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.ACCOUNT_HOLDER (
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.CONTRACT (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.FINANCIAL_TRANSACTIONS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.HOLDINGS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_SEQ VARCHAR(50) COMMENT 'The value of METADATA$FILE_ROW_NUMBER when loading using INFORMATICA',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.INVESTMENT_PRODUCT_TYPE (
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.PLN_SRF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.REF_INVESTMENT_SAVING_PROGRAM_TYPES (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.REGISTERED_REPRESENTATIVE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	...
	COMPANY_NAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Company name : iA Wealth Management',
	...
	BRN_NAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'The advisor branch name',
	REP_TEAM_CD VARCHAR(50) COMMENT 'The advisor team code',
	REP_TEAM_NAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'The advisor team name',
	REP_SYSID NUMBER(38,0) COMMENT 'Univeris ID of the advisor rep code',
	NK_REP_CD VARCHAR(50) COMMENT 'Advisor rep code',
	NK_REP_CORP_NAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Corporation name of the advisor',
	REP_LNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Advisor last name',
	REP_FNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Advisor first name',
	REP_ST_NAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Advisor status : Active, Terminated,...',
	REP_GRP_RSP VARCHAR(512)
);
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.REVENUE_PAYABLE (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.IAS_UNIVERIS.S_COM_PRODUCTION (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace view DB_IAW_ACCP_STG.IAS_UNIVERIS.VW_CONTRACT(
	HK_LINK,
	MD_HASHDIFF,
	HK_HUB_CONTRACT,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
...
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.IAS_UNIVERIS.PIPE_UTF16
	FIELD_DELIMITER = '|'
	ENCODING = 'UTF16LE'
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_IAS_UNIVERIS_TO_STG_COM_PRODUCTION(""ENV"" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_IAS_UNIVERIS_TO_STG_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_REVENUE_PAYABLE(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_CONTRACT(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_CLIENTS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_FINANCIAL_TRANSACTIONS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_INVESTMENT_PRODUCT_TYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_PLANS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_PLN_SRF(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_REF_COM_PROD(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_REGISTERED_REPRESENTATIVE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_REVENUE_PAYABLE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.IAS_UNIVERIS.SP_LOADSTG_IAS_UNIVERIS_TO_STG_COM_PRODUCTION(""ENV"" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
create or replace schema DB_IAW_ACCP_STG.INVESTIA;

create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA.ACCOUNT_HOLDER (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace schema DB_IAW_ACCP_STG.INVESTIA_UNIVERIS;

create or replace TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.ACCOUNT_HOLDER (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.CONTRACT (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.FINANCIAL_TRANSACTIONS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.HOLDINGS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_SEQ VARCHAR(50) COMMENT 'The value of METADATA$FILE_ROW_NUMBER when loading using INFORMATICA',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.PLN_SRF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.REF_INVESTMENT_SAVING_PROGRAM_TYPES (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.REF_PROVINCE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.REGISTERED_REPRESENTATIVE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	...
	REP_CORP_NAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Corporation name of the advisor',
	REP_LNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Advisor last name',
	REP_FNAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Advisor first name',
	REP_ST_NAME VARCHAR(512) MASKING POLICY #unknown_policy COMMENT 'Advisor status : Active, Terminated,...',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.REVENUE_PAYABLE (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.S_COM_PRODUCTION (
	HK_HUB VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.WRAP_FEE (
	HK_LINK VARCHAR(40) COMMENT 'Hash of the business keys',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TABLE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.X_DBB_MASTER_REP (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
	HK_HUB_FROM VARCHAR(64) COMMENT 'Hash of the business keys',
	HK_HUB_TO VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace view DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.VW_CONTRACT(
	HK_LINK,
	MD_HASHDIFF,
	HK_HUB_CONTRACT,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
...
MD_SRC_SYSTEM,
MD_EXTRACT_DT
FROM DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.CONTRACT;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_FINANCIAL_TRANSACTIONS(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_HOLDINGS_DEL(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_REVENUE_PAYABLE(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_INVESTIA_UNIVERIS_TO_STG_TRAILER_FEES(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_FUNDEX_UNIVERIS_TO_STG_X_DBB_MASTER_REP_FUNDEX(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_IAS_UNIVERIS_TO_STG_PLANS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_TO_STG_INVESTMENT_PRODUCT_TYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_CLIENTS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_CLIENTS_RF_TEST(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_CONTRACT(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_FINANCIAL_TRANSACTIONS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_HOLDINGS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_PLANS(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_PLN_SRF(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_REF_COM_PROD(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_REF_PROVINCE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_REGISTERED_REPRESENTATIVE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_REVENUE_PAYABLE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_WRAP_FEE(""ENV"" VARCHAR(10000), ""IO_PATH"" VARCHAR(10000))
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_X_DBB_MASTER_REP(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_X_DBB_MASTER_REP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.INVESTIA_UNIVERIS.SP_CONV_LOADSTG_PSA_INVESTIA_UNIVERIS_TO_STG_X_DBB_MASTER_REP_UNIVERIS(""ENV"" VARCHAR(1000), ""IO_FILE_NAME"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.PUBLIC;

create or replace schema DB_IAW_ACCP_STG.STEWARDSHIP;

create or replace TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_KPI_TARGET_FIRM (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_KPI_TARGET_RVP (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the hub',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_MANUAL_ADVISOR_RVP (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_MAPPING_OPER_TYPE (
	HK_HUB VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_MONTHLY_MILESTONES (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_NEW_ADVISOR (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	...
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system',
	MD_EXTRACT_DT TIMESTAMP_NTZ(9) COMMENT 'Extraction date of the occurrence',
	ADVISOR_NAME VARCHAR(100) MASKING POLICY #unknown_policy COMMENT 'Advisor name',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_ORGANIC_GROWTH_EXCEPTIONS_IAPW (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_PRODUCT_ASSET_CATEGORY (
	HK_HUB VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_RAPCODE_PLAN (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TRANSIENT TABLE DB_IAW_ACCP_STG.STEWARDSHIP.REF_SERVICING_CODES (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
...
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.STEWARDSHIP.CSV_UTF8
	TYPE = csv
	FIELD_DELIMITER = ';'
;
CREATE OR REPLACE FILE FORMAT DB_IAW_ACCP_STG.STEWARDSHIP.PIPE_UTF16
	TYPE = csv
	FIELD_DELIMITER = '|'
	ESCAPE_UNENCLOSED_FIELD = 'NONE'
	NULL_IF = ('0000-00-00')
	ENCODING = 'UTF-16'
;
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LDSTG_PSA_IAS_COMSN_TO_STG_REG_REP_COMM_RECEPTION(""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADBDV_RDV_STEWARDSHIP_IAPW_TO_WT_SERVICING_CODES(""ENV"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADDSTG_PSA_IAPW_TO_STG_REF_ORGANIC_GROWTH_EXCEPTIONS_IAPW(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_IAS_STEWARDSHIP_TO_STG_REF_MAPPING_OPER_TYPE(""ENV"" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS ' 
...
var sql_statement3 = snowflake.createStatement({ 
 ...
 var result3_scan = sql_statement3.execute(); 
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_IAS_TO_STG_REF_MANUAL_ADVISOR_RVP(""ENV"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_IAS_TO_STG_REF_MONTHLY_MILESTONES(""ENV"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_IAS_TO_STG_REF_PRODUCT_ASSET_CATEGORY(""ENV"" VARCHAR(1000), ""I_DATA_START_DATE"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_IAS_TO_STG_REF_RAPCODE_PLAN(""ENV"" VARCHAR(16777216), ""IO_PATH"" VARCHAR(16777216))
RETURNS VARCHAR(10000)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT
	''''2019-01-01'''',
	''''DB_IAW_''||ENV||''_DATAMART_POCIA.BR.IAS_RAPCODE_PLAN'''',
	ACCOUNT_RAP_CODE,
	RETAIL_PLAN,
	PLAN_LABEL,
	ACCOUNT_TYPE,
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_IAPW_TO_STG_REF_NEW_ADVISOR(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_IAPW_TO_STG_REF_SERVICING_CODES(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_IAS_STEWARDSHIP_TO_STG_REF_MAPPING_OPER_TYPE(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_IAS_TO_STG_REF_MANUAL_ADVISOR_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_IAS_TO_STG_REF_MONTHLY_MILESTONES(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_IAS_TO_STG_REF_PRODUCT_ASSET_CATEGORY(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_IAS_TO_STG_REF_RAPCODE_PLAN(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_STEWARDSHIP_TO_STG_REF_KPI_TARGET_FIRM(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE DB_IAW_ACCP_STG.STEWARDSHIP.SP_CONV_LOADSTG_PSA_STEWARDSHIP_TO_STG_REF_KPI_TARGET_RVP(""ENV"" VARCHAR(1000), ""IO_PATH"" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
create or replace schema DB_IAW_ACCP_STG.TEST;

create or replace TABLE DB_IAW_ACCP_STG.TEST.TEST (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
...
create or replace schema DB_IAW_ACCP_STG.TOOLS;
