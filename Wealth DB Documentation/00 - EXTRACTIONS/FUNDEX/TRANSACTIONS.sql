SELECT 
	...
	TRX.RGN_SYSID,
	TRX.BRN_SYSID,
	TRX.TRX_GROSS*(CASE WHEN isnull(TRX.CURRENCY_CD,'') = 'USD' THEN isnull((select TOP 1 CONV_RATE from CURRENCY_CONV (nolock) WHERE CONV_DT <= TRX.TRADE_DT ORDER BY CONV_DT DESC ),1) ELSE 1 END ) AS TRX_GROSS,
