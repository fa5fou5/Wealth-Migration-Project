...
use schema  HOLDINGS_BDV;

create or replace TABLE LINK_INVESTMENT (
...
create or replace TABLE SAT_LINK_INVESTMENT (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
...
create or replace TABLE WT_INVESTMENT_CASH_IAS_NBIN (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace TABLE WT_INVESTMENT_IAS_NBIN (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace TABLE WT_INVESTMENT_IAS_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace TABLE WT_INVESTMENT_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace view VW_INITIAL_LOADING_INVESTMENT_CASH_IAS_NBIN(
	MD_SEQ,
	HK_LINK,
	HK_HUB_CONTRACT,
...
create or replace view VW_INITIAL_LOADING_INVESTMENT_IAS_NBIN(
	MD_SEQ,
	HK_LINK,
	HK_HUB_CONTRACT,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
...
create or replace view VW_INITIAL_LOADING_INVESTMENT_INVESTIA_UNIVERIS(
	HK_HUB_CONTRACT,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
...
LEFT JOIN LATEST_VERSION_CONTRACT CONTRACT 
	...
	AND CONTRACT.MD_ACTIVE = 'A' AND CONTRACT.RANK_CONTRACT = 1;
create or replace view VW_INVESTMENT(
	HK_LINK,
	HK_HUB_CONTRACT,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
create or replace view VW_INVESTMENT_CASH_IAS_NBIN(
	HK_LINK,
	HK_HUB_CONTRACT,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
SELECT 
	...
	DECODE(WT.A_C_CURRENCY,'USD',WT.CASH_VALUE*WT.EXCHANGERATE,WT.CASH_VALUE) * COALESCE(WT.COMMISSIONPCT,100) * 0.01 						AS AUA,
	0 																																		AS AUM,
	0 																																		AS AUM_CLARINGTON,	
	0 																																		AS AUM_IA,
	DECODE(WT.A_C_CURRENCY,'USD',WT.CASH_VALUE*WT.EXCHANGERATE,WT.CASH_VALUE) * COALESCE(WT.COMMISSIONPCT,100) * 0.01 						AS CASH_POSITION,
...
create or replace view VW_INVESTMENT_IAS_NBIN(
	HK_LINK,
	HK_HUB_CONTRACT,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
WHERE 
	...
	AND E.REPID IS NULL
	AND (WT.RR_CD NOT IN ('SEAA', 'SEZ9', 'QYYY'));
create or replace view VW_INVESTMENT_IAS_UNIVERIS(
	HK_LINK,
	HK_HUB_CONTRACT,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
AND MV > 0 
AND E.REPID IS NULL;
create or replace view VW_INVESTMENT_INVESTIA_UNIVERIS(
	HK_LINK,
	HK_HUB_CONTRACT,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
CREATE OR REPLACE PROCEDURE "LOADBDV_RDV_HOLDINGS_TO_BDV_WT_LINK_INVESTMENT_IAS_UNIVERIS"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
 
INS_QUERY = "insert into DB_IAWT_ENV_DWH.HOLDINGS_BDV.WT_INVESTMENT_IAS_UNIVERIS(HK_HUB_CONTRACT	,  " +
" MD_SEQ	," +
"HK_HUB_INVESTMENT_PRODUCT_TYPE	,	" +
"MD_EXTRACT_DT	, " +
"MD_SOURCE	, " +
...
"from DB_IAWT_ENV_DWH.HOLDINGS_RDV.SAT_LINK_INVESTMENT_RR_IAS_UNIVERIS as mstr join DB_IAWT_ENV_DWH.HOLDINGS_RDV.LINK_INVESTMENT_RR_IAS_NBIN as dtls " +
...
" as	Link_Investment_Contract_RR_RR_CD from DB_IAWT_ENV_DWH.shared_RDV.LINK_INVESTMENT_CONTRACT_RR) as dtls " +
...
" from t3 as mstr join DB_IAWT_ENV_DWH.shared_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE as dtls on mstr.hk_link = dtls.hk_link )" +
...
", t7 as (select * from t6 join DB_IAWT_ENV_DWH.shared_RDV.HUB_INVESTMENT_PRODUCT_TYPE dtls on SAT_INVESTMENT_PRODUCT_hk_hub = hk_hub)" +
...
" from DB_IAWT_ENV_DWH.shared_RDV.SAT_CONTRACT_IAS_UNIVERIS as mstr" +
" join (select HK_HUB,max(md_start_dt) as max_md_start_dt from   DB_IAWT_ENV_DWH.shared_RDV.SAT_CONTRACT_IAS_UNIVERIS where MD_START_DT <= TO_DATE(''" + IO_START_DATE + "'',''YYYY-MM-DD'') " +
"group by HK_HUB) as dtls " +
"on mstr.HK_HUB = dtls.hk_HUB and mstr.md_start_dt = dtls.max_md_start_dt where mstr.md_active=''A'')" +
...
"ADMINISTRATOR_TYPE	" +
"	 from t10 left outer join DB_IAWT_ENV_DWH.shared_BDV.LINK_INVESTMENT_CONTRACT as dtls on link_Investment_RR_HK_HUB_CONTRACT  =  dtls.HK_HUB_CONTRACT " +
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_CASH_HOLDINGS_TO_BDV_WT_LINK_INVESTMENT_CASH_IAS_NBIN"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_HOLDINGS_TO_BDV_WT_LINK_INVESTMENT_IAS_NBIN"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
"and link_Commission_HK_HUB_PARTY_ROLE_ADVISOR = HK_HUB_PARTY_ROLE_ADVISOR)"
 ...
 var result_scan = sql_statement.execute();	 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_HOLDINGS_TO_BDV_WT_LINK_INVESTMENT_IAS_UNIVERIS"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_HOLDINGS_TO_BDV_WT_LINK_INVESTMENT_INVESTIA_UNIVERIS"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
 
INS_QUERY = "insert into DB_IAWT_ENV_DWH.HOLDINGS_BDV.WT_INVESTMENT_INVESTIA_UNIVERIS(HK_HUB_CONTRACT	,  " +
" MD_SEQ	," +
"HK_HUB_INVESTMENT_PRODUCT_TYPE	,	" +
"MD_EXTRACT_DT	, " +
"MD_SOURCE	, " +
...
",MD_START_DT as	sat_link_Investment_RR_MD_START_DT " +
" ,HK_HUB_REGISTERED_REPRESENTATIVE as  link_Investment_RR_HK_HUB_REGISTERED_REPRESENTATIVE " +
"from DB_IAWT_ENV_DWH.HOLDINGS_RDV.SAT_LINK_INVESTMENT_RR_INVESTIA_UNIVERIS as mstr join DB_IAWT_ENV_DWH.HOLDINGS_RDV.LINK_INVESTMENT_RR_IAS_NBIN as dtls " +
"on mstr.HK_LINK = dtls.HK_LINK where MD_START_DT = TO_DATE(''" + IO_START_DATE + "'',''YYYY-MM-DD'') AND MD_ACTIVE = ''A'') " +
",t2 as (select * from t1 as mstr join (select HK_HUB_CONTRACT,HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER as Link_Investment_Contract_RR_HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,RR_CD " +
" as	Link_Investment_Contract_RR_RR_CD from DB_IAWT_ENV_DWH.shared_RDV.LINK_INVESTMENT_CONTRACT_RR) as dtls " +
"on link_Investment_RR_HK_HUB_CONTRACT = HK_HUB_CONTRACT)" +
...
", t8 as (select * from t5 left outer join t7 on SAT_INVESTMENT_PRODUCT_hk_hub = hk_hub )" +
",t9 as ( select mstr.HK_HUB as uneiveris_HK_HUB, mstr.ADMINISTRATOR_TYPE as ADMINISTRATOR_TYPE" +
" from DB_IAWT_ENV_DWH.shared_RDV.SAT_CONTRACT_INVESTIA_UNIVERIS as mstr" +
" join (select HK_HUB,max(md_start_dt) as max_md_start_dt from   DB_IAWT_ENV_DWH.shared_RDV.SAT_CONTRACT_INVESTIA_UNIVERIS where MD_START_DT <= TO_DATE(''" + IO_START_DATE + "'',''YYYY-MM-DD'') " +
"group by HK_HUB) as dtls " +
"on mstr.HK_HUB = dtls.hk_HUB and mstr.md_start_dt = dtls.max_md_start_dt where mstr.md_active=''A'')" +
", t10 as (select * from t8 left outer join t9 on SAT_INVESTMENT_PRODUCT_hk_hub = uneiveris_HK_HUB)" +
"select  " +
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_VW_INITIAL_LOADING_INVESTMENT_CASH_TO_WT_INVESTMENT_CASH"("ENV" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS ' 
var trunc_query = "TRUNCATE table DB_IAWT_DEV_DWH.HOLDINGS_BDV.WT_INVESTMENT_CASH_IAS_NBIN";
var trunc_query_ENV = trunc_query.replaceAll("_dev_","_"+ ENV + "_");
var sql_statement1 = snowflake.createStatement({
  sqlText: trunc_query_ENV
});
var result1_scan = sql_statement1.execute(); 
INS_QUERY = "INSERT INTO  DB_IAWT_DEV_DWH.HOLDINGS_BDV.WT_INVESTMENT_CASH_IAS_NBIN (HK_LINK, "+
"HK_HUB_CONTRACT, "+
"HK_HUB_INVESTMENT_PRODUCT_TYPE, "+
"HK_HUB_PARTY_ROLE_ADVISOR, "+
"HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, "+
...
"EXCHANGERATE, "+
"A_C_ACCOUNT_CLASS, "+
"RETAIL_PLAN_RESP FROM DB_IAWT_DEV_DWH.HOLDINGS_BDV.VW_INITIAL_LOADING_INVESTMENT_CASH_IAS_NBIN) "
;
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_VW_INITIAL_LOADING_INVESTMENT_TO_WT_INVESTMENT"("ENV" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS ' 
var delete_query = "DELETE FROM DB_IAWT_DEV_DWH.HOLDINGS_BDV.WT_INVESTMENT_INVESTIA_UNIVERIS WHERE 1=1";
var delete_query_ENV = delete_query.replaceAll("_DEV_","_"+ ENV + "_");
var sql_statement1 = snowflake.createStatement({
  sqlText: delete_query_ENV
});
var result1_scan = sql_statement1.execute(); 
INS_QUERY = "INSERT INTO DB_IAWT_DEV_DWH.HOLDINGS_BDV.WT_INVESTMENT_INVESTIA_UNIVERIS(HK_HUB_CONTRACT, " +
"HK_HUB_INVESTMENT_PRODUCT_TYPE , " +
"HK_HUB_PARTY_ROLE_ADVISOR	,  " +
"HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER	, " + 
"HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES	 , " +
...
"IVD_LOAD_FLAG	, " +
"WF_IND	 " +
"FROM DB_IAWT_DEV_DWH.HOLDINGS_BDV.VW_INITIAL_LOADING_INVESTMENT_INVESTIA_UNIVERIS);" 
var INS_QUERY_ENV = INS_QUERY.replaceAll("_DEV_","_"+ ENV + "_");
var sql_statement2 = snowflake.createStatement({
  sqlText: INS_QUERY_ENV
});
 var result2_scan = sql_statement2.execute(); 
 var update_query = "UPDATE DB_IAWT_DEV_DWH.HOLDINGS_BDV.WT_INVESTMENT_INVESTIA_UNIVERIS "+
"SET "+
...
EXECUTE AS OWNER
AS ' 
var delete_query = "DELETE FROM DB_IAWT_DEV_DM.EXPOLORATION.IAS_COMMISSION_REVENUES WHERE 1=1";
var delete_query_ENV = delete_query.replaceAll("_DEV_","_"+ ENV + "_");
var sql_statement1 = snowflake.createStatement({
  sqlText: delete_query_ENV
});
var result1_scan = sql_statement1.execute(); 
INS_QUERY = "INSERT INTO DB_IAWT_DEV_DM.EXPOLORATION.IAS_COMMISSION_REVENUES("HK_LINK , " +
"HK_HUB_CONTRACT	, " +
"HK_HUB_PARTY_ROLE_ADVISOR	, " +	
"MD_CREATION_DT	, " +
"MD_START_DT	, " +
...
';
use schema  HOLDINGS_RDV;

create or replace TABLE LINK_INVESTMENT_RR_IAS_NBIN (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
...
create or replace TABLE SAT_LINK_INVESTMENT_CASH_RR_IAS_NBIN (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_INVESTMENT_IAS_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_INVESTMENT_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_INVESTMENT_RR_IAS_NBIN (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_INVESTMENT_RR_IAS_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TABLE SAT_LINK_INVESTMENT_RR_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
var sql_command = "INSERT INTO  DB_AV_"+ ENV + "_DWH.RDV.HUB_COVERAGE (HK_HUB_COVERAGE,COVERAGE_IDENTIFIER,MD_SOURCE,MD_CREATION_AUDIT_ID,MD_USER,MD_CREATION_DT) VALUES \\
...
';
use schema  REVENUES_BDV;

create or replace TABLE LINK_REVENUE (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
...
create or replace TABLE VW_INITIAL_LOADING_WT_LINK_REVENUE (
	PLAN_ID VARCHAR(40),
	MARKETPRODUCT_ID VARCHAR(40),
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40),
	...
	REVENUE NUMBER(38,12),
	REVENUE_TYPE VARCHAR(512),
	REVENUE_SUBTYPE VARCHAR(512)
);
create or replace TABLE VW_REVENUE_IAS_COMMISSION (
	HK_LINK VARCHAR(40),
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40),
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40),
	HK_HUB_REF_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40),
...
create or replace TABLE WT_LINK_REVENUE (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	HK_HUB_REF_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40) COMMENT 'Hash key for the REF_INVESTMENT_SAVING_PROGRAM_TYPES',
...
create or replace view VW_INITIAL_LOADING_INVESTIA_REVENUE_PAYABLE_WT_LINK_REVENUE(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
...
FROM
	REVENUES_RDV.SAT_LINK_REVENUE_PAYABLE_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
    ON SLR.HK_LINK = LR.HK_LINK
...
LATEST_VERSION_COM_PRODUCTION AS 
(          
SELECT
	SLR.HK_LINK,
	SLR.MD_START_DT,
	SC.COM_PRODUCTION_CD, 
	SC.COM_PRODUCTION_MNEM, 
	SC.COM_PRODUCTION_LONG_DESC,
	COALESCE (SC.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,SC.COM_PRODUCTION_CD ORDER BY SC.MD_START_DT DESC ),1) AS RANK_CP
FROM
	REVENUES_RDV.SAT_LINK_REVENUE_PAYABLE_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
    ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN (
            SELECT  SC.MD_ACTIVE ,SC.MD_START_DT ,R.COM_PRODUCTION_CD, SC.COM_PRODUCTION_MNEM, SC.COM_PRODUCTION_LONG_DESC 
            FROM REVENUES_RDV.SAT_REF_COM_PRODUCTION_INVESTIA_UNIVERIS SC 
            INNER JOIN REVENUES_RDV.REF_COM_PRODUCTION R 
            ON SC.HK_HUB=R.HK_HUB
            ) SC 
    ON SC.COM_PRODUCTION_CD = SLR.COM_PRODUCTION_CD 
	AND SC.MD_START_DT <= SLR.MD_START_DT          	
),
LATEST_VERSION_BDV_INVESTMENT_CONTRACT AS (
SELECT 
	SLR.HK_LINK,
	...
	COALESCE (SLC.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,LR.HK_HUB_CONTRACT ORDER BY SLC.MD_START_DT DESC ),1) AS RANK_CONTRACT
FROM REVENUES_RDV.SAT_LINK_REVENUE_PAYABLE_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR
	ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN LATEST_VERSION_SHARE COMM_SHARE
	ON COMM_SHARE.HK_LINK = SLR.HK_LINK
...
SELECT  DISTINCT
	CON.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, 
	COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR, 
	CON.HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
	LR.HK_HUB_INVESTMENT_PRODUCT_TYPE, 
	LR.HK_HUB_CONTRACT, 
	TO_DATE(COALESCE(LR.PAYMENT_DT, LR.PROCESS_DT)) AS MD_START_DT, 
	LR.MD_SOURCE, 
	LR.MD_SRC_SYSTEM, 
	SLR.MD_EXTRACT_DT, 
	LR.IVR_SYSID AS CLIENT_ID, 
	COMM_SHARE.MASTER_CODE,  
	CON.PLN_MNEM,
	LR.IVD_SYSID AS MARKETPRODUCT_ID,
	COALESCE (LR.PAYMENT_DT, LR.PROCESS_DT) AS PAYMENT_DT,
	SLR.COM_BEN_PYBL * NVL(COMM_SHARE.COMMISSIONPCT,100) * 0.01 AS REVENUE, 
	CASE WHEN SLR.COM_PRODUCTION_CD IN ('02','10') THEN 'Trailers'
		 WHEN SLR.COM_PRODUCTION_CD = '35' THEN 'Fee based/Managed'
		 ELSE 'Trade commissions'
	END AS REVENUE_TYPE, 
	CASE WHEN COM_PRODUCTION.COM_PRODUCTION_MNEM IN ('MFTRX','BONUS','COMM') THEN 'Trade commissions'
		 WHEN COM_PRODUCTION.COM_PRODUCTION_MNEM IN ('ADJUS','OTHER') THEN 'Others'
		 WHEN COM_PRODUCTION.COM_PRODUCTION_MNEM IN ('REF','SREF') THEN 'Referals'
		 WHEN COM_PRODUCTION.COM_PRODUCTION_MNEM IN ('TOF','TF') THEN 'Charge back client fees'
 		 WHEN COM_PRODUCTION.COM_PRODUCTION_MNEM IN ('GICC') THEN 'GIC commissions'
		 ELSE COM_PRODUCTION.COM_PRODUCTION_LONG_DESC
	END AS REVENUE_SUBTYPE,
	LR.PAY_SYSID AS REVENUE_ID, 
	LR.PLN_SYSID 
FROM REVENUES_RDV.SAT_LINK_REVENUE_PAYABLE_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
	ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN LATEST_VERSION_SHARE COMM_SHARE
    ON COMM_SHARE.HK_LINK = SLR.HK_LINK 
    AND  COMM_SHARE.MD_ACTIVE = 'A' AND COMM_SHARE.RANK_SHARE = 1 
LEFT JOIN  LATEST_VERSION_COM_PRODUCTION COM_PRODUCTION
    ON SLR.HK_LINK = COM_PRODUCTION.HK_LINK
    AND COM_PRODUCTION.COM_PRODUCTION_CD = SLR.COM_PRODUCTION_CD
    AND  COM_PRODUCTION.MD_ACTIVE = 'A' AND COM_PRODUCTION.RANK_CP = 1 
LEFT JOIN LATEST_VERSION_BDV_INVESTMENT_CONTRACT CON
	ON CON.HK_LINK = SLR.HK_LINK
	AND CON.HK_HUB_PARTY_ROLE_ADVISOR =COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR
	AND CON.MD_ACTIVE = 'A' AND CON.RANK_CONTRACT = 1
WHERE SLR.COM_PRODUCTION_CD NOT IN ('02','20','21','22','23','24','25','26');
create or replace view VW_INITIAL_LOADING_INVESTIA_TRAILER_FEES_WT_LINK_REVENUE(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
...
SELECT
	...
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,SRR.HK_HUB ORDER BY SRR.MD_START_DT DESC ),1) AS RANK_RR
FROM
	REVENUES_RDV.SAT_LINK_REVENUE_TRAILER_FEES_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
    ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN SHARED_RDV.SAT_REGISTERED_REPRESENTATIVE_INVESTIA_UNIVERIS SRR 
    ON SRR.REP_SYSID = SLR.REP_SYSID
...
FROM LATEST_VERSION_REGISTERED_REPRESENTATIVE LVRR
	LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE
	    ...
	    ON LVRR.HK_HUB=COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE
	    AND  COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, LVRR.MD_START_DT) 
	    WHERE LVRR.MD_ACTIVE = 'A' AND LVRR.RANK_RR = 1
),
LATEST_VERSION_BDV_INVESTMENT_CONTRACT AS (
SELECT 
	SLR.HK_LINK,
...
COALESCE (SLC.MD_ACTIVE,'A') AS MD_ACTIVE,
COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,LR.HK_HUB_CONTRACT ORDER BY SLC.MD_START_DT DESC ),1) AS RANK_CONTRACT
FROM REVENUES_RDV.SAT_LINK_REVENUE_TRAILER_FEES_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR
	ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN LATEST_VERSION_SHARE COMM_SHARE
	ON COMM_SHARE.HK_LINK = SLR.HK_LINK
...
SELECT  DISTINCT
	...
	LR.IVR_SYSID,
	NULL AS CONTRACT_ID, 
	COMM_SHARE.MASTER_CODE AS ADVISOR_ID,
	COMM_SHARE.MASTER_CODE,
	CON.PLN_MNEM,
	LR.IVD_SYSID AS MARKETPRODUCT_ID,
	COALESCE (LR.PAYMENT_DT, LR.PROCESS_DT) AS PAYMENT_DT,
	SLR.COM_PYBL*NVL(SLR.EXCH_RATE,1)* NVL(COMM_SHARE.COMMISSIONPCT,1) AS REVENUE,
	'Trailers' AS REVENUE_TYPE, 
...
LEFT JOIN LATEST_VERSION_BDV_INVESTMENT_CONTRACT CON
	...
	AND CON.HK_HUB_PARTY_ROLE_ADVISOR =COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR
	AND CON.MD_ACTIVE = 'A' AND CON.RANK_CONTRACT = 1;
create or replace view VW_INITIAL_LOADING_INVESTIA_WRAP_FEES_WT_LINK_REVENUE(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
...
SELECT
	...
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,SRR.HK_HUB ORDER BY SRR.MD_START_DT DESC ),1) AS RANK_RR
FROM
	REVENUES_RDV.SAT_LINK_REVENUE_WRAP_FEE_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
    ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN SHARED_RDV.SAT_REGISTERED_REPRESENTATIVE_INVESTIA_UNIVERIS SRR 
    ON SRR.REP_SYSID = SLR.REP_SYSID
...
COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR,
COALESCE (SLC.MD_ACTIVE,'A') AS MD_ACTIVE,
COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,SLC.HK_LINK ORDER BY SLC.MD_START_DT DESC ),1) AS RANK_CONTRACT
FROM REVENUES_RDV.SAT_LINK_REVENUE_WRAP_FEE_RR_INVESTIA_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR
ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN LATEST_VERSION_SHARE COMM_SHARE
ON COMM_SHARE.HK_LINK = SLR.HK_LINK
...
SELECT DISTINCT 
	...
	LR.IVD_SYSID AS MARKETPRODUCT_ID,
	COALESCE (LR.PAYMENT_DT, LR.PROCESS_DT) AS PAYMENT_DT,
	SLR.FEE_AMT*NVL(COMM_SHARE.COMMISSIONPCT/100,1) AS REVENUE,
	'Fee based/Managed' AS REVENUE_TYPE, 
...
AND COMM_SHARE.MD_ACTIVE = 'A' AND COMM_SHARE.RANK_SHARE = 1
LEFT JOIN LATEST_VERSION_BDV_INVESTMENT_CONTRACT CON
ON CON.HK_LINK = SLR.HK_LINK AND CON.HK_HUB_PARTY_ROLE_ADVISOR = COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR
AND CON.MD_ACTIVE = 'A' AND CON.RANK_CONTRACT = 1
WHERE SLR.STATUS_CD = 'F' AND TRUNC(SLR.FISCAL_SYSID / 100) >= 2019;
create or replace view VW_INITIAL_LOADING_UNIVERIS_REVENUE_PAYABLE_WT_LINK_REVENUE(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_CONTRACT,
...
SELECT 
	X.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, 
	X.HK_HUB_PARTY_ROLE_ADVISOR, 
	X.HK_HUB_INVESTMENT_PRODUCT_TYPE, 
	X.HK_HUB_CONTRACT, 
	X.MD_START_DT, 
	X.MD_SOURCE, 
	X.MD_SRC_SYSTEM, 
...
(SELECT DISTINCT 
	...
	SLR.COM_BEN_PYBL * NVL(COMM_SHARE.COMMISSIONPCT,100) * 0.01 AS REVENUE, 
	CASE WHEN SLR.COM_PRODUCTION_CD IN ('02','10') THEN 'Trailers'
		 WHEN SLR.COM_PRODUCTION_CD = '37' THEN 'Fee based/Managed'
		 ELSE 'Trade commissions'
	END AS REVENUE_TYPE, 
	CASE WHEN COM_PRODUCTION.COM_PRODUCTION_MNEM IN ('MFTRX','BONUS','COMM') THEN 'Trade commissions'
		 WHEN COM_PRODUCTION.COM_PRODUCTION_MNEM IN ('ADJUS','OTHER') THEN 'Others'
	...
	LR.PAY_SYSID, 
	LR.PLN_SYSID,
    COALESCE (ROW_NUMBER() OVER (PARTITION BY LR.HK_LINK,COMM_SHARE.HK_LINK ORDER BY COMM_SHARE.MD_START_DT DESC ),1) AS RANK_SHARE,
    COALESCE (COMM_SHARE.MD_ACTIVE,'A') AS MD_ACTIVE
FROM REVENUES_RDV.SAT_LINK_REVENUE_PAYABLE_RR_IAS_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
	ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR LC 
	ON LC.HK_HUB_CONTRACT = LR.HK_HUB_CONTRACT 
LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE 
        	FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE LCS 
        	INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE CS 
    ...
    ON LC.HK_HUB_REGISTERED_REPRESENTATIVE=COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE
    AND  COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, COALESCE(LR.PAYMENT_DT, LR.PROCESS_DT)) 
LEFT JOIN 	( SELECT  R.COM_PRODUCTION_CD, SC.COM_PRODUCTION_MNEM, SC.COM_PRODUCTION_LONG_DESC 
            FROM REVENUES_RDV.SAT_REF_COM_PRODUCTION SC 
            INNER JOIN REVENUES_RDV.REF_COM_PRODUCTION R 
            	ON SC.HK_HUB=R.HK_HUB AND SC.MD_ACTIVE='A'
			) COM_PRODUCTION
    ON COM_PRODUCTION.COM_PRODUCTION_CD = SLR.COM_PRODUCTION_CD 
WHERE SLR.COM_PRODUCTION_CD NOT IN ('02','20','21','22','23','24','25','26')
) X
WHERE X.MD_ACTIVE = 'A' AND X.RANK_SHARE = 1;
create or replace view VW_INITIAL_LOADING_UNIVERIS_REVENUE_PAYABLE_WT_LINK_REVENUE_IHEB(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
...
WITH 
LATEST_VERSION_REGISTERED_REPRESENTATIVE AS(
SELECT --LR.PAYMENT_DT, LR.PROCESS_DT,
	SLR.HK_LINK,
	SLR.MD_START_DT,
	SRR.HK_HUB,
	COALESCE (SRR.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,SRR.HK_HUB ORDER BY SRR.MD_START_DT DESC ),1) AS RANK_RR
FROM
	REVENUES_RDV.SAT_LINK_REVENUE_PAYABLE_RR_IAS_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
    ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN SHARED_RDV.SAT_REGISTERED_REPRESENTATIVE_IAS_UNIVERIS SRR 
    ON SRR.REP_SYSID = SLR.REP_SYSID
	AND SRR.MD_START_DT <= SLR.MD_START_DT    
)
,LATEST_VERSION_SHARE AS (
...
FROM LATEST_VERSION_REGISTERED_REPRESENTATIVE LVRR
	LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE
	    ...
	    ON LVRR.HK_HUB=COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE
	    AND  COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, LVRR.MD_START_DT) 
	    --AND COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, COALESCE(LVRR.PAYMENT_DT, LVRR.PROCESS_DT))
	    AND  LVRR.MD_ACTIVE = 'A' AND LVRR.RANK_RR = 1
),
LATEST_VERSION_COM_PRODUCTION AS 
(          
...
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
    ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN (
            SELECT  SRC.MD_ACTIVE ,SRC.MD_START_DT ,R.COM_PRODUCTION_CD, SRC.COM_PRODUCTION_MNEM, SRC.COM_PRODUCTION_LONG_DESC 
            FROM REVENUES_RDV.SAT_REF_COM_PRODUCTION SRC 
            INNER JOIN REVENUES_RDV.REF_COM_PRODUCTION R 
            ON SRC.HK_HUB=R.HK_HUB
            ) SC 
    ON SC.COM_PRODUCTION_CD = SLR.COM_PRODUCTION_CD 
	AND SC.MD_START_DT <= SLR.MD_START_DT          	
)
...
LEFT JOIN  LATEST_VERSION_COM_PRODUCTION COM_PRODUCTION
    ON SLR.HK_LINK = COM_PRODUCTION.HK_LINK
    --AND COM_PRODUCTION.COM_PRODUCTION_CD = SLR.COM_PRODUCTION_CD --moch zeyda ligne hethi?
    AND  COM_PRODUCTION.MD_ACTIVE = 'A' AND COM_PRODUCTION.RANK_CP = 1 
LEFT JOIN LATEST_VERSION_BDV_INVESTMENT_CONTRACT CON
	ON CON.HK_LINK = SLR.HK_LINK
	AND CON.HK_HUB_PARTY_ROLE_ADVISOR =COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR
	AND CON.MD_ACTIVE = 'A' AND CON.RANK_CONTRACT = 1
WHERE SLR.COM_PRODUCTION_CD NOT IN ('02','20','21','22','23','24','25','26');
create or replace view VW_INITIAL_LOADING_UNIVERIS_REVENUE_PAYABLE_WT_LINK_REVENUE_NEW(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_CONTRACT,
...
LATEST_VERSION_INVESTMENT_CONTRACT AS (
	SELECT SLR.HK_LINK,
	SLR.MD_START_DT,
	LC.HK_HUB_REGISTERED_REPRESENTATIVE,
	LC.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	LC.CONTRACT_ID, 
	COALESCE (SLC.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,LR.HK_HUB_CONTRACT ORDER BY SLC.MD_START_DT DESC ),1) AS RANK_CONTRACT
	...
	LEFT JOIN SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR LC 
		ON LC.HK_HUB_CONTRACT = LR.HK_HUB_CONTRACT 
	LEFT JOIN  SHARED_RDV.SAT_LINK_INVESTMENT_CONTRACT_IAS_UNIVERIS SLC
	    ON SLC.HK_LINK = LC.HK_LINK 
	    
	    --WHERE LR.HK_HUB_CONTRACT = 'a2d948cb74b201f94c2a827275f32367f4bdc395'
)
,LATEST_VERSION_SHARE AS (
	SELECT 
	LVIC.HK_LINK,
	COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE,
	LVIC.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	LVIC.CONTRACT_ID,
	COMM_SHARE.MD_START_DT,
	COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR,
	COMM_SHARE.MASTER_CODE,
	COMM_SHARE.COMMISSIONPCT,
	COALESCE (COMM_SHARE.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY LVIC.HK_LINK,COMM_SHARE.HK_LINK ORDER BY COMM_SHARE.MD_START_DT DESC ),1) AS RANK_SHARE
FROM LATEST_VERSION_INVESTMENT_CONTRACT LVIC
	LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE
	        	FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE LCS 
	        	INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE CS 
	        		ON CS.HK_LINK=LCS.HK_LINK AND CS.MD_SRC_SYSTEM = 'IAS'
	    		) COMM_SHARE
	    ON LVIC.HK_HUB_REGISTERED_REPRESENTATIVE=COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE
	    AND  COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, LVIC.MD_START_DT) 
	    AND  LVIC.MD_ACTIVE = 'A' AND LVIC.RANK_CONTRACT = 1
)
SELECT DISTINCT 
	COMM_SHARE.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, 
	COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR, 
	LR.HK_HUB_INVESTMENT_PRODUCT_TYPE, 
	LR.HK_HUB_CONTRACT, 
	TO_DATE(COALESCE(LR.PAYMENT_DT, LR.PROCESS_DT)) AS MD_START_DT, 
...
LEFT JOIN 	( SELECT  R.COM_PRODUCTION_CD, SC.COM_PRODUCTION_MNEM, SC.COM_PRODUCTION_LONG_DESC 
    ...
    ON COM_PRODUCTION.COM_PRODUCTION_CD = SLR.COM_PRODUCTION_CD 
WHERE SLR.COM_PRODUCTION_CD NOT IN ('02','20','21','22','23','24','25','26');
create or replace view VW_INITIAL_LOADING_UNIVERIS_TRAILER_FEES_WT_LINK_REVENUE(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_CONTRACT,
...
(SELECT DISTINCT 
	...
	LR.HK_HUB_INVESTMENT_PRODUCT_TYPE, 
	LR.HK_HUB_CONTRACT, 
	TO_DATE(LR.PAYMENT_DT) AS MD_START_DT, 
	LR.MD_SOURCE, 
	LR.MD_SRC_SYSTEM, 
	SLR.MD_EXTRACT_DT, 
	LR.IVR_SYSID,
	...
	LR.IVD_SYSID,
	LR.PAYMENT_DT,
	SLR.COM_PYBL* NVL(SLR.EXCH_RATE,1)* NVL(COMM_SHARE.COMMISSIONPCT,100) * 0.01 AS REVENUE, 
	'Trailers' AS REVENUE_TYPE, 
	'Mutual Fund Servicing Commissions' AS REVENUE_SUBTYPE,
	LR.PAY_SYSID, 
	LR.PLN_SYSID,
    COALESCE (COMM_SHARE.MD_ACTIVE,'A') AS MD_ACTIVE,
    COALESCE (ROW_NUMBER() OVER (PARTITION BY LR.HK_LINK,COMM_SHARE.HK_LINK ORDER BY COMM_SHARE.MD_START_DT DESC ),1) AS RANK_SHARE	
FROM REVENUES_RDV.SAT_LINK_REVENUE_TRAILER_FEES_RR_IAS_UNIVERIS SLR
INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
	ON SLR.HK_LINK = LR.HK_LINK
LEFT JOIN SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR LC 
	ON LC.HK_HUB_CONTRACT = LR.HK_HUB_CONTRACT 
LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE 
    ...
    ON LC.HK_HUB_REGISTERED_REPRESENTATIVE=COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE
    AND  COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, COALESCE(LR.PAYMENT_DT,LR.PROCESS_DT)) 
LEFT JOIN SHARED_BDV.LINK_INVESTMENT_CONTRACT LIC 
	ON LIC.HK_HUB_CONTRACT = LR.HK_HUB_CONTRACT 
	AND LIC.HK_HUB_PARTY_ROLE_ADVISOR = COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR) X
WHERE X.RANK_SHARE = 1 AND X.MD_ACTIVE = 'A';
create or replace view VW_INITIAL_LOADING_UNIVERIS_TRAILER_FEES_WT_LINK_REVENUE_IHEB(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_CONTRACT,
...
WITH LATEST_VERSION_RDV_INVESTMENT_CONTRACT AS (
SELECT 
	SLR.HK_LINK,
	SLR.MD_START_DT,
	LC.HK_HUB_REGISTERED_REPRESENTATIVE,
	...
	LC.MD_SRC_SYSTEM , 
	COALESCE (SLC.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,LC.HK_HUB_CONTRACT ORDER BY SLC.MD_START_DT DESC ),1) AS RANK_CONTRACT_RR
	FROM REVENUES_RDV.SAT_LINK_REVENUE_TRAILER_FEES_RR_IAS_UNIVERIS SLR
	INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
		ON SLR.HK_LINK = LR.HK_LINK
	LEFT JOIN SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR LC 
...
LATEST_VERSION_SHARE AS (
	...
	COMM_SHARE.COMMISSIONPCT,
	COALESCE (COMM_SHARE.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,COMM_SHARE.HK_LINK ORDER BY COMM_SHARE.MD_START_DT DESC ),1) AS RANK_SHARE
	FROM REVENUES_RDV.SAT_LINK_REVENUE_TRAILER_FEES_RR_IAS_UNIVERIS SLR
	INNER JOIN REVENUES_RDV.LINK_REVENUE_RR LR 
		ON SLR.HK_LINK = LR.HK_LINK
    LEFT JOIN LATEST_VERSION_RDV_INVESTMENT_CONTRACT INVESTMENT_CONTRACT_RR
    	ON INVESTMENT_CONTRACT_RR.HK_LINK = SLR.HK_LINK 
    	AND  INVESTMENT_CONTRACT_RR.MD_ACTIVE = 'A' AND INVESTMENT_CONTRACT_RR.RANK_CONTRACT_RR = 1 
	LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE
	        	FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE LCS 
	        	INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE CS 
	        		ON CS.HK_LINK=LCS.HK_LINK AND CS.MD_SRC_SYSTEM = 'IAS'
	    		) COMM_SHARE
	    ON INVESTMENT_CONTRACT_RR.HK_HUB_REGISTERED_REPRESENTATIVE=COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE
	    AND  COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, SLR.MD_START_DT) 
),
LATEST_VERSION_BDV_INVESTMENT_CONTRACT AS (
SELECT 
	SLR.HK_LINK,
...
SELECT DISTINCT 
	...
	SLR.MD_EXTRACT_DT, 
	LR.IVR_SYSID,
	--LR.PLN_SYSID,  -- MODIFIED BY Jihed
	COMM_SHARE.MASTER_CODE,  
	'-1' AS PLAN_ID,
	'-1' AS MARKETPRODUCT_ID,
	LR.IVD_SYSID,
...
LEFT JOIN LATEST_VERSION_BDV_INVESTMENT_CONTRACT CON
    ...
    AND CON.HK_HUB_PARTY_ROLE_ADVISOR = COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR
    AND  CON.MD_ACTIVE = 'A' AND CON.RANK_CONTRACT = 1;
create or replace view VW_INITIAL_LOADING_WT_LINK_REVENUE_NEW(
	PLAN_ID,
	MARKETPRODUCT_ID,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
SELECT DISTINCT
	...
	LR.COMMISSION AS REVENUE, 
	(CASE LR.SOURCECODE WHEN 'OFF' THEN 'Trade commissions' WHEN 'FXF' THEN 'Fee based/Managed' WHEN 'MGD' THEN 'Fee based/Managed' WHEN 'JRN' THEN 'Trailers' WHEN 'MNL' THEN 'Trade commissions' WHEN 'INS' THEN 'Insurances' WHEN 'TRD' THEN 'Trade commissions' ELSE 'Unkown' END) AS REVENUE_TYPE, 
	(CASE LR.SOURCECODE WHEN 'OFF' THEN 'OffBook commission' WHEN 'FXF' THEN 'Fixed fees' WHEN 'MGD' THEN 'Managed' WHEN 'JRN' THEN 'Trailer fees and GIC' WHEN 'MNL' THEN 'Others' WHEN 'INS' THEN 'Insurances' WHEN 'TRD' THEN 'Trade commissions' ELSE 'Unkown' END) AS REVENUE_SUBTYPE
FROM REVENUES_RDV.LINK_REVENUE_RR_IAS_COMMISSION LR
...
AND LR.ACCOUNTID NOT RLIKE '^[A-Z][A-Z].*' AND LR.ACCOUNTID IS NOT NULL AND E.REPID IS NULL);
create or replace view VW_INITIAL_LOADING_WT_LINK_REVENUE_OLD(
	PLAN_ID,
	MARKETPRODUCT_ID,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
WHERE (((((LR.SOURCECODE <> 'EXP') AND (LR.SOURCECODE <> 'TXR')) AND (LR.REPID <> 'SEAA')) AND (LR.REPID <> 'SEZ9')) AND (LR.REPID <> 'QYYY')
AND LR.ACCOUNTID NOT RLIKE '^[A-Z][A-Z].*' AND LR.ACCOUNTID IS NOT NULL AND E.REPID IS NULL);
create or replace view VW_REVENUE_IAS_UNIVERIS(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
create or replace view VW_REVENUE_INVESTIA_UNIVERIS(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_REF_INVESTMENT_SAVING_PROGRAM_TYPES,
...
CREATE OR REPLACE PROCEDURE "REVENUE_IAS_COMMISSION_TO_BDV_WT_LINK_REVENUE"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
var sql_statement = snowflake.createStatement({
 ...
 var result_scan = sql_statement.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_REVENUES_TO_BDV_WT_LINK_REVENUES"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
UPD_QUERY STRING;
BEGIN
TRUNC_QUERY := ''TRUNCATE TABLE DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.WT_LINK_REVENUE'';
INS_QUERY := ''INSERT INTO DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.WT_LINK_REVENUE(
HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
HK_HUB_PARTY_ROLE_ADVISOR,
HK_HUB_CONTRACT,
MD_START_DT,
...
REVENUE_TYPE,
REVENUE_SUBTYPE
FROM DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.VW_INITIAL_LOADING_WT_LINK_REVENUE)'';
UPD_QUERY := ''UPDATE DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.WT_LINK_REVENUE
SET
...
var sql_statement = snowflake.createStatement({
 ...
 var result_scan = sql_statement.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_REVENUE_PAYABLE_IAS_UNIVERIS_TO_BDV_WT_LINK_REVENUE"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
"BUSINESS_RULES.REVENUES.UDF_CONV_BR_UNIVERIS_REVENUE_REVENUE_TYPE_002(sat_link_revenue_com_production_cd,sat_link_md_src_system), "+
"BUSINESS_RULES.REVENUES.UDF_CONV_BR_UNIVERIS_REVENUE_REVENUE_SUBTYPE_003(COM_PRODUCTION_MNEM,COM_PRODUCTION_LONG_DESC), "+
...
var sql_statement = snowflake.createStatement({
 ...
 var result_scan = sql_statement.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_REVENUE_PAYABLE_INVESTIA_TO_BDV_WT_LINK_REVENUE"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
var sql_statement = snowflake.createStatement({
 ...
 var result_scan = sql_statement.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_REVENUE_PAYABLE_TO_BDV_WT_LINK_REVENUES"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
UPD_QUERY STRING;
BEGIN
DEL_QUERY := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.WT_LINK_REVENUE WHERE MD_SRC_SYSTEM = ''''IAS-UNIVERIS''''
AND MD_SOURCE LIKE ''''%REVENUE_PAYABLE%'''';'';
INS_QUERY := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.WT_LINK_REVENUE
(
HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
HK_HUB_PARTY_ROLE_ADVISOR,
HK_HUB_REF_INVESTMENT_SAVING_PROGRAM_TYPES,
...
REVENUE_ID,
PLN_SYSID
FROM DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.VW_INITIAL_LOADING_INVESTIA_REVENUE_PAYABLE_WT_LINK_REVENUE)'';
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRAILER_FEES_IAS_UNIVERIS_TO_BDV_WT_LINK_REVENUE"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
"from db_IAWT_dev_dwh.revenues_rdv.SAT_LINK_REVENUE_TRAILER_FEES_RR_IAS_UNIVERIS as mstr join db_IAWT_dev_dwh.revenues_rdv.LINK_REVENUE_RR as dtls "+
"on mstr.hk_link = dtls.hk_link "+
"where mstr.md_start_dt = to_date(''"+IO_START_DATE+"'',''YYYY-MMD-DD'') AND MSTR.MD_ACTIVE = ''A'' ), "+
"t2 as(select * from t1 left outer join (select HK_HUB_CONTRACT, HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,contract_id,client_id from db_IAWT_dev_dwh.shared_rdv.LINK_INVESTMENT_CONTRACT_RR ) as dtls "+
"on HK_HUB_CONTRACT = link_revenue_RR_HK_HUB_CONTRACT), "+
"t3 as (select "+
"HK_HUB as SAT_REGISTERED_HK_HUB,REP_SYSID as sat_REP_SYSID,MD_ACTIVE  from  db_IAWT_dev_dwh.shared_rdv.SAT_REGISTERED_REPRESENTATIVE_IAS_UNIVERIS as mstr join ( "+
"select HK_HUB as dtls_HK_HUB, max(md_start_dt) as max_start_dt from   db_IAWT_dev_dwh.shared_rdv.SAT_REGISTERED_REPRESENTATIVE_IAS_UNIVERIS "+
"where MD_START_DT <= TO_DATE(''"+IO_START_DATE+"'',''YYYY-MM-DD'') group by HK_HUB ) as dtls "+
"on HK_HUB = dtls_hk_HUB and MD_START_DT =  max_start_dt where MD_ACTIVE = ''A''), "+
"t4 as(  select * from t3 as master join (select HK_HUB as hub_hk_hub,rr_CD as hub_rr_cd from  db_IAWT_dev_dwh.shared_rdv.HUB_REGISTERED_REPRESENTATIVE where CONTAINS(MD_SRC_SYSTEM, ''IAS'') ) as dtls "+
"on SAT_REGISTERED_HK_HUB = hub_hk_hub where MD_ACTIVE = ''A''), "+
...
"t7 as(  select * from t6 as master join (select HK_LINK, HK_HUB_PARTY_ROLE_ADVISOR as link_Commission_HK_HUB_PARTY_ROLE_ADVISOR, MASTER_CODE as  link_Commission_MASTER_CODE, "+
"HK_HUB_REGISTERED_REPRESENTATIVE as link_Commission_HK_HUB_REGISTERED_REPRESENTATIVE "+
"from  db_IAWT_dev_dwh.shared_bdv.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE ) as dtls "+
"on SAT_LINK_PARTY_RELATIONSHIP_HK_LINK = HK_LINK), "+
"t8 as(select * from t5 left outer join t7 on  hub_hk_hub = link_Commission_HK_HUB_REGISTERED_REPRESENTATIVE) "+
"select HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, "+
"link_Commission_HK_HUB_PARTY_ROLE_ADVISOR, "+
...
",HK_HUB_CONTRACT as Link_Invstment_cnt_HK_HUB_CONTRACT from db_IAWT_dev_dwh.shared_bdv.LINK_INVESTMENT_CONTRACT ) "+
"on Link_Invstment_cnt_HK_HUB_PARTY_ROLE_ADVISOR = link_Commission_HK_HUB_PARTY_ROLE_ADVISOR  and "+
"Link_Invstment_cnt_HK_HUB_CONTRACT = link_revenue_RR_HK_HUB_CONTRACT ) ";
var INS_QUERY_ENV = INS_QUERY.replaceAll("_dev_","_"+ ENV + "_");
var sql_statement = snowflake.createStatement({
 ...
 var result_scan = sql_statement.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRAILER_FEES_INVESTIA_TO_BDV_WT_LINK_REVENUE"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
"EXCH_RATE as sat_link_revenue_EXCH_RATE, "+
"process_dt as  link_revenue_rr_process_dt "+
"from db_IAWT_dev_dwh.revenues_rdv.SAT_LINK_REVENUE_TRAILER_FEES_RR_INVESTIA_UNIVERIS as mstr join db_IAWT_dev_dwh.revenues_rdv.LINK_REVENUE_RR as dtls on mstr.hk_link = dtls.hk_link "+
"where mstr.MD_START_DT = TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') AND mstr.MD_ACTIVE = ''A''), "+
"t2 as(select max(slic.MD_START_DT) as md_max_start_dt,lic.hk_hub_contract as lic_hk_hub_contract from db_IAWT_dev_dwh.shared_rdv.SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS as slic join db_IAWT_dev_dwh.shared_rdv.LINK_INVESTMENT_CONTRACT_RR as lic  on slic.hk_link = lic.hk_link "+
"where slic.MD_START_DT <= TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') and lic.md_src_system = ''INVESTIA-UNIVERIS'' group by lic.hk_hub_contract), "+
...
"CONTRACT_ID as LIHCPass2_CONTRACT_ID, client_ID as LIHCPass2_client_ID,slic.md_active as slic2_md_active from db_IAWT_dev_dwh.shared_rdv.SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS as slic join db_IAWT_dev_dwh.shared_rdv.LINK_INVESTMENT_CONTRACT_RR as lic  on slic.hk_link = lic.hk_link "+
"where slic.MD_START_DT <= TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') and lic.md_src_system = ''INVESTIA-UNIVERIS'' ), "+
...
"where MD_START_DT <= TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') group by HK_HUB ) as dtls "+
"on HK_HUB = dtls_hk_HUB and MD_START_DT =  max_start_dt where MD_ACTIVE = ''A''), "+
"t7 as(  select * from t6 as master join (select HK_HUB as hub_hk_hub,rr_CD as hub_rr_cd from  db_IAWT_dev_dwh.shared_rdv.HUB_REGISTERED_REPRESENTATIVE where MD_SRC_SYSTEM = ''INVESTIA-UNIVERIS'' "+
")  as dtls "+
"on SAT_REGISTERED_HK_HUB = hub_hk_hub where md_active = ''A''), "+
"t8 as(  select * from t5 left outer join t7 on hub_rr_cd = sat_link_revenue_REP_SYSID ), "+
"t9 as ( select MD_ACTIVE, "+
"HK_LINK as SAT_LINK_PARTY_RELATIONSHIP_HK_LINK,COMMISSIONPCT as sat_link_Commission_COMMISSIONPCT  from  db_IAWT_dev_dwh.shared_bdv.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE as mstr join ( "+
"select HK_LINK as dtls_HK_LINK, max(md_start_dt) as max_start_dt from   db_IAWT_dev_dwh.shared_bdv.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE "+
"where MD_START_DT <= TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') group by HK_LINK) as dtls "+
...
"on SAT_LINK_PARTY_RELATIONSHIP_HK_LINK = HK_LINK where MD_SRC_SYSTEM = ''INVESTIA-UNIVERIS'' and MD_ACTIVE = ''A'' ), "+
"t11 as(select * from t8 left outer join t10 on  hub_hk_hub = link_Commission_HK_HUB_REGISTERED_REPRESENTATIVE ), "+
"t12 as ( select hk_link as SAT_LINK_inv_hk_link from  db_IAWT_dev_dwh.shared_bdv.SAT_LINK_INVESTMENT_CONTRACT as mstr join ( "+
"select HK_LINK as dtls_HK_LINK, max(md_start_dt) as max_start_dt from   db_IAWT_dev_dwh.shared_bdv.SAT_LINK_INVESTMENT_CONTRACT "+
"where MD_START_DT <= TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') group by HK_LINK) as dtls "+
"on HK_LINK = dtls_hk_LINK and MD_START_DT =  max_start_dt where MD_ACTIVE = ''A''), "+
...
"from db_IAWT_dev_dwh.shared_bdv.LINK_INVESTMENT_CONTRACT) on hk_LINK = SAT_LINK_inv_hk_link) "+
...
var sql_statement = snowflake.createStatement({
 ...
 var result_scan = sql_statement.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRAILER_FEES_TO_BDV_WT_LINK_REVENUES"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
REVENUE_ID,
PLN_SYSID
FROM DB_IAWT_''||ENV||''_DWH.REVENUES_BDV.VW_INITIAL_LOADING_INVESTIA_TRAILER_FEES_WT_LINK_REVENUE)'';
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_WRAP_FEES_INVESTIA_TO_BDV_WT_LINK_REVENUE"("ENV" VARCHAR(16777216), "IO_START_DATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
"process_dt as  link_revenue_rr_process_dt "+
"from db_IAWT_dev_dwh.revenues_rdv.SAT_LINK_REVENUE_WRAP_FEE_RR_INVESTIA_UNIVERIS as mstr join db_IAWT_dev_dwh.revenues_rdv.LINK_REVENUE_RR as dtls on mstr.hk_link = dtls.hk_link "+
...
"t2 as(select max(slic.MD_START_DT) as md_max_start_dt,lic.hk_hub_contract as lic_hk_hub_contract from db_IAWT_dev_dwh.shared_rdv.SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS as slic join db_IAWT_dev_dwh.shared_rdv.LINK_INVESTMENT_CONTRACT_RR as lic  on slic.hk_link = lic.hk_link "+
"where slic.MD_START_DT <= TO_DATE(''"+ IO_START_DATE +"'',''YYYY-MM-DD'') and lic.md_src_system = ''INVESTIA-UNIVERIS'' group by lic.hk_hub_contract), "+
"t3 as(select lic.hk_hub_contract as lic2_hk_hub_contract , slic.md_active as slic2_md_active from db_IAWT_dev_dwh.shared_rdv.SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS as slic join db_IAWT_dev_dwh.shared_rdv.LINK_INVESTMENT_CONTRACT_RR as lic  on slic.hk_link = lic.hk_link "+
"where slic.MD_START_DT <= TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') and lic.md_src_system = ''INVESTIA-UNIVERIS'' ), "+
"t4 as (select * from t2 join t3 on lic_hk_hub_contract = lic2_hk_hub_contract where slic2_md_active = ''A''), "+
"t5 as (select * from t1 left outer join t4 on lic_hk_hub_contract = link_revenue_RR_HK_HUB_CONTRACT), "+
"t6 as (select "+
...
"where MD_START_DT <= TO_DATE(''"+ IO_START_DATE + "'',''YYYY-MM-DD'') group by HK_HUB ) as dtls "+
"on HK_HUB = dtls_hk_HUB and MD_START_DT =  max_start_dt where MD_ACTIVE = ''A''), "+
"t7 as(  select * from t6 as master join (select HK_HUB as hub_hk_hub from  db_IAWT_dev_dwh.shared_rdv.HUB_REGISTERED_REPRESENTATIVE where MD_SRC_SYSTEM = ''INVESTIA-UNIVERIS'')  as dtls "+
"on SAT_REGISTERED_HK_HUB = hub_hk_hub), "+
"t8 as(  select * from t5 left outer join t7 on sat_REP_SYSID = sat_link_revenue_REP_SYSID ), "+
"t9 as ( select "+
"HK_LINK as SAT_LINK_PARTY_RELATIONSHIP_HK_LINK,COMMISSIONPCT as sat_link_Commission_COMMISSIONPCT  from  db_IAWT_dev_dwh.shared_bdv.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE as mstr join ( "+
...
"link_revenue_RR_IVD_SYSID, "+
"link_revenue_RR_PAYMENT_DT, "+
"IFF(sat_link_Commission_COMMISSIONPCT IS NULL,1,sat_link_Commission_COMMISSIONPCT) * sat_link_revenue_FEE_AMT	 , "+
"''Fee based/Managed'', "+
"''Fee for Service'', "+
"link_revenue_RR_PLN_SYSID, "+
"link_revenue_RR_PAY_SYSID "+
...
create or replace TABLE WT_LINK_REVENUE (
	...
	REVENUE_SUBTYPE VARCHAR(512),
	AUA NUMBER(38,12),
	REVENUE_ID NUMBER(38,0),
	PLN_SYSID NUMBER(38,0)
);
create or replace view VW_INITIAL_LOADING_UNIVERIS_TRAILER_FEES_WT_LINK_REVENUE(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
...
LEFT JOIN SHARED_BDV.LINK_INVESTMENT_CONTRACT LIC 
	...
	AND LIC.HK_HUB_PARTY_ROLE_ADVISOR = COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR) X
WHERE X.RANK_SHARE = 1 AND X.MD_ACTIVE = 'A';
use schema  REVENUES_RDV;

create or replace TABLE LINK_REVENUE_RR (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TABLE LINK_REVENUE_RR_IAS_COMMISSION (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
...
create or replace TABLE LINK_REVENUE_RR_TBD (
	HK_LINK VARCHAR(40),
	HK_HUB_CONTRACT VARCHAR(40),
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40),
	MD_START_DT TIMESTAMP_NTZ(9),
	...
	MD_SRC_SYSTEM VARCHAR(100),
	MD_EXTRACT_DT TIMESTAMP_NTZ(9),
	PAY_SYSID NUMBER(38,0),
	PAYMENT_DT TIMESTAMP_NTZ(9),
	PLN_SYSID NUMBER(38,0),
	IVR_SYSID NUMBER(38,0),
	IVD_SYSID NUMBER(38,0),
	PROCESS_DT TIMESTAMP_NTZ(9)
);
create or replace TABLE REF_COM_PRODUCTION (
...
create or replace TABLE SAT_LINK_REVENUE_PAYABLE_RR_IAS_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_REVENUE_PAYABLE_RR_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_REVENUE_TRAILER_FEES_RR_IAS_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_REVENUE_TRAILER_FEES_RR_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_REVENUE_WRAP_FEE_RR_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_COM_PRODUCTION (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_COM_PRODUCTION_INVESTIA_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADSATELLITE_INSERT_AUDIT_ID"("ENV" VARCHAR(16777216), "SRC_SATELLITE_LV" VARCHAR(16777216), "SRC_SATELLITE" VARCHAR(16777216), "SRC_DATA" VARCHAR(16777216), "TGT_MAPPING" VARCHAR(16777216), "TGT_OBJ" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADSATELLITE_INSERT_AUDIT_ID"("ENV" VARCHAR(16777216), "SRC_SATELLITE_LV" VARCHAR(16777216), "SRC_SATELLITE" VARCHAR(16777216), "SRC_DATA" VARCHAR(16777216), "TGT_OBJ" VARCHAR(16777216), "TGT_MAPPING" VARCHAR(16777216), "AUDIT_ID" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
" FROM " + SRC_DATA + " AS MSTR LEFT OUTER JOIN T2 AS DTLS ON MSTR.HK_HUB = DTLS.HK_HUB AND MSTR.MD_HASHDIFF = DTLS.MD_HASHDIFF WHERE DTLS.Hk_hub IS NULL)";
 ...
 var result_scan = sql_statement.execute();	
';
use schema  SHARED_BDV;

create or replace TABLE HUB_PARTY_ROLE_ADVISOR (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE LINK_INVESTMENT_CONTRACT (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace TABLE LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE (
...
create or replace TABLE PRADEDEP_SAT_LINK_SHARE_BDV (
	HK_LINK VARCHAR(64),
	MD_START_DT TIMESTAMP_NTZ(9),
	...
	IS_RESHARED NUMBER(7,3),
	PHYSICAL NUMBER(7,3),
	TOREPID VARCHAR(50)
);
create or replace TABLE REF_INVESTMENT_SAVING_PROGRAM_TYPES_AGG (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE SAT_CONTRACT_AUA_SEG_COMPUTE (
...
create or replace TABLE SAT_CONTRACT_COMPUTE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_INVESTMENT_PRODUCT_TYPE_COMPUTE (
	...
	ISSUER_COMPANY_CODE VARCHAR(50),
	ISSUER_COMPANY_NAME VARCHAR(1000)
);
create or replace TABLE SAT_LINK_INVESTMENT_CONTRACT (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE (
	HK_LINK VARCHAR(64) COMMENT 'HASH OF THE BUSINESS KEYS',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'START DATE OF THE IMAGE/VERSION',
	MD_HASHDIFF VARCHAR(64) COMMENT 'REPRESENTS THE WHOLE SET OF HASHED ATTRIBUTES TO BE HISTORIZED FOR AN OCCURRENCE',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'CREATION DATE TIME OF THE OCCURRENCE',
...
create or replace TABLE SAT_PARTY_ROLE_ACCOUNT_HOLDER_AUA_SEG_COMPUTE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ACCOUNT_HOLDER_CLEAN (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ACCOUNT_HOLDER_COMPUTE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ACCOUNT_HOLDER_COMPUTE_BKP (
	HK_HUB VARCHAR(64),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_HASHDIFF VARCHAR(64),
	MD_CREATION_DT TIMESTAMP_NTZ(9),
	...
	MD_EXTRACT_DT TIMESTAMP_NTZ(9),
	MD_ACTIVE VARCHAR(1),
	INCOME_AMT NUMBER(38,2),
	INCOME_LEVEL_1_SEGMENT VARCHAR(50),
	INCOME_LEVEL_1_SEGMENT_ORD NUMBER(2,0),
	INCOME_LEVEL_2_SEGMENT VARCHAR(50),
	INCOME_LEVEL_2_SEGMENT_ORD NUMBER(2,0),
	AGE_SEGMENT VARCHAR(50),
	AGE_SEGMENT_ORD NUMBER(2,0),
	NEW_CLIENT_IND VARCHAR(16777216),
	CLIENT_START_DT TIMESTAMP_NTZ(9)
);
create or replace TABLE SAT_PARTY_ROLE_ADVISOR_AUA_SEG_COMPUTE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH_RACHID_JIHED (
	HK_HUB VARCHAR(64),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_HASHDIFF VARCHAR(64),
	MD_CREATION_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_COMPUTE (
...
create or replace TABLE SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE TRANSLINK_EXCHANGE_RATE (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
...
create or replace TABLE WT_ADVISOR_IAS_CERTS (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_INVESTMENT_CONTRACT_IAS_NBIN (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace TABLE WT_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
...
create or replace TABLE WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE_MC (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(64) COMMENT 'Hash of the business keys',
	HK_HUB_ADVISOR VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TABLE WT_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH (
	HK_HUB VARCHAR(64),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_EXTRACT_DT TIMESTAMP_NTZ(9),
	MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE WT_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH_BKP (
	HK_HUB VARCHAR(64),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_EXTRACT_DT TIMESTAMP_NTZ(9),
	MD_HASHDIFF VARCHAR(64),
	...
	NEW_FIRM_BACK_OFFICE VARCHAR(1000),
	PRESTIGE_STATUS VARCHAR(100),
	TRANSITION_PERIOD_END_DATE TIMESTAMP_NTZ(9),
	DEAL_ASSESTS NUMBER(11,0),
	EXPECTED_ASSESTS NUMBER(11,0),
	PREVIOUS_FIRM VARCHAR(100),
	PREVIOUS_FIRM_TYPE VARCHAR(100)
);
create or replace TABLE WT_REGISTERED_REPRESENTATIVE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
...
create or replace TABLE WT_REGISTERED_REPRESENTATIVE_IAS_CERTS (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	HK_SAT VARCHAR(40) COMMENT 'Hash of the Satellite for the multi-active keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
...
create or replace TABLE WT_SAT_CONTRACT_COMPUTE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_SAT_INVESTMENT_PRODUCT_TYPE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TABLE WT_SAT_INVESTMENT_PRODUCT_TYPE_COMPUTE (
	...
	ISSUER_COMPANY_CODE VARCHAR(1000),
	ISSUER_COMPANY_NAME VARCHAR(1000)
);
create or replace TABLE WT_SAT_INVESTMENT_PRODUCT_TYPE_MERGE (
	HK_HUB VARCHAR(7000) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(7000) DEFAULT '0' COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_SAT_PARTY_ROLE_ACCOUNT_HOLDER_AUA_SEG_COMPUTE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_SAT_PARTY_ROLE_ACCOUNT_HOLDER_COMPUTE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) DEFAULT '0' COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_SAT_PARTY_ROLE_ADVISOR_AUA_SEG_COMPUTE (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) DEFAULT '0' COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_COMPUTE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) DEFAULT '0' COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace view VW_CLIENT_CONTRACT(
	HK_HUB_CONTRACT,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	A_C_CLIENT,
	MD_START_DT,
...
create or replace view VW_EXCHANGE_RATE(
	HK_LINK,
	MD_START_DT,
	MD_CREATION_DT,
	MD_SOURCE,
...
FROM DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.REF_DATE D
LEFT OUTER JOIN DB_IAWT_DEV_DWH.SHARED_RDV.TRANSLINK_EXCHANGE_RATE E 
ON D.DATE=E.EXCHANGE_DATE 
WHERE D.DATE BETWEEN (SELECT MIN(EXCHANGE_DATE) FROM DB_IAWT_DEV_DWH.SHARED_RDV.TRANSLINK_EXCHANGE_RATE) AND (SELECT MAX(EXCHANGE_DATE) FROM DB_IAWT_DEV_DWH.SHARED_RDV.TRANSLINK_EXCHANGE_RATE)
ORDER BY D.DATE) E;
create or replace view VW_IAS_RRCODE_MASTERCODE_TRANS(
	A_C_REPRESENTATIVE,
	COMMISSIONPCT,
	TOREPID,
	MASTER_CODE,
...
create or replace view VW_INITIAL_LOADING_INVESTIA_UNIVERIS_WT_TRANSLINK_FINANCIAL_TRANSACTION(
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_CONTRACT,
...
WITH LATEST_VERSION_SHARE AS (
	...
	COALESCE (COMM_SHARE.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLH.HK_LINK,COMM_SHARE.HK_LINK ORDER BY COMM_SHARE.MD_START_DT DESC ),1) AS RANK_SHARE
	FROM DB_IAWT_DEV_DWH.HOLDINGS_RDV.SAT_LINK_INVESTMENT_CASH_RR_IAS_NBIN SLH
	INNER JOIN DB_IAWT_DEV_DWH.HOLDINGS_RDV.LINK_INVESTMENT_RR_IAS_NBIN LH
	    ON  SLH.HK_LINK=LH.HK_LINK
	LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE
	        	FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE LCS 
	        	INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE CS 
...
LEFT JOIN SHARED_BDV.TRANSLINK_EXCHANGE_RATE LER
	ON LER.EXCHANGE_DATE = SLH.A_C_SUMM_BALANCE_BUS_DATE;
create or replace view VW_INITIAL_LOADING_SAT_LINK_COMMISSION_SHARE_MULTIIMAGE(
	HK_LINK,
	MD_START_DT,
	MD_HASHDIFF,
	MD_ACTIVE,
...
SELECT RSLT.* 
FROM RSLT
LEFT JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE S ON RSLT.HK_LINK = S.HK_LINK AND RSLT.MD_START_DT = S.MD_START_DT --AND S.MD_ACTIVE = RSLT.MD_ACTIVE
WHERE S.HK_LINK IS NULL;
create or replace view VW_INITIAL_LOADING_SHARE(
	HK_LINK,
...
(
	SELECT DISTINCT TRIM(s.FROMREPID) AS FROMREPID, s.COMMISSIONPCT, TRIM(s.TOREPID) AS TOREPID, 
	TRIM(ADV_to.MAINREPCODE) AS MASTER_CODE, 1 AS PHYSICAL, 'FROM_RR_TO_MAIN' AS COM_TYPE, 0 AS IS_RESHARED, s.START_DT, s.END_DT
	FROM LV_SHARE s 
	LEFT JOIN ADV ADV_to
	ON TRIM(s.TOREPID) = TRIM(ADV_to.MAINREPCODE)
	WHERE ADV_to.MAINREPCODE IS NOT NULL AND s.COMMISSIONPCT > 0
...
(
	SELECT DISTINCT TRIM(s.FROMREPID) AS FROMREPID, s.COMMISSIONPCT, TRIM(s.TOREPID) AS TOREPID, 
  	TRIM(rr.MAINREPCODE) AS MASTER_CODE, 1 AS PHYSICAL, 'FROM_RR_TO_RR_TO_MAIN' AS COM_TYPE, 0 AS IS_RESHARED, s.START_DT, s.END_DT
	FROM LV_SHARE s 
	LEFT JOIN FROM_RR_TO_MAIN
	ON FROM_RR_TO_MAIN.FROMREPID = TRIM(s.FROMREPID) AND FROM_RR_TO_MAIN.TOREPID = TRIM(s.TOREPID) 	
	LEFT JOIN 
...
(
	SELECT DISTINCT TRIM(s.FROMREPID) AS FROMREPID, s.COMMISSIONPCT, TRIM(s.TOREPID) AS TOREPID, 
  TRIM(s.TOREPID) AS MASTER_CODE, 0 AS PHYSICAL, 'OTHER' AS COM_TYPE, 0 AS IS_RESHARED, s.START_DT, s.END_DT
	FROM LV_SHARE s 
	LEFT JOIN FROM_RR_TO_MAIN
	ON FROM_RR_TO_MAIN.FROMREPID = TRIM(s.FROMREPID) AND FROM_RR_TO_MAIN.TOREPID = TRIM(s.TOREPID) 
	LEFT JOIN FROM_RR_TO_RR_TO_MAIN
...
AV_ALL AS
(
	SELECT T.A_C_REPRESENTATIVE, T.COMMISSIONPCT, T.TOREPID, T.MASTER_CODE, T.PHYSICAL, T.COM_TYPE, T.IS_RESHARED, T.START_DT, T.END_DT
	FROM 
	(
		SELECT FROMREPID AS A_C_REPRESENTATIVE, COMMISSIONPCT, TOREPID, MASTER_CODE, PHYSICAL, COM_TYPE, IS_RESHARED,START_DT, END_DT
		FROM FROM_RR_TO_MAIN
		WHERE MASTER_CODE IS NOT NULL
...
SELECT 
SHA1(CONCAT(COALESCE('IAS-COMMISSION'/*MD_SRC_SYSTEM*/,'#NULL#'),'|', COALESCE(A_C_REPRESENTATIVE, '#NULL#'), '|' , COALESCE(TOREPID,'#NULL#'))) AS HK_LINK,
SHA1(CONCAT(COALESCE('IAS-COMMISSION'/*MD_SRC_SYSTEM*/,'#NULL#'),'|', COALESCE(A_C_REPRESENTATIVE, '#NULL#'))) AS HK_HUB_REGISTERED_REPRESENTATIVE,
SHA1(CONCAT(COALESCE('IAS-COMMISSION'/*MD_SRC_SYSTEM*/,'#NULL#'),'|', COALESCE(MASTER_CODE, '#NULL#'))) AS HK_HUB_PARTY_ROLE_ADVISOR,
...
FROM AV_ALL
ORDER BY A_C_REPRESENTATIVE;
create or replace view VW_INITIAL_LOADING_WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE(
	HK_LINK,
	HK_HUB_REGISTERED_REPRESENTATIVE,
	HK_HUB_PARTY_ROLE_ADVISOR,
	MD_HASHDIFF,
...
SELECT 
	...
	WT.A_C_CLIENT																															AS CLIENT_ID,
	WT.CONTRACT_ID																															AS PLN_SYSID,
	WT.A_C_SUMM_BALANCE_BUS_DATE 																											AS BALANCE_DATE,
	-- The Business rule below is documented as BR_ALL_HOLDINGS_HOLDING_VALUE_001
	WT.CASH_VALUE * COALESCE(WT.COMMISSIONPCT,100) * 0.01																					AS HOLDING_VALUE,
	-- The Business rule below is documented as BR_ALL_HOLDINGS_AUA_002
	DECODE(WT.A_C_CURRENCY,'USD',WT.CASH_VALUE*WT.EXCHANGERATE,WT.CASH_VALUE) * COALESCE(WT.COMMISSIONPCT,100) * 0.01 						AS AUA,
...
WHERE WT.CONTRACT_ID NOT RLIKE '^[A-Z][A-Z].*'
	...
	AND E.REPID IS NULL
	AND (WT.RR_CD NOT IN ('SEAA', 'SEZ9', 'QYYY'));
create or replace view VW_INVESTMENT_PRODUCT_TYPE_COMPUTE(
	HK_HUB,
	MD_HASHDIFF,
	MD_SOURCE,
	MD_START_DT,
...
MD_SRC_SYSTEM,
SYMBOL,
CASE WHEN  NB_SYM   >1 THEN SOURCE_Name ELSE MERGED_Name END AS Product_Name,
ASSET_CATEGORY,      
CATEGORY,
PRODUCT_GROUP,
ISSUER_COMPANY_CODE,
...
FROM DB_IAWT_DEV_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE DMP 
LEFT JOIN DB_IAWT_DEV_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE_MERGE P_MERGE
ON DMP.SYMBOL = P_MERGE.SYMBOL
---WHERE DMP.SYMBOL  IN  ('MGS2359')
) FINAL_TAB
---WHERE SYMBOL IN  ('MGS2359') 
ORDER BY SYMBOL;
create or replace view VW_PARTY_ROLE_ACCOUNT_HOLDER_CLEAN(
	HK_HUB,
	MD_START_DT,
	MD_SOURCE,
...
SELECT c.HK_HUB,
	...
	FROM SHARED_RDV.SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_NBIN c
	WHERE c.MD_ACTIVE = 'A';
create or replace view VW_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH(
	HK_HUB_PARTY_ROLE_ADVISOR,
	MASTER_CODE,
	BEGIN_DT,
	MD_START_DT,
...
COALESCE(RR.MD_START_DT, RC.MD_START_DT, URR.MD_START_DT, WTRRCOMM.MD_START_DT, sat.MD_START_DT) AS MD_START_DT, --added by SV
    COALESCE(RR.MD_ACTIVE,RC.MD_ACTIVE, URR.MD_ACTIVE, WTRRCOMM.MD_ACTIVE, sat.MD_ACTIVE) AS MD_ACTIVE, --added by SV
    COALESCE( 
     NULLIF(DECODE(TRIM(cert.RVP), '#N/A', 'non affiliated to RVPs', TRIM(cert.RVP)),''), 
     NULLIF(DECODE(TRIM(cert.RVP), NULL , 'non affiliated to RVPs', TRIM(cert.RVP)),''),
 NULLIF(DECODE(URR.RGN_MGR, 'All', NULL, URR.RGN_MGR),''),
     NULLIF(DECODE(TRIM(ICAR.FULL_NAME), '#N/A', 'non affiliated to RVPs', TRIM(ICAR.FULL_NAME)),''),
     'non affiliated to RVPs') AS Region_VP,
...
URR.REP_LNAME,
URR.REP_FNAME,
    CASE WHEN substring(UPPER(SH.MASTER_CODE), 1, 4) in ('PART', 'CORP') THEN 'Corporation'
    WHEN substring(UPPER(SH.MASTER_CODE), 1, 2) = 'IM' THEN 'Corporation'
ELSE cert.PRIMARY_ROLE END AS PRIMARY_ROLE,
cert.ADVISOR_BIRTH_DATE as ADVISOR_BIRTH_DATE
FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE sh
INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE sat
ON sh.HK_LINK =sat.HK_LINK 
LEFT JOIN SHARED_BDV.WT_REGISTERED_REPRESENTATIVE_IAS_CERTS cert 
ON sh.MASTER_CODE = cert.RR_CD 
LEFT JOIN SHARED_RDV.HUB_REGISTERED_REPRESENTATIVE c
ON c.RR_CD =sh.MASTER_CODE AND c.MD_SRC_SYSTEM IN ('IAS-COMMISSION','IAS_CERTS','IAS-UNIVERIS')
LEFT JOIN SHARED_BDV.WT_REGISTERED_REPRESENTATIVE RR
ON c.HK_HUB =RR.HK_HUB AND RR.MAINREPCODE = c.RR_CD 
AND rr.ACTIVE = 1 
LEFT JOIN SHARED_BDV.WT_REGISTERED_REPRESENTATIVE RC
ON c.HK_HUB =RC.HK_HUB  AND RC.ACTIVE = 0
-- GET UNIVERIS DATA
LEFT JOIN SHARED_BDV.WT_REGISTERED_REPRESENTATIVE URR
ON c.HK_HUB =URR.HK_HUB
LEFT JOIN SHARED_BDV.WT_REGISTERED_REPRESENTATIVE_IAS_CERTS ICAR
ON (CONTAINS(UPPER(ICAR.FIRST_NAME),UPPER(TRIM(RR.FIRSTNAME))) AND CONTAINS(UPPER(ICAR.LAST_NAME),UPPER(TRIM(RR.LASTNAME))) )
OR CONTAINS(UPPER(ICAR.FULL_NAME),UPPER(TRIM(RR.REPNAME)))
OR (CONTAINS(UPPER(ICAR.FULL_NAME),UPPER(TRIM(SPLIT_PART(RR.REPNAME,',',1)))) AND CONTAINS(UPPER(ICAR.FULL_NAME),UPPER(TRIM(SPLIT_PART(RR.REPNAME,',',2)))))
LEFT JOIN SHARED_BDV.WT_REGISTERED_REPRESENTATIVE WTRRCOMM
ON WTRRCOMM.MAINREPCODE = c.RR_CD AND c.HK_HUB = WTRRCOMM.HK_HUB 
AND WTRRCOMM.ACTIVE = 0
WHERE sh.MD_SRC_SYSTEM IN ('IAS','IAS-COMMISSION')  
GROUP BY 
SH.HK_HUB_PARTY_ROLE_ADVISOR ,
SH.MASTER_CODE,
COALESCE(cert.BEGIN_DT, WTRRCOMM.STARTDATE,  '9999-12-31'),
COALESCE(RR.MD_START_DT, RC.MD_START_DT, URR.MD_START_DT, WTRRCOMM.MD_START_DT, sat.MD_START_DT), 
    COALESCE(RR.MD_ACTIVE,RC.MD_ACTIVE, URR.MD_ACTIVE, WTRRCOMM.MD_ACTIVE, sat.MD_ACTIVE),
   Region_VP,
   Advisor_fullname,
  URR.BRN_CD,
URR.BRN_NAME,
...
create or replace view VW_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH_2022_01_26(
	HK_HUB_PARTY_ROLE_ADVISOR,
	MASTER_CODE,
	BEGIN_DT,
	MD_START_DT,
...
SELECT  DISTINCT 
	...
	SH.MASTER_CODE,
	COALESCE(cert.BEGIN_DT, WTRRCOMM.STARTDATE,  '9999-12-31') AS BEGIN_DT,
	sat.MD_START_DT, --added by SV
    sat.MD_ACTIVE, --added by SV
    COALESCE( 
    	  NULLIF(DECODE(TRIM(cert.RVP), '#N/A', 'non affiliated to RVPs', TRIM(cert.RVP)),''), 
    	  NULLIF(DECODE(TRIM(cert.RVP), NULL , 'non affiliated to RVPs', TRIM(cert.RVP)),''),
		  NULLIF(DECODE(URR.RGN_MGR, 'All', NULL, URR.RGN_MGR),''),
...
GROUP BY 
   ...
   Advisor_fullname,
	...
	cert.PRIMARY_ROLE,
	cert.ADVISOR_BIRTH_DATE;
create or replace view VW_SAT_CONTRACT_COMPUTE(
	HK_HUB,
	MD_START_DT,
	MD_HASH_NAT_KEYS,
	MD_SOURCE,
...
ON sref.HK_HUB = R.HK_HUB) IP 
ON s.PLN_CD =IP.PLN_CD;
create or replace view VW_SAT_LINK_COMMISSION_SHARE_MULTIIMAGE(
	HK_LINK,
	MD_START_DT,
	MD_HASHDIFF,
	MD_ACTIVE,
...
(
	SELECT 	r.HK_LINK, 
			...
			lag(r.MD_ACTIVE, 1, '0') over (partition by r.HK_LINK order by r.MD_START_DT asc) AS PREVIOUS_ACTIVE,
			r.ROW_SRC
	FROM 
	(
		SELECT * FROM SAT
...
WHERE S.HK_LINK IS NULL;
CREATE OR REPLACE PROCEDURE "DUMMY"("ENV" VARCHAR(1000), "I_DATA_START_DATE" DATE)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
INS_PRE_DEL := ''select i_DATA_START_DATE'';
EXECUTE IMMEDIATE :INS_PRE_DEL;
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_HOLDINGS_TO_BDV_WT_SAT_PARTY_ROLE_ACCOUNT_HOLDER_AUA_SEG_COMPUTE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT 
	...
	,SUM(bdv2.AUA)
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENT_AUA_SEGMENTATION_002(SUM(bdv2.AUA))[''''o_CLIENT_AUA_SEGMENT_ORDER'''']
	FROM (
	SELECT *
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_HOLDINGS_TO_BDV_WT_SAT_PARTY_ROLE_ADVISOR_AUA_SEG_COMPUTE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000), "I_AUDIT_ID" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
,BUSINESS_RULES.SHARED_ADVISORS.UDF_CONV_BR_ALL_ADVISOR_AUA_SEGMENTATION_002(SATPARTY_BDV.O_ADVISOR_SUM_AUA)[''''o_ADVISOR_AUA_SEGMENT'''']
,BUSINESS_RULES.SHARED_ADVISORS.UDF_CONV_BR_ALL_ADVISOR_AUA_SEGMENTATION_002(SATPARTY_BDV.O_ADVISOR_SUM_AUA)[''''o_ADVISOR_AUA_SEGMENT_ORDER'''']
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_IAS_CERTS_HUB_SAT_TO_BDV_WT_ADVISOR_IAS_CERTS"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_IAS_CERTS_REGISTERED_REPRESENTATIVE_TO_BDV_WT_REGISTERED_REPRESENTATIVE_IAS_CERTS"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
WITH
  ...
  SELECT
	A.LV_HK_HUB 			AS 	LV_HK_HUB,
	C.LV_HK_SAT 			AS 	LV_HK_SAT,
	D.O_DATA_START_DATE 	AS 	O_DATA_START_DATE,
	B.HK_HUB 				AS 	HK_HUB,
	B.HK_SAT			 	AS 	HK_SAT,
	B.MD_START_DT 			AS 	MD_START_DT,
	B.MD_HASHDIFF 			AS 	MD_HASHDIFF,
	...
	ON B.HK_HUB = A.LV_HK_HUB
	JOIN LV C
	ON B.HK_SAT = C.LV_HK_SAT
	JOIN LV D
	ON B.MD_START_DT = D.O_DATA_START_DATE
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_IAS_COMMISSION_SHARE_SAT_TO_BDV_WT_REGISTERED_REPRESENTATIVE"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
WITH
  ...
  SELECT
	...
	JOIN LV_UNIVERIS C
	ON B.MD_START_DT = A.O_DATA_START_DATE_UNIVERIS
	),
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_IAS_COMMISSION_SHARE_TO_BDV_WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE_MC"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
WITH
  ...
  SELECT
	...
	JOIN LV C
	ON B.MD_START_DT = C.O_START_DATE
	WHERE B.MD_ACTIVE = ''''A''''
	),
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_IAS_NBIN_TO_BDV_WT_AGG_PLANSP"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
	DATA_START_DATE :=CHAR(39)||DATA_START_DATE||CHAR(39);
	DEL_QUERY := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG
	WHERE MD_SRC_SYSTEM = ''''IAS'''''';
INS_QUERY := ''INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG(
MD_START_DT,
MD_HASHDIFF,
MD_CREATION_AUDIT_ID,
MD_SOURCE,
...
WITH
                                  ...
                                  SELECT
									...
									MD_EXTRACT_DT,
									MD_ACTIVE
									FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN 
									WHERE MD_START_DT <= TO_DATE(''||DATA_START_DATE||'',''''YYYY-MM-DD'''')
									GROUP BY HK_HUB,MD_HASHDIFF,MD_CREATION_DT,MD_CREATION_AUDIT_ID,MD_SOURCE,MD_SRC_SYSTEM,MD_EXTRACT_DT,MD_ACTIVE,MD_START_DT
                                  ),
                                  SAT AS (
                                      SELECT
										...
										FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN B
										JOIN LV A
                                        ON A.HK_HUB = B.HK_HUB
										JOIN LV C
                                        ON C.O_MAX_DATE_LV = B.MD_START_DT
								  ...
								  SELECT
									...
									FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.REF_INVESTMENT_SAVING_PROGRAM_TYPES B
									JOIN SAT A 
									ON A.SAT_HK_HUB = B.HK_HUB
									WHERE B.HK_HUB != 0
								  )
								  SELECT 
								  TO_DATE(''||DATA_START_DATE||'',''''YYYY-MM-DD'''') AS O_MD_DATE,
								  SAT_MD_HASHDIFF,
								  ...
								  FROM REFF)'';
UPD_QUERY := ''UPDATE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG
SET
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_INVESTIA_UNIVERIS_SHARED_TO_WT_SATACCOUNTHOLDER_COMPUTE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT rdv.HK_HUB
	...
	,rdv.MD_SRC_SYSTEM
	,rdv.MD_EXTRACT_DT
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_UNIVERIS_CLIENTS_INCOME_SEGMENTATION_006(rdv.SALARY_DESC)[''''o_INCOME_SEGMENT'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_UNIVERIS_CLIENTS_INCOME_SEGMENTATION_006(rdv.SALARY_DESC)[''''o_INCOME_SEGMENT_ORD'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_UNIVERIS_CLIENTS_SALARY_SEGMENTATION_007(rdv.SALARY_DESC)[''''o_SALARY_SEGMENT'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_UNIVERIS_CLIENTS_SALARY_SEGMENTATION_007(rdv.SALARY_DESC)[''''o_SALARY_SEGMENT_ORD'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_UNIVERIS_CLIENTS_AGE_SEGMENTATION_008(rdv.IVR_PRIM_BDT, rdv.CORP_CD, rdv.MD_START_DT)[''''o_AGE_SEGMENT'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_UNIVERIS_CLIENTS_AGE_SEGMENTATION_008(rdv.IVR_PRIM_BDT, rdv.CORP_CD, rdv.MD_START_DT)[''''o_AGE_SEGMENT_ORD'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_004(rdv.MD_START_DT, rdv.CREATE_DT)
FROM (
	SELECT *
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_INVESTIA_UNIVERIS_SHARE_TO_BDV_WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE WHERE MD_SRC_SYSTEM = ''''INVESTIA-UNIVERIS'''';  '';
INS_INSERT := ''
...
(SELECT SAT_LINK.* FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_COMMISSION_SHARE_RR_INVESTIA_UNIVERIS SAT_LINK
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_LINK ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_COMMISSION_SHARE_RR_INVESTIA_UNIVERIS WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) SAT_LINKCV
ON SAT_LINKCV.HK_LINK = SAT_LINK.HK_LINK WHERE SAT_LINK.MD_ACTIVE = ''''A''''
)SAT_LINKCV
JOIN
DB_IAWT_''||ENV||''_DWH.SHARED_RDV.LINK_COMMISSION_SHARE_RR LINK
...
BEGIN
DATA_START_DATE :=CHAR(39)||DATA_START_DATE||CHAR(39);
TRUNC_QUERY := ''TRUNCATE TABLE DB_IAWT_DEV_DWH.REVENUES_BDV.WT_LINK_REVENUE'';
INS_QUERY := ''INSERT INTO DB_IAWT_DEV_DWH.REVENUES_BDV.WT_LINK_REVENUE(
HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
HK_HUB_PARTY_ROLE_ADVISOR,
HK_HUB_CONTRACT,
MD_START_DT,
...
REVENUE_TYPE,
EREVENUE_SUBTYPE
FROM DB_IAWT_DEV_DWH.REVENUES_BDV.VW_INITIAL_LOADING_WT_LINK_REVENUE)'';
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SAT_LINK_INVESTMENT_CONTRACT_RR_TO_BDV_WT_INVESTMENT_CONTRACT_IAS_NBIN"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_CONTRACT_IAS_NBIN WHERE MD_SRC_SYSTEM = ''''IAS'''' '';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_CONTRACT_IAS_NBIN (
HK_HUB_CONTRACT	
,HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER		
,HK_HUB_PARTY_ROLE_ADVISOR		
,MD_START_DT		
...
,bdv0.ASC_1_RESP_PLAN_TYPES
	FROM (
	SELECT *
			FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_INVESTMENT_CONTRACT_IAS_NBIN
			)srdv
		JOIN (
		SELECT *
			FROM (
			...
			WHERE SATHUB.RN = 1 AND SATHUB.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''')
			) bdv ON bdv.HK_LINK = srdv.HK_LINK
		JOIN DB_IAWT_''||ENV||''_DWH.SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR rdv ON rdv.HK_LINK = bdv.HK_LINK 
		LEFT JOIN
		(
			...
			JOIN (
				...
				) bdvcv ON bdvcv.HK_HUB = rdv2.HK_HUB 
		...
		LEFT JOIN 
			...
			JOIN (
				...
				) bdvcv1 ON bdvcv1.HK_LINK = sbdv2.HK_LINK 
				JOIN DB_IAWT_''||ENV||''_DWH.SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE sbdv ON sbdv.HK_LINK = bdvcv1.HK_LINK WHERE sbdv2.MD_ACTIVE = ''''A''''
		)bdv2 ON rdv.HK_HUB_REGISTERED_REPRESENTATIVE = bdv2.HK_HUB_REGISTERED_REPRESENTATIVE

		     '';
			 
INS_UPDATE :='' UPDATE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_CONTRACT_IAS_NBIN
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SAT_LINK_INVESTMENT_CONTRACT_RR_TO_BDV_WT_INVESTMENT_CONTRACT_IAS_UNIVERIS"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_CONTRACT_IAS_NBIN WHERE MD_SRC_SYSTEM = ''''IAS-UNIVERIS'''' '';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_CONTRACT_IAS_NBIN (
HK_HUB_CONTRACT	
,HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER		
...
,bdv2.PLN_MNEM	
	FROM (
	SELECT *
			FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_INVESTMENT_CONTRACT_IAS_UNIVERIS) rdv3
		JOIN (
		SELECT *
			FROM (
				SELECT *
				...
				FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_INVESTMENT_CONTRACT_IAS_UNIVERIS
				) SATHUB
			WHERE SATHUB.RN = 1 AND SATHUB.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''') 
			) bdv ON bdv.HK_LINK = rdv3.HK_LINK
		JOIN DB_IAWT_''||ENV||''_DWH.SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR rdv ON rdv.HK_LINK = bdv.HK_LINK 
		LEFT JOIN
		(	SELECT *
			FROM
		(
			...
			FROM (
				SELECT *
				FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_UNIVERIS
				) srdv2
			JOIN (
				SELECT *
				FROM (
				...
				WHERE SATHUB1.RN1 = 1 AND SATHUB1.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''') 
				) bdvcv ON bdvcv.HK_HUB = srdv2.HK_HUB
			JOIN DB_IAWT_''||ENV||''_DWH.SHARED_RDV.REF_INVESTMENT_SAVING_PROGRAM_TYPES srdv ON bdvcv.HK_HUB = srdv.HK_HUB WHERE srdv2.MD_ACTIVE = ''''A''''
		)bdv0
		LEFT JOIN 
			(
			...
			JOIN (
				...
				WHERE SATHUB2.RN2 = 1 AND SATHUB2.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''') 
				) bdvcv1 ON bdvcv1.HK_HUB = rdv2.HK_HUB WHERE rdv2.MD_ACTIVE = ''''A''''
		...
		(
			...
			JOIN (
				...
				) bdvcv2 ON bdvcv2.HK_LINK = sbdv2.HK_LINK 
				JOIN DB_IAWT_''||ENV||''_DWH.SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE sbdv ON sbdv.HK_LINK = sbdv2.HK_LINK WHERE sbdv2.MD_ACTIVE = ''''A''''
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SAT_LINK_INVESTMENT_CONTRACT_RR_TO_BDV_WT_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_CONTRACT_IAS_NBIN WHERE MD_SRC_SYSTEM = ''''INVESTIA-UNIVERIS'''' '';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_INVESTMENT_CONTRACT_IAS_NBIN (
HK_HUB_CONTRACT	
,HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER	
...
,bdv3.A_C_ACCOUNT_CLASS	
	FROM (
	SELECT *
			FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS) rdv3
		JOIN (
		SELECT *
			FROM (
				SELECT *
				...
				FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS
				) SATHUB
			WHERE SATHUB.RN = 1 AND SATHUB.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''') 
			) bdv ON bdv.HK_LINK = rdv3.HK_LINK
		JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR WHERE MD_SRC_SYSTEM = ''''INVESTIA-UNIVERIS'''')rdv ON rdv.HK_LINK = bdv.HK_LINK 
		LEFT JOIN
		(
		...
		(
			...
			FROM (
				SELECT *
				FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE WHERE MD_SRC_SYSTEM = ''''INVESTIA-UNIVERIS''''
				) sbdv2
			JOIN (
				SELECT *
				FROM (
			...
			JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE WHERE MD_SRC_SYSTEM = ''''INVESTIA-UNIVERIS'''') sbdv ON sbdv2.HK_LINK = sbdv.HK_LINK WHERE bdvcv1.MD_ACTIVE = ''''A''''
		)bdv2 ON rdv.HK_HUB_REGISTERED_REPRESENTATIVE = bdv2.HK_HUB_REGISTERED_REPRESENTATIVE
		LEFT JOIN 
		(
			SELECT srdv.HK_HUB, rdv2.ACCOUNT_RAP_CODE, rdv2.RETAIL_PLAN, rdv2.A_C_ACCOUNT_CLASS, srdv.PLN_MNEM_ENG
			FROM (
				SELECT *
				FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_INVESTIA_UNIVERIS
				) srdv
			JOIN (
				SELECT *
				FROM (
				...
				WHERE SATHUB3.RN3 = 1 AND SATHUB3.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''') 
				) bdvcv2 ON bdvcv2.HK_HUB = srdv.HK_HUB 
				JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.REF_INVESTMENT_SAVING_PROGRAM_TYPES WHERE MD_SRC_SYSTEM = ''''INVESTIA-UNIVERIS'''') rdv2 ON rdv2.HK_HUB = srdv.HK_HUB WHERE srdv.MD_ACTIVE = ''''A''''
		)bdv3 ON bdv0.HK_HUB = bdv3.HK_HUB
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SAT_REGISTERED_REPRESENTATIVE_TO_BDV_WT_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
,BUSINESS_RULES.SHARED_ADVISORS.UDF_CONV_BR_ALL_ADVISOR_001(RDV_BDV.BEGIN_DT,O_MD_START_DT) AS O_NEW_ADVISOR_IND
,BUSINESS_RULES.SHARED_ADVISORS.UDF_CONV_BR_ALL_ADVISOR_003(RDV_BDV.ADVISOR_BIRTH_DATE,O_MD_START_DT,O_ISCORPORATION)[''''o_AGE_SEGMENT''''] AS O_AGE_SEGMENT
,BUSINESS_RULES.SHARED_ADVISORS.UDF_CONV_BR_ALL_ADVISOR_003(RDV_BDV.ADVISOR_BIRTH_DATE,O_MD_START_DT,O_ISCORPORATION)[''''o_AGE_SEGMENT_ORD''''] AS O_AGE_SEGMENT_ORD
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SAT_REGISTERED_REPRESENTATIVE_TO_BDV_WT_PARTY_ROLE_ADVISOR_COMPUTE_INVESTIA_UNIVERIS"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
WITH
  ...
  JNR_PRV_WITH_MAINLINE AS (
   SELECT 
	...
	BUSINESS_RULES.SHARED_ADVISORS.UDF_CONV_BR_ALL_ADVISOR_001(o_CREATE_DT,O_MD_START_DT) AS NEW_ADVISOR_IND
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARED_TO_WT_IAS_NBIN_SATPLAN_COMPUTE"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
DATA_START_DATE :=CHAR(39)||DATA_START_DATE||CHAR(39);
DEL_QUERY := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_COMPUTE
WHERE MD_SRC_SYSTEM = ''''IAS'''''';
INS_QUERY :=''INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_COMPUTE(
MD_START_DT,
MD_CREATION_DT,
MD_SOURCE,
MD_SRC_SYSTEM,
...
WITH
  ...
  SELECT
	...
	MD_EXTRACT_DT,
	MD_ACTIVE
	FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG
	WHERE MD_START_DT <= TO_DATE(''||DATA_START_DATE||'',''''YYYY-MM-DD'''')
	GROUP BY HK_HUB,MD_HASHDIFF,MD_CREATION_DT,MD_CREATION_AUDIT_ID,MD_SOURCE,MD_SRC_SYSTEM,MD_EXTRACT_DT,MD_ACTIVE,MD_START_DT
  ),
  SAT AS (
      SELECT
		...
		B.MD_SRC_SYSTEM AS SAT_MD_SRC_SYSTEM,
		B.MD_START_DT AS SAT_MD_START_DT
		FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG B
		JOIN LV A
        ON A.HK_HUB = B.HK_HUB
		JOIN LV C
        ON C.O_MAX_DATE_LV = B.MD_START_DT
  ...
  HK_HUB,
  MD_START_DT,
  MAX(MD_START_DT) AS O_MAX_DATE_LV2,
  MD_HASHDIFF,
  MD_CREATION_DT,
  MD_CREATION_AUDIT_ID,
  MD_SOURCE,
  ...
  GROUP_TYPE_CODE,
  ACCUMULATION_TYPE
  FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.SAT_REF_RAPCODE_PLAN_IAS
  WHERE MD_START_DT <= TO_DATE(''||DATA_START_DATE||'',''''YYYY-MM-DD'''')
  GROUP BY HK_HUB,MD_HASHDIFF,MD_CREATION_DT,MD_CREATION_AUDIT_ID,MD_SOURCE,MD_SRC_SYSTEM,MD_EXTRACT_DT,MD_ACTIVE,MD_START_DT,PLAN_LABEL,ACCOUNT_TYPE,GROUP_TYPE_CODE,ACCUMULATION_TYPE
  ),
  SAT2 AS (
  SELECT 
  ...
  FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.SAT_REF_RAPCODE_PLAN_IAS B
  JOIN LV2 A
  ON A.HK_HUB = B.HK_HUB
  JOIN LV2 C
  ON C.O_MAX_DATE_LV2 = B.MD_START_DT
  WHERE B.MD_ACTIVE = ''''A'''' AND B.HK_HUB != ''''0''''
  ),
  JNR_REFF_P2 AS (
  SELECT
  ...
  FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.REF_RAPCODE_PLAN B
  JOIN SAT2 A
  ...
  SELECT
	...
	FROM JNR_REFF_P B
	JOIN JNR_REFF_P2 A
	ON B.REF_PLN_CD = A.REF_RAP_CODE_PLN_CD
  ),
  JNR_NOT_P_P2 AS (
  SELECT
	B.REF_A_C_ACCOUNT_CLASS AS REF_A_C_ACCOUNT_CLASS,
...
UPD_QUERY := ''UPDATE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_COMPUTE
SET
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARED_TO_WT_IAS_UNIVERIS_SATPLAN_COMPUTE"("ENV" VARCHAR(1000), "DATA_START_DATE" VARCHAR(20))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
WITH
  ...
  SELECT
	...
	FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.REF_INVESTMENT_SAVING_PROGRAM_TYPES B
	JOIN DB_IAWT_''||ENV||''_DWH.SHARED_RDV.REF_INVESTMENT_SAVING_PROGRAM_TYPES A
	ON B.PLN_MNEM = A.PLN_MNEM
	WHERE B.MD_SRC_SYSTEM =''''INVESTIA-UNIVERIS'''' AND A.MD_SRC_SYSTEM =''''IAS-UNIVERIS'''' AND B.MD_SRC_SYSTEM IS NOT NULL
  ),
  ...
  SELECT
	...
	FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_UNIVERIS B
	JOIN AGG_MaxDataSartDate A 
	ON B.HK_HUB = A.LV_HK_HUB
	JOIN AGG_MaxDataSartDate C
	ON B.MD_START_DT = C.O_DATA_START_DATE
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARED_TO_WT_SATACCOUNTHOLDER_COMPUTE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT rdv.HK_HUB
	...
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_002(clean.CLIENT_ANNUAL_GROSS_INC_CLEAN)[''''o_INCOME_LEVEL_1_SEGMENT'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_002(clean.CLIENT_ANNUAL_GROSS_INC_CLEAN)[''''o_INCOME_LEVEL_1_SEGMENT_ORD'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_001(clean.CLIENT_ANNUAL_GROSS_INC_CLEAN)[''''o_INCOME_LEVEL_2_SEGMENT'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_001(clean.CLIENT_ANNUAL_GROSS_INC_CLEAN)[''''o_INCOME_LEVEL_2_SEGMENT_ORD'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_003(rdv.CLIENT_BIRTH_DATE, rdv.MD_START_DT,(CASE WHEN rdv.CLIENT_TAX_RECIP_TYPE IN (''''0'''',''''3'''',''''4'''',''''5'''') THEN ''''True'''' ELSE ''''False'''' END))[''''o_AGE_SEGMENT'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_003(rdv.CLIENT_BIRTH_DATE, rdv.MD_START_DT,(CASE WHEN rdv.CLIENT_TAX_RECIP_TYPE IN (''''0'''',''''3'''',''''4'''',''''5'''') THEN ''''True'''' ELSE ''''False'''' END))[''''o_AGE_SEGMENT_ORD'''']
	,BUSINESS_RULES.SHARED_CLIENTS.UDF_CONV_BR_ALL_CLIENTS_004(rdv.MD_START_DT, rdv.CLIENT_INIT_CONTRACT_DATE)
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARED_TO_WT_SAT_INVESTMENTPRODUCTTYPE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''TRUNCATE TABLE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE  '';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE(
HK_HUB
,MD_START_DT
,MD_HASHDIFF
,MD_CREATION_DT
...
,UNI.MGT_CD
,UNI.MGT_NAME_ENG
FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS UNI 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) UNICV ON UNI.HK_HUB = UNICV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.HUB_INVESTMENT_PRODUCT_TYPE WHERE HK_HUB <> ''''0'''' AND MD_SRC_SYSTEM = ''''IAS-UNIVERIS'''') HUB_IAS ON UNI.HK_HUB = HUB_IAS.HK_HUB
...
,INV.MGT_CD
,INV.MGT_NAME_ENG
FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS INV 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) INVCV ON INV.HK_HUB = INVCV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.HUB_INVESTMENT_PRODUCT_TYPE WHERE HK_HUB <> ''''0'''' AND MD_SRC_SYSTEM = ''''INVESTIA-UNIVERIS'''') HUB_INV ON INV.HK_HUB = HUB_INV.HK_HUB
...
,NULL
FROM
(SELECT RDV_IAS.* FROM  DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_NBIN RDV_IAS 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_NBIN WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) RDV_IASCV ON RDV_IAS.HK_HUB = RDV_IASCV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.HUB_INVESTMENT_PRODUCT_TYPE WHERE HK_HUB <> ''''0'''' AND MD_SRC_SYSTEM = ''''IAS'''') HUB_IAS ON RDV_IAS.HK_HUB = HUB_IAS.HK_HUB
WHERE RDV_IAS.MD_ACTIVE = ''''A'''' AND RDV_IAS.HK_HUB <> ''''0'''') RDV1
LEFT JOIN 
(SELECT HUB_REF.TI_ALTERNATE_TI_TYPE,HUB_REF.TI_ALTERNATE_TI_CLASS,RDV_REF.* FROM  DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_MAPPING_PRODUCT_TYPE_IAS_IAVM RDV_REF 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_MAPPING_PRODUCT_TYPE_IAS_IAVM WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) RDV_REFCV ON RDV_REF.HK_HUB = RDV_REFCV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.REF_MAPPING_PRODUCT_TYPE WHERE HK_HUB <> ''''0'''') HUB_REF ON RDV_REF.HK_HUB = HUB_REF.HK_HUB
...
LEFT JOIN
(SELECT HUB_PRO.TI_ALTERNATE_TI_TYPE,RDV_PRO.* FROM  DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.SAT_REF_PRODUCT_ASSET_CATEGORY_IAS RDV_PRO 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.SAT_REF_PRODUCT_ASSET_CATEGORY_IAS WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) RDV_PROCV ON RDV_PRO.HK_HUB = RDV_PROCV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.REF_PRODUCT_ASSET_CATEGORY WHERE HK_HUB <> ''''0'''') HUB_PRO ON RDV_PRO.HK_HUB = HUB_PRO.HK_HUB
WHERE RDV_PRO .MD_ACTIVE = ''''A'''' AND RDV_PRO .HK_HUB <> ''''0'''' ) RDV3 
ON RDV1.TI_ALTERNATE_TI_TYPE = RDV3.TI_ALTERNATE_TI_TYPE
              '';
			  
INS_UPDATE :='' UPDATE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE_COMPUTE
SET
	MD_HASHDIFF=
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARED_TO_WT_SAT_INVESTMENTPRODUCTTYPE_COMPUTE"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
INS_PRE_DEL := ''TRUNCATE TABLE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE_COMPUTE  '';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE_COMPUTE
(HK_HUB
,MD_START_DT
,MD_CREATION_DT
,MD_SOURCE
...
,ISSUER_COMPANY_CODE
,ISSUER_COMPANY_NAME
FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.VW_INVESTMENT_PRODUCT_TYPE_COMPUTE
              '';
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARED_TO_WT_SAT_INVESTMENTPRODUCTTYPE_MERGE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''TRUNCATE TABLE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE_MERGE  '';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_INVESTMENT_PRODUCT_TYPE_MERGE
(
HK_HUB
,MD_START_DT
,MD_CREATION_DT
...
(SELECT *
			...
			FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.VW_INVESTMENT_PRODUCT_SYMBOLS WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) VW
		
LEFT JOIN 			
			
(SELECT HUB_FUND.*,RDV_FUND.FUNDDESCEN,RDV_FUND.GROUPNAMEEN FROM  DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_FUND_IAS_FUNDATA RDV_FUND 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_REF_FUND_IAS_FUNDATA WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) RDV_FUNDCV ON RDV_FUND.HK_HUB = RDV_FUNDCV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.REF_FUND WHERE HK_HUB <> ''''0'''') HUB_FUND ON RDV_FUND.HK_HUB = HUB_FUND.HK_HUB
...
(SELECT INV.* FROM  DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS INV 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) INVCV ON INV.HK_HUB = INVCV.HK_HUB
...
(SELECT UNI.* FROM  DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS UNI 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) UNICV ON UNI.HK_HUB = UNICV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.HUB_INVESTMENT_PRODUCT_TYPE WHERE HK_HUB <> ''''0'''') HUB_UNI ON UNI.HK_HUB = HUB_UNI.HK_HUB
...
(SELECT IAS.* FROM  DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_NBIN IAS 
JOIN 
(SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_NBIN WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) CV WHERE CV.RN = 1) IASCV ON IAS.HK_HUB = IASCV.HK_HUB
JOIN (SELECT * FROM DB_IAWT_''||ENV||''_DWH.SHARED_RDV.HUB_INVESTMENT_PRODUCT_TYPE WHERE HK_HUB <> ''''0'''') HUB_IAS ON IAS.HK_HUB = HUB_IAS.HK_HUB
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARE_IAS_COMMISSION_TO_BDV_LINK_SHARE"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
INS_QUERY := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE
...
A_C_REPRESENTATIVE,
MASTER_CODE
FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.VW_INITIAL_LOADING_WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE
              '';
			  
EXECUTE IMMEDIATE :INS_QUERY;
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_SHARE_TO_BDV_SAT_LINK_SHARE_MULTI_IMAGE"("ENV" VARCHAR(1000), "I_AUDIT_ID" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE (
HK_LINK
,MD_START_DT
,MD_HASHDIFF
,MD_CREATION_DT
...
,STG.TOREPID
FROM
DB_IAWT_''||ENV||''_DWH.SHARED_BDV.VW_INITIAL_LOADING_SAT_LINK_COMMISSION_SHARE_MULTIIMAGE SAT
LEFT JOIN
DB_IAWT_''||ENV||''_DWH.SHARED_BDV.VW_INITIAL_LOADING_WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE  STG
ON
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_UNIVERIS_HOLDINGS_TO_BDV_WT_SAT_PARTY_ROLE_ACCOUNT_HOLDER_AUA_SEG_COMPUTE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_UNIVERIS_SHARED_TO_WT_SATACCOUNTHOLDER_COMPUTE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_VIEW_SHARE_TO_BDV_WT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT
TRANS.MD_START_DT
,CASE WHEN ORG.SOURCE_MASTER_CODE IS NULL THEN ORG.MD_SOURCE ELSE ORG.SOURCE_MASTER_CODE END
,CURRENT_TIMESTAMP
,TRANS.MD_SRC_SYSTEM
,TRANS.MD_EXTRACT_DT
...
LEFT JOIN
(SELECT * FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.VW_ORGANIC_GROWTH_EXCEPTIONS_IAPW WHERE MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''') AND START_DATE <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''') AND END_DATE <= TO_DATE(''||i_DATA_START_DATE||'',''''YYYY-MM-DD'''')) ORG
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_VW_SAT_CONTRACT_TO_WT_SATCONTRACT_COMPUTE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_CONTRACT_COMPUTE WHERE 1=1'';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_CONTRACT_COMPUTE (
HK_HUB
,MD_START_DT
,MD_CREATION_DT
,MD_SOURCE
...
FROM (
	...
	FROM (
		...
		FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_CONTRACT_COMPUTE lv
		) SATHUB
	WHERE SATHUB.RN = 1
	) lv
	JOIN
	(
SELECT *
	FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_CONTRACT_COMPUTE
	) SRC ON lv.HK_HUB = SRC.HK_HUB
WHERE SRC.MD_ACTIVE = ''''A'''' AND lv.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''')
'';
INS_UPDATE :=''UPDATE DB_IAWT_''||ENV||''_DWH.SHARED_BDV.WT_SAT_CONTRACT_COMPUTE
SET
	MD_HASHDIFF=SHA1(
				CONCAT(
				COALESCE(PLAN_CODE,''''#NULL#''''), ''''|'''',
...
END
';
use schema  SHARED_RDV;

create or replace TABLE HUB_ADVISOR_IAS_CERTS (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE HUB_CONTRACT_BKP_14032022 (
	HK_HUB VARCHAR(40),
	MD_CREATION_DT TIMESTAMP_NTZ(9),
	MD_CREATION_AUDIT_ID VARCHAR(1000),
	MD_SOURCE VARCHAR(1000),
	...
	UNIVERIS_PLAN_ID NUMBER(38,0),
	UNIVERIS_CLIENT_ID NUMBER(38,0)
);
create or replace TABLE HUB_INVESTMENT_PRODUCT_TYPE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE HUB_PARTY_ROLE_ACCOUNT_HOLDER (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE HUB_REGISTERED_REPRESENTATIVE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE LINK_COMMISSION_SHARE_RR (
...
create or replace TABLE LINK_INVESTMENT_CONTRACT_RR (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(40) COMMENT 'Hash key for HUB_REGISTERED_REPRESENTATIVE',
...
create or replace TABLE REF_FUND (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE REF_HOLIDAYS_IAS_IAVM (
...
create or replace TABLE REF_INVESTMENT_SAVING_PROGRAM_TYPES (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE REF_MAPPING_PRODUCT_TYPE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE SAT_ADVISOR_IAS_CERTS (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_CONTRACT_IAS_NBIN (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_CONTRACT_IAS_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_CONTRACT_IAS_UNIVERIS_BKP_14032022 (
	HK_HUB VARCHAR(40),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_HASHDIFF VARCHAR(64),
	MD_CREATION_DT TIMESTAMP_NTZ(9),
	...
	MD_ACTIVE VARCHAR(1),
	PLN_CD VARCHAR(8000),
	PLN_STATUS VARCHAR(8000),
	PLN_ADM_CD VARCHAR(8000),
	SETUP_DT TIMESTAMP_NTZ(9),
	CLOSE_DT TIMESTAMP_NTZ(9),
	PEN_JUR_CD VARCHAR(8000),
	FEE_EXMP_IND NUMBER(38,0),
	ADMINISTRATOR_TYPE VARCHAR(8000),
	REP_SYSID NUMBER(38,0),
	REP_CD VARCHAR(50)
);
create or replace TABLE SAT_CONTRACT_INVESTIA_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_INVESTMENT_PRODUCT_TYPE_IAS_NBIN (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS (
...
create or replace TABLE SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_COMMISSION_SHARE_RR (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Sourc\r\ne system',
	MD_EXTRACT_DT TIMESTAMP_NTZ(9) COMMENT 'Source extraction date',
	MD_ACTIVE VARCHAR(1) COMMENT 'Active Flag, \"\"A\"\" row exists in the source, \"\"D\"\" row does not exist in the source',
	REVENUEPCT NUMBER(6,3) COMMENT 'Dispatch of revenues (percentage)',
	COMMISSIONPCT NUMBER(6,3) COMMENT 'Commission Sharing Percentage',
...
create or replace TABLE SAT_LINK_COMMISSION_SHARE_RR_INVESTIA_UNIVERIS (
	...
	COMM_RATE NUMBER(29,3) COMMENT 'Commission Rate',
	BRN_SYSID NUMBER(38,0) COMMENT 'Branch ID',
	BRN_CD VARCHAR(10) COMMENT 'Branch code'
);
create or replace TABLE SAT_LINK_INVESTMENT_CONTRACT_IAS_NBIN (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_INVESTMENT_CONTRACT_IAS_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_NBIN (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_UNIVERIS (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_PARTY_ROLE_ACCOUNT_HOLDER_INVESTIA_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_FUND_IAS_FUNDATA (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_HOLIDAYS_IAS_IAVM (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_UNIVERIS_BKP_14032022 (
	HK_HUB VARCHAR(40),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_HASHDIFF VARCHAR(64),
	MD_CREATION_DT TIMESTAMP_NTZ(9),
	...
	PLN_REG NUMBER(38,0),
	PLN_CD VARCHAR(8000),
	PLN_DESC VARCHAR(8000),
	PLN_MNEM_F VARCHAR(8000),
	PLN_DESC_F VARCHAR(8000),
	PLN_MNEM_ENG VARCHAR(8000),
	PLN_DESC_ENG VARCHAR(8000),
	PLN_SHORT_DESC_ENG VARCHAR(8000),
	PLN_MNEM_FRE VARCHAR(8000),
	PLN_DESC_FRE VARCHAR(8000),
	PLN_SHORT_DESC_FRE VARCHAR(8000),
	STMT_GROUP_MNEM VARCHAR(8000)
);
create or replace TABLE SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_INVESTIA_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_MAPPING_PRODUCT_TYPE_IAS_IAVM (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_PROVINCE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REGISTERED_REPRESENTATIVE_COMMISSION (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	HK_SAT VARCHAR(40) COMMENT 'Hash of the Satellite for the multi-active keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
...
create or replace TABLE SAT_REGISTERED_REPRESENTATIVE_IAS_CERTS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	HK_SAT VARCHAR(40) COMMENT 'Hash of the Satellite for the multi-active keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
...
create or replace TABLE SAT_REGISTERED_REPRESENTATIVE_IAS_IAVM (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REGISTERED_REPRESENTATIVE_IAS_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REGISTERED_REPRESENTATIVE_INVESTIA_UNIVERIS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace view VW_ADVISOR_IAS_CERTS(
	HK_HUB,
	MD_START_DT,
	MD_HASHDIFF,
	MD_SOURCE,
...
END_DT,
ADVISOR_BIRTH_DATE
FROM DB_IAWT_DEV_STG.IAS_CERTS.REGISTERED_REPRESENTATIVE;
create or replace view VW_HUB_REGISTERED_REPRESENTAVIVE_IAS_CERTS(
	HK_HUB,
	MD_SOURCE,
	MD_SRC_SYSTEM,
	MD_EXTRACT_DT,
...
create or replace view VW_IAS_GET_CLIENT_START_DATE(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	MD_START_DT,
	CLIENT_ID,
	CLIENT_START_DT,
...
ACCOUNT_START_DT_DATASET AS (
		...
		SELECT hub.HK_HUB, sat.A_C_CLIENT , sat.A_C_OPEN_DATE
			FROM  DB_IAWT_DEV_DWH.SHARED_RDV.SAT_CONTRACT_IAS_NBIN sat
			INNER JOIN DB_IAWT_DEV_DWH.SHARED_RDV.HUB_CONTRACT hub 
...
SELECT DISTINCT hub.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, sat.MD_START_DT, hub.CLIENT_ID, ASDT.A_C_OPEN_DATE AS CLIENT_START_DT, sat.MD_ACTIVE
FROM   DB_IAWT_DEV_DWH.SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR hub
INNER JOIN DB_IAWT_DEV_DWH.SHARED_RDV.SAT_LINK_INVESTMENT_CONTRACT_IAS_NBIN sat
...
create or replace view VW_IAS_GET_CLIENT_START_DATE_JIHED(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	MD_START_DT,
	CLIENT_ID,
	CLIENT_START_DT,
...
ACCOUNT_START_DT_DATASET AS (
		-- Get the Client, Clients Hash and Earliest Clients Open Date --
		SELECT hub.HK_HUB, sat.A_C_CLIENT , sat.A_C_OPEN_DATE--, ROW_NUMBER() OVER (PARTITION BY sat.A_C_CLIENT ORDER BY sat.MD_START_DT ) AS ROW_NB
...
AND sat.MD_SRC_SYSTEM = 'IAS'
LEFT JOIN ACCOUNT_START_DT_DATASET ASDT
ON ASDT.A_C_CLIENT = hub.CLIENT_ID --AND ASDT.ROW_NB = 1
;
create or replace view VW_INVESTMENT_PRODUCT_SYMBOLS(
	SYMBOL,
	MD_START_DT
) as 
...
WHERE UNI.HK_HUB <>'0'
UNION 
SELECT DISTINCT INV.SYMBOL AS SYMBOL , INV.MD_START_DT 
FROM SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS INV
WHERE INV.HK_HUB <>'0';
create or replace view VW_REGISTERED_REPRESENTATIVE_NOTNULL(
	HK_HUB,
	HK_SAT,
	MD_START_DT,
	MD_HASHDIFF,
...
FROM DB_IAWT_DEV_STG.IAS_CERTS.REGISTERED_REPRESENTATIVE
  WHERE RR_CD IS NOT NULL;
create or replace view VW_SAT_LINK_COMMISSION_SHARE_RR_MULTIIMAGE(
	HK_LINK,
	MD_START_DT,
	MD_HASHDIFF,
	PREVIOUS_HASHDIFF,
...
(
	...
	FROM DB_IAWT_DEV_STG.IAS_COMMISSION.VW_SHARE_AUD r	
),
SAT AS
(
	SELECT 	DISTINCT r.HK_LINK, 
			...
			LAST_VALUE(r.MD_HASHDIFF) over (partition by r.HK_LINK order by r.MD_START_DT asc) AS MD_HASHDIFF,
			'SAT' AS ROW_SRC
	FROM DB_IAWT_DEV_DWH.SHARED_RDV.SAT_LINK_COMMISSION_SHARE_RR r
	WHERE MD_SRC_SYSTEM = 'IAS'
),
SRC AS
(
...
SELECT RSLT.* 
FROM RSLT
LEFT JOIN DB_IAWT_DEV_DWH.SHARED_RDV.SAT_LINK_COMMISSION_SHARE_RR S ON RSLT.HK_LINK = S.HK_LINK AND RSLT.MD_START_DT = S.MD_START_DT
WHERE S.HK_LINK IS NULL;
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADRDV_IAS_COMISSION_TO_SAT_LINK_SHARE_RR_DELETE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_QUERY := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.SHARED_RDV.SAT_LINK_COMMISSION_SHARE_RR
WITH share_hist AS (
SELECT
    HK_LINK,
    MD_START_DT,
...
create or replace TABLE LINK_SERVICING_CODES (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
...
create or replace TABLE SAT_LINK_SERVICING_CODES (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE WT_SERVICING_CODES (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash of the business keys of party role advisor',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(40) COMMENT 'Hash of the business keys of servicing advisor',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace view VW_IAS_MAPPING_OPER_TYPE(
	HK_HUB,
	MD_SRC_SYSTEM,
	IBMSOURCE,
	LEVEL,
...
FROM DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.REF_MAPPING_OPER_TYPE R
INNER JOIN DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.SAT_REF_MAPPING_OPER_TYPE_IAS S
ON R.HK_HUB=S.HK_HUB
INNER JOIN (SELECT HK_HUB,MAX(MD_START_DT) AS MAX_MD_START_DT FROM DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.SAT_REF_MAPPING_OPER_TYPE_IAS GROUP BY HK_HUB)LVS
ON S.HK_HUB=LVS.HK_HUB AND S.MD_START_DT=LVS.MAX_MD_START_DT
WHERE S.MD_ACTIVE='A';
create or replace view VW_SERVICING_CODES_SPLIT(
	HK_HUB,
	MD_START_DT,
	MD_EXTRACT_DT,
	MD_SOURCE,
...
S.PRESTIGE_STATUS,
S.MD_ACTIVE
FROM STEWARDSHIP_RDV.SAT_REF_SERVICING_CODES_IAPW S
INNER JOIN STEWARDSHIP_RDV.REF_SERVICING_CODES R ON S.HK_HUB = R.HK_HUB,
lateral flatten(input=>split(TRIM(UPPER(SERVICING_CODE)), ','),OUTER => TRUE) c;
CREATE OR REPLACE PROCEDURE "DB_IAWT_DEV_DWH.STEWARDSHIP_BDV.SP_CONV_LOADBDV_RDV_STEWARDSHIP_IAPW_TO_WT_SERVICING_CODES"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_BDV.WT_SERVICING_CODES 
(	HK_LINK,
	MD_START_DT,
	MD_CREATION_DT,
	MD_SOURCE,
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_STEWARDSHIP_IAPW_TO_WT_SERVICING_CODES"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
use schema  STEWARDSHIP_RDV;

create or replace TABLE REF_DATE (
	DATE DATE NOT NULL,
...
;
create or replace TABLE REF_MANUAL_ADVISOR_RVP_IAS (
...
create or replace TABLE REF_MAPPING_OPER_TYPE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE REF_NEW_ADVISOR (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE REF_ORGANIC_GROWTH_EXCEPTIONS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE REF_PRODUCT_ASSET_CATEGORY (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE REF_SERVICING_CODES (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE SAT_REF_MANUAL_ADVISOR_RVP_IAS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_MAPPING_OPER_TYPE_IAS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_MONTHLY_MILESTONES_IAS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_NEW_ADVISOR_IAPW (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_ORGANIC_GROWTH_EXCEPTIONS_IAPW (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_PRODUCT_ASSET_CATEGORY_IAS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_RAPCODE_PLAN_IAS (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_REF_SERVICING_CODES_IAPW (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SEQ NUMBER(11,0),
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
...
create or replace view VW_NEW_ADVISOR(
	HK_HUB,
	MD_START_DT,
	MD_HASHDIFF,
	MD_CREATION_DT,
...
,PREVIOUS_FIRM
,PREVIOUS_FIRM_TYPE
FROM DB_IAWT_DEV_STG.STEWARDSHIP.REF_NEW_ADVISOR
...
SELECT
	...
	s.END_DATE
FROM
	DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.REF_ORGANIC_GROWTH_EXCEPTIONS h
INNER JOIN DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.SAT_REF_ORGANIC_GROWTH_EXCEPTIONS_IAPW s 
ON
	s.HK_HUB = h.HK_HUB
WHERE
...
create or replace view VW_SERVICING_CODES(
	HK_HUB,
	MD_START_DT,
	MD_HASHDIFF,
	MD_SEQ,
...
SERVICING_CODE,
PRESTIGE_STATUS
FROM DB_IAWT_DEV_STG.STEWARDSHIP.REF_SERVICING_CODES
QUALIFY ROW_NUMBER() OVER (PARTITION BY HK_HUB ORDER BY HK_HUB ) = 1;
use schema  TOOLS;
...
create or replace TABLE AUDIT_JOBS_EXECUTIONS_TEST_MONITORING (
	JOB_NAME VARCHAR(1000) COMMENT 'Taskflow name',
	DATA_START_DT DATE COMMENT 'Functional start Load date',
	DATA_NEXT_START_DT DATE COMMENT 'Functional next start Load date',
	UPDATE_JOB_AUDIT_ID VARCHAR(1000) COMMENT 'Taskflow job ID that updated this record',
...
create or replace TABLE ENTITY_COLUMNS (
...
create or replace TABLE HUB_TEST (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE PIT_PARTY_ROLE_ACCOUNT_HOLDER (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_POSITION_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	HK_HUB_SAT VARCHAR(64) COMMENT 'Hash key for the Hub from the Satellite table',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_SRC_SAT VARCHAR(1000) COMMENT 'Source Satellite',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
	MD_SRC_SYSTEM VARCHAR(100) COMMENT 'Source system'
);
create or replace TABLE TEST_NEXT (
	COL_TEST VARCHAR(100)
);
create or replace view VW_PIT_PARTY_ROLE_ACCOUNT_HOLDER(
	MD_POSITION_DT,
	HK_HUB,
	MD_START_DT,
	MD_HASHDIFF,
...
SELECT p.MD_POSITION_DT, s.*
FROM TOOLS.PIT_PARTY_ROLE_ACCOUNT_HOLDER p
LEFT JOIN SHARED_RDV.SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_NBIN s
ON s.HK_HUB = p.HK_HUB AND s.MD_START_DT = p.MD_START_DT;
CREATE OR REPLACE PROCEDURE "SP_AUDIT_JOB"("SRC_OBJ" VARCHAR(16777216), "TGT_OBJ" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
var result_scan = sql_statement.execute();	
';
CREATE OR REPLACE PROCEDURE "SP_AUDIT_STARTJOB_NEXTDATE"("ENV" VARCHAR(16777216), "JOB_NAME" VARCHAR(16777216), "AUDIT_ID" VARCHAR(16777216), "IO_RESULT" VARCHAR(16777216), "IO_DATASTARTDATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
 var CALL_PROCEDURE = "DB_IAWT_" + ENV + "_DWH.tools.USP_AUDIT_START_JOB_NEXT_DATE";
 ...
 var tbl_obj = "db_IAWT_" + ENV + "_dwh.tools.audit_jobs_executions";
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_AUDIT_STARTJOB_NEXTDATE"("ENV" VARCHAR(16777216), "JOB_NAME" VARCHAR(16777216), "AUDIT_ID" VARCHAR(16777216), "IO_RESULT" VARCHAR(16777216), "IO_DATASTARTDATE" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
var sle_query = "select job_action_result ,to_varchar(job_data_start_dt_result,''YYYY-MM-DD'') from " + tbl_obj + " where job_status = ''IN PROGRESS'' AND UPPER(JOB_NAME) = UPPER(REPLACE(?,''CHAR(39)'',''''))";
 ...
 return res.getColumnValue(1) + '','' + res.getColumnValue(2);
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADHUB_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADLINK_AUDIT_ID_RK"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADLINK_AUDIT_ID_SC"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '

var INS_QUERY = "INSERT INTO "+ TGT_TBL + "(" + INSERT_COLS + ") SELECT " + SELECT_COLS + " FROM " + SRC_TBL + " SRC LEFT JOIN "+ TGT_TBL +" LINK ON SRC.HK_LINK = LINK.HK_LINK  WHERE LINK.HK_LINK IS NULL;"
var TRUN_QUERY = "TRUNCATE TABLE " + TGT_TBL +";"
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADLINK_AUDIT_ID_SC_JITHU"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADLINK_MULTIIMAGE_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
if (TRUNC_TBL == ''Y'')
   ...
   var result_scan = sql_statement.execute();		
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADSATELLITE_DELETE_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
if (TRUNC_TBL == ''Y'')
   ...
   var result_scan = sql_statement.execute();		
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADSATELLITE_INSERT_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
if (TRUNC_TBL == ''Y'')
   ...
   var result_scan = sql_statement.execute();		
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADSATLINK_DELETE_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
if (TRUNC_TBL == ''Y'')
   ...
   var result_scan = sql_statement.execute();		
';
CREATE OR REPLACE PROCEDURE "SP_CONV_DATAVAULT_LOADSATLINK_INSERT_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_BDV.VW_SERVICING_CODES_SPLIT src
JOIN 
(SELECT * FROM (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_HUB ORDER BY MD_START_DT DESC) RN FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_BDV.VW_SERVICING_CODES_SPLIT) srcHUB WHERE srcHUB.RN = 1 AND srcHUB.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''')) sat
ON sat.HK_HUB = src.HK_HUB AND sat.MD_START_DT = TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''')
WHERE sat.MD_ACTIVE=''''A'''' and sat.HK_HUB<>''''0''''
              '';
INS_UPDATE :=''
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRANSACTIONS_IAS_UNIVERIS_TO_BDV_WT_LINK_TRANSACTIONS_IAS_UNIVERIS"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT
	...
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_TRANSACTION_TYPE_001(trdv.SPR_CTGY,trdv.TRX_MNEM_ENG)[''''o_TRANSACTION_TYPE'''']
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_TRANSACTION_TYPE_001(trdv.SPR_CTGY,trdv.TRX_MNEM_ENG)[''''o_ORD_TRANSACTION_TYPE'''']
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_CASH_FLOW_002(trdv.TRX_MNEM_ENG)
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_CASH_FLOW_003((trdv.TRX_MNEM_ENG),(trdv.TRX_GROSS*1))
...
var sql_statement2 = snowflake.createStatement({
 ...
 var result2_scan = sql_statement2.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_TOOLS_AUDIT_TO_SHARED_WT_BDV_WT_CAMPAIGN"("ENV" VARCHAR(16777216), "JOB_NAME" VARCHAR(16777216), "DATA_START_DT" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS ' 
...
var sql_statement2 = snowflake.createStatement({
 ...
 var result2_scan = sql_statement2.execute(); 
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADSATLINK_MULTIIMAGE_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_STG_COUNT"("ENV" VARCHAR(16777216), "TBL_SCHEMA" VARCHAR(16777216), "TABLE_NAME" VARCHAR(16777216))
RETURNS VARCHAR(10000)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
;
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADHUB_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '

var INS_QUERY = "INSERT INTO "+ TGT_TBL + "(" + INSERT_COLS + ") SELECT " + SELECT_COLS + " FROM " + SRC_TBL + " STG LEFT JOIN "+ TGT_TBL +" HUB ON STG.HK_HUB = HUB.HK_HUB  WHERE HUB.HK_HUB IS NULL ORDER BY STG.HK_HUB;"
var TRUN_QUERY = "TRUNCATE TABLE " + TGT_TBL +";"
...
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADLINK_AUDIT_ID"("SRC_MASTER_OBJECT" VARCHAR(255), "SRC_DTLS_OBJECT" VARCHAR(255), "TGT_OBJECT" VARCHAR(255), "I_LINK_HK_LINK" VARCHAR(251), "I_SRC_HK_LINK" VARCHAR(251), "TGT_MAPPING" VARCHAR(1000), "I_AUDIT_ID" VARCHAR(255))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADLINK_AUDIT_ID_RK"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '

var INS_QUERY = "INSERT INTO "+ TGT_TBL + "(" + INSERT_COLS + ") SELECT " + SELECT_COLS + " FROM " + SRC_TBL + " STG LEFT JOIN "+ TGT_TBL +" LNK ON STG.HK_LINK = LNK.HK_LINK  WHERE LNK.HK_LINK IS NULL;"
var TRUN_QUERY = "TRUNCATE TABLE " + TGT_TBL +";"
...
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADLINK_AUDIT_ID_TST"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '

var INS_QUERY = "INSERT INTO "+ TGT_TBL + "(" + INSERT_COLS + ") SELECT " + SELECT_COLS + " FROM " + SRC_TBL + " STG LEFT JOIN "+ TGT_TBL +" HUB ON STG.HK_HUB = HUB.HK_HUB  WHERE HUB.HK_HUB IS NULL;"
var TRUN_QUERY = "TRUNCATE TABLE " + TGT_TBL +";"
...
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADSATELLITE_DELETE_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
if (TRUNC_TBL == ''Y'')
   ...
   var result_scan = sql_statement.execute();		
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADSATELLITE_INSERT_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
if (TRUNC_TBL == ''Y'')
   ...
   var result_scan = sql_statement.execute();		
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADSATLINK_DELETE_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
if (TRUNC_TBL == ''Y'')
   ...
   var result_scan = sql_statement.execute();		
';
CREATE OR REPLACE PROCEDURE "SP_DATAVAULT_LOADSATLINK_INSERT_AUDIT_ID"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "TRUNC_TBL" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
var INS_QUERY = "INSERT INTO "+ TGT_TBL + "(" + INSERT_COLS + ") SELECT " +  SELECT_COLS + " FROM " + SRC_TBL + " SRC LEFT JOIN (SELECT * FROM  (SELECT *, ROW_NUMBER() OVER(PARTITION BY HK_LINK ORDER BY MD_START_DT DESC) RN FROM "  + TGT_TBL + "  SAT) SATLINK WHERE SATLINK.RN = 1 AND SATLINK.MD_ACTIVE =''A'') SAT ON SAT.HK_LINK = SRC.HK_LINK AND  SAT.MD_HASHDIFF  = SRC.MD_HASHDIFF WHERE SAT.HK_LINK  IS NULL;";
var TRUN_QUERY = "TRUNCATE TABLE " + TGT_TBL +";";
...
';
CREATE OR REPLACE PROCEDURE "SP_LOAD_TRANSACTION_ENTRIES"("DEV" VARCHAR(256))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
 var TRANSACTIONS = "db_ctb_" + DEV + "_dm.ctb.TRANSACTIONS";
 var V_LOAD_AHCS_TRANSACTIONS = "db_ctb_" + DEV + "_dwh.ctb.V_LOAD_AHCS_TRANSACTIONS";
 var V_LOAD_GL_TRANSACTIONS = "db_ctb_" + DEV + "_dwh.ctb.V_LOAD_GL_TRANSACTIONS"; 
 var V_REPORTING_PERIODS = "db_ctb_" + DEV  + "_dm.ctb.V_REPORTING_PERIODS"; 
 var select_ahcs = "select HK_LINK,MD_HASHDIFF,ACCOUNTING_PERIOD,SYSTEMESOURCE,ID_PRIMAIRE,ID_SECONDAIRE,ID_RECLAMATION,ID_REASSURANCE,ID_COMPLEMENT,ID_MANUEL_001,ID_MANUEL_002,ID_MANUEL_003,ID_MANUEL_004,ID_MANUEL_005,ACCOUNTING_ENTRY_TYPE,LEDGER_NAME,ENTITY,NATURE,COST_CENTER,INTERCO,LOB,PRODUCT,PARTICIPATION,GEOGRAPHY,PERIODICITY,ORIGIN,PROJECT,FUTUR1,FUTUR2,DEBIT,CREDIT,SOLDE,''AHCS'' as MD_System_Source, CURRENT_TIMESTAMP AS MD_Creation_Date from IDENTIFIER(?)";
 var select_GL = "select HK_LINK,MD_HASHDIFF,ACCOUNTING_PERIOD,SYSTEMESOURCE,ID_PRIMAIRE,ID_SECONDAIRE,ID_RECLAMATION,ID_REASSURANCE,ID_COMPLEMENT,ID_MANUEL_001,ID_MANUEL_002,ID_MANUEL_003,ID_MANUEL_004,ID_MANUEL_005,ACCOUNTING_ENTRY_TYPE,LEDGER_NAME,ENTITY,NATURE,COST_CENTER,INTERCO,LOB,PRODUCT,PARTICIPATION,GEOGRAPHY,PERIODICITY,ORIGIN,PROJECT,FUTUR1,FUTUR2,DEBIT,CREDIT,SOLDE,''GL'' as MD_System_Source, CURRENT_TIMESTAMP AS MD_Creation_Date from IDENTIFIER(?)";
 var union_query =  "(" + select_ahcs + " Union " + select_GL + ")";
 var trans_join_query = "( SELECT HK_LINK,MD_HASHDIFF,ACCOUNTING_PERIOD,MD_System_Source,currentversion FROM IDENTIFIER(?) MST JOIN  IDENTIFIER(?) DTL ON MST.NOMPERIODE = DTL.ACCOUNTING_PERIOD WHERE DTL.CURRENTVERSION = ''1'' )"
 var final_select_query = "select  Mstr.HK_LINK,Mstr.MD_HASHDIFF,Mstr.ACCOUNTING_PERIOD,Mstr.SYSTEMESOURCE,Mstr.ID_PRIMAIRE,Mstr.ID_SECONDAIRE,Mstr.ID_RECLAMATION,Mstr.ID_REASSURANCE,Mstr.ID_COMPLEMENT,Mstr.ID_MANUEL_001,Mstr.ID_MANUEL_002,Mstr.ID_MANUEL_003,Mstr.ID_MANUEL_004,Mstr.ID_MANUEL_005,Mstr.ACCOUNTING_ENTRY_TYPE,Mstr.LEDGER_NAME,Mstr.ENTITY,Mstr.NATURE,Mstr.COST_CENTER,Mstr.INTERCO,Mstr.LOB,PRODUCT,Mstr.PARTICIPATION,Mstr.GEOGRAPHY,Mstr.PERIODICITY,Mstr.ORIGIN,PROJECT,Mstr.FUTUR1,Mstr.FUTUR2,Mstr.DEBIT,Mstr.CREDIT,Mstr.SOLDE,Mstr.MD_System_Source, Mstr.MD_Creation_Date,null as currentversion  from " + union_query + " AS  MSTR  left outer join " + trans_join_query + " AS DTLS ON  MSTR.HK_LINK = DTLS.HK_LINK AND MSTR.MD_System_Source = DTLS.MD_System_Source AND  mstr.md_hashdiff   = dtls.md_hashdiff where dtls.md_hashdiff IS  NULL" 
 var final_insert_query = "insert into IDENTIFIER(?) (HK_LINK,MD_HASHDIFF,ACCOUNTING_PERIOD,SYSTEMESOURCE,ID_PRIMAIRE,ID_SECONDAIRE,ID_RECLAMATION,ID_REASSURANCE,ID_COMPLEMENT,ID_MANUEL_001,ID_MANUEL_002,ID_MANUEL_003,ID_MANUEL_004,ID_MANUEL_005,ACCOUNTING_ENTRY_TYPE,LEDGER_NAME,ENTITY,NATURE,COST_CENTER,INTERCO,LOB,PRODUCT,PARTICIPATION,GEOGRAPHY,PERIODICITY,ORIGIN,PROJECT,FUTUR1,FUTUR2,DEBIT,CREDIT,SOLDE,MD_System_Source, MD_Creation_Date, currentversion) " + final_select_query;
 var  insert_STMT = snowflake.createStatement({ sqlText:final_insert_query,binds:[TRANSACTIONS,V_LOAD_AHCS_TRANSACTIONS,V_LOAD_GL_TRANSACTIONS,V_REPORTING_PERIODS,TRANSACTIONS]});
 var res = insert_STMT.execute();
 ';
CREATE OR REPLACE PROCEDURE "SP_RECONCILIATION"("ENV" VARCHAR(16777216), "AUDIT_ID" VARCHAR(16777216), "IO_DATA_START_DATE" VARCHAR(16777216), "IO_NAME" VARCHAR(255), "IO_PATTERN" VARCHAR(255))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '

var del_stmt = "DELETE FROM DB_IAWT_"+ ENV + 
  ...
  var sql_statement = snowflake.createStatement(
   ...
   var result_scan = sql_statement.execute();   
   var call_stmt = "CALL DB_IAWT_" + ENV + 
...
';
CREATE OR REPLACE PROCEDURE "SP_STG_COUNT"("ENV" VARCHAR(16777216), "TBL_SCHEMA" VARCHAR(16777216), "TABLE_NAME" VARCHAR(16777216))
RETURNS VARCHAR(10000)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "USP_AUDIT_END_JOB"("JOB_NAME" VARCHAR(16777216), "DATA_START_DT" VARCHAR(16777216), "JOB_AUDIT_ID" VARCHAR(16777216), "JOB_END_STATUS" VARCHAR(16777216), "JOB_END_DESC" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
';
CREATE OR REPLACE PROCEDURE "USP_AUDIT_START_JOB"("JOB_NAME" VARCHAR(16777216), "DATA_START_DT" VARCHAR(10), "JOB_AUDIT_ID" VARCHAR(16777216))
RETURNS VARCHAR(100)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
...
var cmd =  "SELECT CASE WHEN JOB_STATUS IS NOT NULL AND JOB_ACTION_RESULT = ''SUCCESS'' THEN ''SUCCESS'' ELSE ''ERROR'' END AS tmp_result FROM DB_IAWT_DEV_DWH.TOOLS.AUDIT_JOBS_EXECUTIONS WHERE JOB_STATUS=''IN PROGRESS'' AND  JOB_NAME=  Replace(''"+JOB_NAME+"'', CHR(39), '''')  AND DATA_START_DT =  TO_DATE(Replace(''"+DATA_START_DT+"'', CHR(39), ''''),''YYYY-MM-DD'')";
var st = snowflake.createStatement( { sqlText: cmd } );
var res = st.execute();
var op=''''
while (res.next())  {
...
return op;
';
CREATE OR REPLACE PROCEDURE "USP_AUDIT_START_JOB_VARIABLE_SET_TEST"("JOB_NAME" VARCHAR(16777216), "DATA_START_DT" VARCHAR(10))
RETURNS VARCHAR(100)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
var cmd =  "SELECT CASE WHEN JOB_STATUS IS NOT NULL AND JOB_ACTION_RESULT = ''SUCCESS'' THEN ''SUCCESS'' ELSE ''ERROR'' END AS tmp_result FROM DB_IAWT_DEV_DWH.TOOLS.AUDIT_JOBS_EXECUTIONS WHERE JOB_STATUS=''IN PROGRESS'' AND  JOB_NAME=  Replace(''tf_LoadRDV_20-30_PSA_IAS_NBIN_to_RDV_CASH_HOLDINGS'', CHR(39), '''')  AND DATA_START_DT =  TO_DATE(Replace(''2021-01-01'', CHR(39), ''''),''YYYY-MM-DD'')";
var st = snowflake.createStatement( { sqlText: cmd } );
var res = st.execute();
var op=''''
while (res.next())  {
...
return op;
';
CREATE OR REPLACE PROCEDURE "USP_CONV_M_FACT_INSERT"("INSERT_COLS" VARCHAR(16777216), "SELECT_COLS" VARCHAR(16777216), "SRC_TBL" VARCHAR(16777216), "TGT_TBL" VARCHAR(16777216), "JOB_NAME" VARCHAR(16777216), "JOB_AUDIT_ID" VARCHAR(16777216), "RUN_ID" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
END
';
use schema  TOOLS_REG_TESTS;

create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_BDV__LINK_INVESTMENT_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_BDV__LINK_INVESTMENT_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_BDV__SAT_LINK_INVESTMENT_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_BDV__SAT_LINK_INVESTMENT_RES (
	RES VARCHAR(2),
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__LINK_INVESTMENT_RR_IAS_NBIN_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(40) COMMENT 'Hash key for HUB_REGISTERED_REPRESENTATIVE',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__LINK_INVESTMENT_RR_IAS_NBIN_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_CASH_RR_IAS_NBIN_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_CASH_RR_IAS_NBIN_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_IAS_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_RR_IAS_NBIN_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_RR_IAS_NBIN_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_RR_IAS_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_RR_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9)
);
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_RR_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__HOLDINGS_RDV__SAT_LINK_INVESTMENT_RR_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_BDV__LINK_REVENUE_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	HK_HUB_REF_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40) COMMENT 'Hash key for the REF_INVESTMENT_SAVING_PROGRAM_TYPES',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_BDV__LINK_REVENUE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__LINK_REVENUE_RR_IAS_COMMISSION_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__LINK_REVENUE_RR_IAS_COMMISSION_RES (
	RES_VALUE VARCHAR(16777216),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__LINK_REVENUE_RR_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for HUB_INVESTMENT_PRODUCT_TYPE',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__LINK_REVENUE_RR_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__LINK_REVENUE_RR_TBD_REF (
	HK_LINK VARCHAR(40),
	HK_HUB_CONTRACT VARCHAR(40),
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40),
	MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__LINK_REVENUE_RR_TBD_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__REF_COM_PRODUCTION_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__REF_COM_PRODUCTION_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_PAYABLE_RR_IAS_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_PAYABLE_RR_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_PAYABLE_RR_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_PAYABLE_RR_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_TRAILER_FEES_RR_IAS_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_TRAILER_FEES_RR_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_TRAILER_FEES_RR_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_TRAILER_FEES_RR_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_WRAP_FEE_RR_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_LINK_REVENUE_WRAP_FEE_RR_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_REF_COM_PRODUCTION_INVESTIA_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_REF_COM_PRODUCTION_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_REF_COM_PRODUCTION_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__REVENUES_RDV__SAT_REF_COM_PRODUCTION_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__HUB_PARTY_ROLE_ADVISOR_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__HUB_PARTY_ROLE_ADVISOR_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__LINK_INVESTMENT_CONTRACT_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ADVISOR',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__LINK_INVESTMENT_CONTRACT_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE_REF (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(64) COMMENT 'Hash of the business keys REGISTERED REPRESENTATIVE',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(64) COMMENT 'Hash of the business keys PARTY ROLE ADVISOR',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(64),
	REF_HK_LINK VARCHAR(64)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__REF_INVESTMENT_SAVING_PROGRAM_TYPES_AGG_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__REF_INVESTMENT_SAVING_PROGRAM_TYPES_AGG_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_CONTRACT_COMPUTE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_CONTRACT_COMPUTE_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_INVESTMENT_PRODUCT_TYPE_COMPUTE_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Sat',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_INVESTMENT_PRODUCT_TYPE_COMPUTE_RES (
	RES VARCHAR(2),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_LINK_INVESTMENT_CONTRACT_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_LINK_INVESTMENT_CONTRACT_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE_REF (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_AUA_SEG_COMPUTE_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_AUA_SEG_COMPUTE_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_CLEAN_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_CLEAN_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_COMPUTE_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_COMPUTE_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ADVISOR_AUA_SEG_COMPUTE_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ADVISOR_AUA_SEG_COMPUTE_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_PARTY_ROLE_ADVISOR_COMPUTE_IAS_WEALTH_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_HUB VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_COMPUTE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Sat',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_COMPUTE_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_AGG_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__TRANSLINK_EXCHANGE_RATE_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_BDV__TRANSLINK_EXCHANGE_RATE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_ADVISOR_IAS_CERTS_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_ADVISOR_IAS_CERTS_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(64),
	REF_HK_HUB VARCHAR(64)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_CONTRACT_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_CONTRACT_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_INVESTMENT_PRODUCT_TYPE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_INVESTMENT_PRODUCT_TYPE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_PARTY_ROLE_ACCOUNT_HOLDER_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_PARTY_ROLE_ACCOUNT_HOLDER_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_REGISTERED_REPRESENTATIVE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__HUB_REGISTERED_REPRESENTATIVE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__LINK_COMMISSION_SHARE_RR_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	HK_HUB_FROM VARCHAR(40) COMMENT 'Hash key for the Hub',
	HK_HUB_TO VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__LINK_COMMISSION_SHARE_RR_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__LINK_INVESTMENT_CONTRACT_RR_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for HUB_CONTRACT',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for HUB_PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(40) COMMENT 'Hash key for HUB_REGISTERED_REPRESENTATIVE',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__LINK_INVESTMENT_CONTRACT_RR_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_FUND_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_FUND_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_HOLIDAYS_IAS_IAVM_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_HOLIDAYS_IAS_IAVM_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_INVESTMENT_SAVING_PROGRAM_TYPES_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_INVESTMENT_SAVING_PROGRAM_TYPES_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_MAPPING_PRODUCT_TYPE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_MAPPING_PRODUCT_TYPE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_PROVINCE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__REF_PROVINCE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_ADVISOR_IAS_CERTS_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_ADVISOR_IAS_CERTS_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_CONTRACT_IAS_NBIN_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_CONTRACT_IAS_NBIN_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_CONTRACT_IAS_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_CONTRACT_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_CONTRACT_INVESTIA_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_CONTRACT_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40),
	RES_MD_HASHDIFF VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_INVESTMENT_PRODUCT_TYPE_IAS_NBIN_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_INVESTMENT_PRODUCT_TYPE_IAS_NBIN_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS_REF (
	HK_HUB VARCHAR(100) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(100) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(100),
	REF_MD_HASHDIFF VARCHAR(100),
	RES_HK_HUB VARCHAR(100),
	REF_HK_HUB VARCHAR(100)
);
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40),
	RES_MD_HASHDIFF VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_COMMISSION_SHARE_RR_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_COMMISSION_SHARE_RR_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_COMMISSION_SHARE_RR_REF (
	HK_LINK VARCHAR(64) COMMENT 'Hash of the business keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_COMMISSION_SHARE_RR_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_INVESTMENT_CONTRACT_IAS_NBIN_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_INVESTMENT_CONTRACT_IAS_NBIN_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_INVESTMENT_CONTRACT_IAS_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_INVESTMENT_CONTRACT_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_LINK_INVESTMENT_CONTRACT_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_NBIN_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_NBIN_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_HUB VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_UNIVERIS_REF (
	HK_HUB VARCHAR(64) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(64),
	REF_HK_HUB VARCHAR(64),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_INVESTIA_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_PARTY_ROLE_ACCOUNT_HOLDER_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_FUND_IAS_FUNDATA_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_FUND_IAS_FUNDATA_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_HOLIDAYS_IAS_IAVM_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_HOLIDAYS_IAS_IAVM_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_NBIN_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_INVESTIA_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_INVESTMENT_SAVING_PROGRAM_TYPES_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_MAPPING_PRODUCT_TYPE_IAS_IAVM_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_MAPPING_PRODUCT_TYPE_IAS_IAVM_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_PROVINCE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REF_PROVINCE_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_COMMISSION_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	HK_SAT VARCHAR(40) COMMENT 'Hash of the Satellite for the multi-active keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_COMMISSION_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_IAS_CERTS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	HK_SAT VARCHAR(40) COMMENT 'Hash of the Satellite for the multi-active keys',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_IAS_CERTS_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_IAS_IAVM_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_IAS_IAVM_RES (
	RES VARCHAR(2),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40),
	RES_MD_HASHDIFF VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_IAS_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_INVESTIA_UNIVERIS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__SAT_REGISTERED_REPRESENTATIVE_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__TRANSLINK_EXCHANGE_RATE_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
...
create or replace TABLE DB_IAWT_DEV_DWH__SHARED_RDV__TRANSLINK_EXCHANGE_RATE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_BDV__LINK_SERVICING_CODES_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash of the business keys of party role advisor',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(40) COMMENT 'Hash of the business keys of servicing advisor',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_BDV__LINK_SERVICING_CODES_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_BDV__SAT_LINK_SERVICING_CODES_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_BDV__SAT_LINK_SERVICING_CODES_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_HK_LINK VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_MANUAL_ADVISOR_RVP_IAS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_MANUAL_ADVISOR_RVP_IAS_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_MAPPING_OPER_TYPE_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_MAPPING_OPER_TYPE_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_MONTHLY_MILESTONES_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_MONTHLY_MILESTONES_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_NEW_ADVISOR_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_NEW_ADVISOR_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_PRODUCT_ASSET_CATEGORY_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_PRODUCT_ASSET_CATEGORY_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_RAPCODE_PLAN_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_RAPCODE_PLAN_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_SERVICING_CODES_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__REF_SERVICING_CODES_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_HUB VARCHAR(40),
	REF_HK_HUB VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_MANUAL_ADVISOR_RVP_IAS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_MANUAL_ADVISOR_RVP_IAS_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_MAPPING_OPER_TYPE_IAS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_MAPPING_OPER_TYPE_IAS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_MONTHLY_MILESTONES_IAS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_MONTHLY_MILESTONES_IAS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_NEW_ADVISOR_IAPW_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_NEW_ADVISOR_IAPW_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_PRODUCT_ASSET_CATEGORY_IAS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_PRODUCT_ASSET_CATEGORY_IAS_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_RAPCODE_PLAN_IAS_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_RAPCODE_PLAN_IAS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(64),
	REF_MD_HASHDIFF VARCHAR(64),
	RES_HK_HUB VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_SERVICING_CODES_IAPW_REF (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Reference',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__STEWARDSHIP_RDV__SAT_REF_SERVICING_CODES_IAPW_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(40),
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_BDV__TRANSLINK_FINANCIAL_TRANSACTION_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_BDV__TRANSLINK_FINANCIAL_TRANSACTION_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__LINK_FINANCIAL_TRANSACTION_RR_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__LINK_FINANCIAL_TRANSACTION_RR_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40)
);
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_CMSDT_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_CMSDT_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK_RES (
	RES VARCHAR(2),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
	REF_MD_START_DT TIMESTAMP_NTZ(9),
	RES_MD_HASHDIFF VARCHAR(64),
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_INVESTIA_UNIVERIS_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__SAT_LINK_FINANCIAL_TRANSACTION_RR_INVESTIA_UNIVERIS_RES (
	RES VARCHAR(2),
	RES_MD_HASHDIFF VARCHAR(40),
	REF_MD_HASHDIFF VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__TRANSLINK_POSITION_PRICE_IAS_IAVM_REF (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
...
create or replace TABLE DB_IAWT_DEV_DWH__TRANSACTIONS_RDV__TRANSLINK_POSITION_PRICE_IAS_IAVM_RES (
	RES_VALUE VARCHAR(16777216),
	RES_HK_LINK VARCHAR(40),
	REF_HK_LINK VARCHAR(40),
	RES_MD_START_DT TIMESTAMP_NTZ(9),
...
create or replace TABLE REG_TESTS_RESULTS (
	ID NUMBER(38,0) autoincrement COMMENT 'Unique identifier of a regression test result',
	RES_TABLE_FULLNAME VARCHAR(2000) NOT NULL COMMENT 'Name of the result table [DbName]_[SchemaName]_[TableName]_RES',
	NB_ERRORS NUMBER(38,0) COMMENT 'Number of regression tests found errors',
	MD_CREATION_DT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP() COMMENT 'Tiemstamp of the row'
);
use schema  TRANSACTIONS_BDV;

create or replace TABLE TRANSLINK_FINANCIAL_TRANSACTION (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40) COMMENT 'Hash key for the REF_INVESTMENT_SAVING_PROGRAM_TYPES',
...
create or replace TABLE TRANSLINK_FINANCIAL_TRANSACTION_BKUP (
	HK_LINK VARCHAR(40),
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40),
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40),
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40),
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40),
	HK_HUB_CONTRACT VARCHAR(40),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_CREATION_DT TIMESTAMP_NTZ(9),
	...
	INVESTMENT_PRODUCT_ID VARCHAR(100),
	PLN_MNEM VARCHAR(512),
	ACCOUNT_RAP_CODE VARCHAR(10),
	RETAIL_PLAN VARCHAR(50),
	ASC_1_RESP_PLAN_TYPES VARCHAR(10),
	TRADE_DATE TIMESTAMP_NTZ(9),
	GROSS_AMOUNT NUMBER(38,12),
	TRANSACTION_TYPE VARCHAR(21),
	ORD_TRANSACTION_TYPE NUMBER(1,0),
	CASH_FLOW VARCHAR(8000),
...
create or replace TABLE WT_LINK_FINANCIAL_TRANSACTION_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40) COMMENT 'Hash key for the REF_INVESTMENT_SAVING_PROGRAM_TYPES',
...
create or replace TABLE WT_LINK_FINANCIAL_TRANSACTION_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40) COMMENT 'Hash key for the REF_INVESTMENT_SAVING_PROGRAM_TYPES',
...
create or replace TABLE WT_REF_MAPPING_OPER_TYPE (
	HK_HUB VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
	MD_SOURCE VARCHAR(1000) COMMENT 'Represents the source system, file, etc. of the instance',
...
create or replace TABLE WT_TRANSLINK_FINANCIAL_TRANSACTION (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_PARTY_ROLE_ADVISOR VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES VARCHAR(40) COMMENT 'Hash key for the REF_INVESTMENT_SAVING_PROGRAM_TYPES',
	...
	A_C_ACCOUNT_CLASS VARCHAR(3) COMMENT 'Account class : 038, 040, ...',
	RETAIL_PLAN_RESP VARCHAR(1) COMMENT 'To be defined',
	TI_PRIMARY_MARKET VARCHAR(50),
	A_C_REPRESENTATIVE VARCHAR(50),
	ASC_1_RESP_PLAN_TYPES VARCHAR(100) COMMENT 'subtype of the RESP plans',
	DEPARTED_ADVISOR_IND NUMBER(1,0) COMMENT 'DEPARTED ADVISOR INDICATOR',
	DEPARTED_ADVISOR_MASTER_CODE VARCHAR(50)
);
create or replace view VW_INITIAL_LOADING_INVESTIA_WT_TRANSLINK_FINANCIAL_TRANSACTION(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
...
LATEST_VERSION_PRODUCT AS (
	...
	INNER JOIN TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR LR 
		ON SLR.HK_LINK = LR.HK_LINK
	LEFT JOIN SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_INVESTIA_UNIVERIS SLC 
		ON SLC.HK_HUB = LR.HK_HUB_INVESTMENT_PRODUCT_TYPE  
	    AND SLC.MD_START_DT <= SLR.MD_START_DT
),
LATEST_VERSION_REGISTERED_REPRESENTATIVE AS(
...
FROM TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_INVESTIA_UNIVERIS SLR
	INNER JOIN TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR LR 
		ON SLR.HK_LINK = LR.HK_LINK
    LEFT JOIN LATEST_VERSION_REGISTERED_REPRESENTATIVE LVRR
    	ON LVRR.HK_LINK = LR.HK_LINK 
    	AND  LVRR.MD_ACTIVE = 'A' AND LVRR.RANK_RR = 1
	LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE
	        	FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE LCS 
	        	INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE CS 
...
SELECT  DISTINCT 
	COALESCE(CON.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,'0') AS HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, 
	COALESCE(COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR,'0') AS HK_HUB_PARTY_ROLE_ADVISOR, 
	DECODE(TRUE, CON.PLN_MNEM IS NULL ,'0', SHA1(UPPER(CONCAT(COALESCE(TRIM(CON.MD_SRC_SYSTEM),'#NULL#') ,'|', COALESCE(TRIM(CON.PLN_MNEM),'#NULL#'), '|', '#NULL#','|', '#NULL#','|', '#NULL#' )))) AS HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES, 
	COALESCE(LR.HK_HUB_INVESTMENT_PRODUCT_TYPE,'0') AS HK_HUB_INVESTMENT_PRODUCT_TYPE, 
	COALESCE(LR.HK_HUB_CONTRACT,'0') AS HK_HUB_CONTRACT, 
...
WHERE
	SLR.SPR_CTGY IN ('PUR', 'PAC', 'RED', 'AWD', 'SWI', 'SWO', 'TIN', 'TOT', 'XIN', 'XOT')
	AND PR.SYMBOL NOT IN ('MRC001', 'IAAFCCA', 'INVCCA');
create or replace view VW_INITIAL_LOADING_WT_TRANSLINK_FINANCIAL_TRANSACTION(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_CONTRACT,
...
SELECT 		
		...
		CONTRACT.ASC_1_RESP_PLAN_TYPES AS ASC_1_RESP_PLAN_TYPES	,
		CASE WHEN DEP.REP_CODE IS NULL THEN 0 ELSE 1 END AS DEPARTED_ADVISOR_IND
FROM TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK SLT
INNER JOIN TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR LT
    ON  SLT.HK_LINK=LT.HK_LINK
LEFT JOIN LATEST_VERSION_SHARE COMM_SHARE
...
create or replace view VW_INITIAL_LOADING_WT_TRANSLINK_FINANCIAL_TRANSACTION_NEW(
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_PRODUCT_TYPE,
	HK_HUB_CONTRACT,
...
/*LATEST_VERSION_INVESTMENT_CONTRACT AS (
	...
	--AND INVESTMENT_CONTRACT.HK_HUB_PARTY_ROLE_ADVISOR = COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR
	AND INVESTMENT_CONTRACT.MD_START_DT <= SLT.MD_START_DT
    WHERE TRANSACTION_ID = 3528115045
), */
LATEST_VERSION_CONTRACT AS (
	SELECT SLT.HK_LINK,
	CONTRACT.HK_HUB,
...
SELECT 		
		...
		LT.HK_HUB_INVESTMENT_PRODUCT_TYPE AS HK_HUB_INVESTMENT_PRODUCT_TYPE, 
		LT.HK_HUB_CONTRACT AS HK_HUB_CONTRACT, 
		SLT.TRAN_TRADING_TRADE_DATE AS MD_START_DT, 
		CURRENT_TIMESTAMP() AS MD_CREATION_DT, 
		LT.MD_SOURCE AS MD_SOURCE, 
		LT.MD_SRC_SYSTEM AS MD_SRC_SYSTEM, 
		'-1' AS MD_CREATION_AUDIT_ID, 
...
LEFT JOIN SHARED_BDV.TRANSLINK_EXCHANGE_RATE LER
	ON LER.EXCHANGE_DATE = SLT.TRAN_TRADING_TRADE_DATE;
create or replace view VW_INITIAL_UNI_LOADING_WT_TRANSLINK_FINANCIAL_TRANSACTION(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
...
X.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER, 
X.HK_HUB_PARTY_ROLE_ADVISOR, 
X.HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES, 
X.HK_HUB_INVESTMENT_PRODUCT_TYPE, 
X.HK_HUB_CONTRACT, 
X.MD_START_DT, 
X.MD_CREATION_DT, 
...
X.MD_EXTRACT_DT, 
X.TRANSACTION_ID, 
X.UNIVERIS_CLIENT_ID, 
X.MASTER_CODE, 
X.UNIVERIS_PLAN_ID, 
X.INVESTMENT_PRODUCT_ID, 
X.PLN_MNEM, 
X.TRADE_DATE, 
X.GROSS_AMOUNT, 
X.TRANSACTION_TYPE, 
X.ORD_TRANSACTION_TYPE,
X.CASH_FLOW,
X.CASH_FLOW_TYPE, 
X.ADMINISTRATORY_TYPE
FROM 
(SELECT  
SHA1(UPPER(CONCAT(COALESCE(TRIM(SAT.MD_SRC_SYSTEM), '#NULL#'), '|' , 
COALESCE(TRIM(TRANSACTION_ID), '#NULL#'), '|' , 
COALESCE(TRIM(UNIVERIS_CLIENT_ID), '#NULL#'), '|' , 
COALESCE(TRIM(MASTER_CODE), '#NULL#'), '|' , 
'#NULL#', '|',  -- CONTRACT_ID
COALESCE(TRIM(LINK.UNIVERIS_PLAN_ID), '#NULL#'), '|',
COALESCE(TRIM(LINK.INVESTMENT_PRODUCT_ID), '#NULL#'), '|' ,  
COALESCE(TRIM(CON.PLN_MNEM),'#NULL#'), '|' , 
'#NULL#', '|', -- ACCOUNT_RAP_CODE
'#NULL#', '|' , -- RETAIL_PLAN
'#NULL#' -- ASC_1_RESP_PLAN_TYPES
))) AS HK_LINK, 
...
COALESCE(COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR,'0') AS HK_HUB_PARTY_ROLE_ADVISOR, 
DECODE(TRUE, CON.PLN_MNEM IS NULL ,'0', SHA1(UPPER(CONCAT(COALESCE(TRIM(CON.MD_SRC_SYSTEM),'#NULL#') ,'|', COALESCE(TRIM(CON.PLN_MNEM),'#NULL#'), '|', '#NULL#','|', '#NULL#','|', '#NULL#' )))) AS HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES, 
COALESCE(link.HK_HUB_INVESTMENT_PRODUCT_TYPE,'0') AS HK_HUB_INVESTMENT_PRODUCT_TYPE, 
COALESCE(link.HK_HUB_CONTRACT,'0') AS HK_HUB_CONTRACT, 
sat.TRADE_DT AS MD_START_DT, 
CURRENT_TIMESTAMP() AS MD_CREATION_DT, 
sat.MD_SOURCE AS MD_SOURCE, 
link.MD_SRC_SYSTEM AS MD_SRC_SYSTEM, 
sat.MD_EXTRACT_DT AS MD_EXTRACT_DT, 
link.TRANSACTION_ID AS TRANSACTION_ID, 
link.UNIVERIS_CLIENT_ID AS UNIVERIS_CLIENT_ID, 
COMM_SHARE.MASTER_CODE AS MASTER_CODE, 
link.UNIVERIS_PLAN_ID AS UNIVERIS_PLAN_ID, 
link.INVESTMENT_PRODUCT_ID AS INVESTMENT_PRODUCT_ID, 
CON.PLN_MNEM AS PLN_MNEM, 
SAT.TRADE_DT AS TRADE_DATE, 
SAT.TRX_GROSS * NVL(COMM_SHARE.COMMISSIONPCT/100,1) AS GROSS_AMOUNT, 
CASE
		WHEN SAT.SPR_CTGY = 'PUR' THEN 'Purchases'
		WHEN SAT.SPR_CTGY = 'RED' THEN 'Redemptions'
		WHEN SAT.TRX_MNEM_ENG LIKE '%SWI%' THEN 'Switch In'
		WHEN SAT.TRX_MNEM_ENG LIKE '%SWO%' THEN 'Switch Out'
		WHEN SAT.TRX_MNEM_ENG LIKE '%TIN%' THEN 'Transfer In'
		WHEN SAT.TRX_MNEM_ENG LIKE '%TOT%' THEN 'Transfer Out'
		WHEN SAT.TRX_MNEM_ENG LIKE '%XIN%'
		OR SAT.TRX_MNEM_ENG LIKE '%DXI%' THEN 'External Transfer In'
		WHEN SAT.TRX_MNEM_ENG LIKE '%XOT%'
		OR SAT.TRX_MNEM_ENG LIKE '%DXO%' THEN 'External Transfer Out'
		ELSE 'Others'
END AS TRANSACTION_TYPE, 
CAST((CASE 1 WHEN (CASE WHEN (SAT.SPR_CTGY = 'PUR') THEN 1 
      WHEN NOT (SAT.SPR_CTGY = 'PUR') THEN 0 ELSE NULL END) THEN 1 
      WHEN (CASE WHEN (SAT.SPR_CTGY = 'RED') THEN 1 
      WHEN NOT (SAT.SPR_CTGY = 'RED') THEN 0 ELSE NULL END) THEN 2 
      WHEN (CASE WHEN (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'SWI') > 0) THEN 1 
      WHEN NOT (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'SWI') > 0) THEN 0 ELSE NULL END) THEN 3 
      WHEN (CASE WHEN (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'SWO') > 0) THEN 1 
      WHEN NOT (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'SWO') > 0) THEN 0 ELSE NULL END) THEN 4 
      WHEN (CASE WHEN (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'TIN') > 0) THEN 1 
      WHEN NOT (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'TIN') > 0) THEN 0 ELSE NULL END) THEN 5 
      WHEN (CASE WHEN (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'TOT') > 0) THEN 1 
      WHEN NOT (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'TOT') > 0) THEN 0 ELSE NULL END) THEN 6 
      WHEN (CASE WHEN ((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XIN') > 0) OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) THEN 1 
      WHEN NOT ((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XIN') > 0)  OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) THEN 0 ELSE NULL END) THEN 7 
      WHEN (CASE WHEN ((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0) OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) THEN 1 
      WHEN NOT ((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0) OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) THEN 0 ELSE NULL END) THEN 8 ELSE 9 END) AS DECIMAL(1, 0)) 
AS ORD_TRANSACTION_TYPE,
(CASE 1 WHEN (CASE WHEN ((((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XIN') > 0)
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) THEN 1 
 WHEN NOT ((((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XIN') > 0) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) THEN 0 ELSE NULL END) THEN 'Yes' ELSE 'No' END)
 AS CASH_FLOW,
CAST((CASE 1 WHEN (CASE WHEN (((((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XIN') > 0) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) AND 
 (((SAT.TRX_GROSS * (CASE WHEN COMM_SHARE.COMMISSIONPCT IS NULL THEN 1 ELSE COMM_SHARE.COMMISSIONPCT END)) 
 * SAT.SPR_FACTOR) >= 0)) THEN 1 
 WHEN NOT (((((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XIN') > 0) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) 
 AND (((SAT.TRX_GROSS * (CASE WHEN COMM_SHARE.COMMISSIONPCT IS NULL THEN 1 ELSE COMM_SHARE.COMMISSIONPCT END))
 * SAT.SPR_FACTOR) >= 0)) THEN 0 ELSE NULL END) THEN 'IN FLOW'
 WHEN (CASE WHEN (((((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XIN') > 0) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) 
 AND (((SAT.TRX_GROSS * (CASE WHEN COMM_SHARE.COMMISSIONPCT IS NULL THEN 1 ELSE COMM_SHARE.COMMISSIONPCT END)) 
 * SAT.SPR_FACTOR) < 0)) THEN 1 WHEN NOT (((((REGEXP_INSTR(SAT.TRX_MNEM_ENG, 
 'XIN') > 0) OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXI') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'XOT') > 0)) 
 OR (REGEXP_INSTR(SAT.TRX_MNEM_ENG, 'DXO') > 0)) 
 AND (((SAT.TRX_GROSS * (CASE WHEN COMM_SHARE.COMMISSIONPCT IS NULL THEN 1 
 ELSE COMM_SHARE.COMMISSIONPCT END)) * SAT.SPR_FACTOR) < 0)) 
 THEN 0 ELSE NULL END) THEN 'OUT FLOW' ELSE 'OTHER' END) AS VARCHAR(8))
 AS CASH_FLOW_TYPE, 
SC.ADMINISTRATOR_TYPE AS ADMINISTRATORY_TYPE,
COALESCE (COMM_SHARE.MD_ACTIVE,'A') AS MD_ACTIVE,
COALESCE (ROW_NUMBER() OVER (PARTITION BY link.HK_LINK,COMM_SHARE.HK_LINK ORDER BY COMM_SHARE.MD_START_DT DESC ),1) AS RANK_SHARE
FROM 
TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_UNIVERIS sat 
INNER JOIN TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR link 
ON sat.HK_LINK =link.HK_LINK 
LEFT JOIN  SHARED_RDV.LINK_INVESTMENT_CONTRACT_RR  LIC 
ON link.HK_HUB_CONTRACT =LIC.HK_HUB_CONTRACT 
LEFT JOIN 	
( 
SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE 
FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE LCS 
INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE CS 
ON CS.HK_LINK=LCS.HK_LINK AND CS.MD_SRC_SYSTEM = 'IAS'
) COMM_SHARE
ON LIC.HK_HUB_REGISTERED_REPRESENTATIVE=COMM_SHARE.HK_HUB_REGISTERED_REPRESENTATIVE
AND  COMM_SHARE.MD_START_DT <= DATEADD(SECOND, 86399, sat.TRADE_DT)  
LEFT JOIN  SHARED_RDV.SAT_CONTRACT_IAS_UNIVERIS SC
ON SC.HK_HUB =LIC.HK_HUB_CONTRACT 
LEFT JOIN SHARED_RDV.SAT_INVESTMENT_PRODUCT_TYPE_IAS_UNIVERIS PR
ON PR.HK_HUB =LINK.HK_HUB_INVESTMENT_PRODUCT_TYPE 
LEFT JOIN SHARED_BDV.LINK_INVESTMENT_CONTRACT CON
ON CON.HK_HUB_CONTRACT =LIC.HK_HUB_CONTRACT AND CON.HK_HUB_PARTY_ROLE_ADVISOR =COMM_SHARE.HK_HUB_PARTY_ROLE_ADVISOR
WHERE SAT.SPR_CTGY IN ('PUR', 'PAC', 'RED', 'AWD', 'SWI', 'SWO', 'TIN', 'TOT', 'XIN', 'XOT')
AND PR.SYMBOL NOT IN ('MRC001', 'IAAFCCA', 'INVCCA') ) X
WHERE X.MD_ACTIVE = 'A' AND X.RANK_SHARE = 1;
create or replace view VW_INITIAL_UNI_LOADING_WT_TRANSLINK_FINANCIAL_TRANSACTION_IHEB(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
...
LATEST_VERSION_CONTRACT AS (
	...
	COALESCE (SLC.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLR.HK_LINK,LR.HK_HUB_CONTRACT ORDER BY SLC.MD_START_DT DESC ),1) AS RANK_CONTRACT
	FROM TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_UNIVERIS SLR
	INNER JOIN TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR LR 
		ON SLR.HK_LINK = LR.HK_LINK
	LEFT JOIN SHARED_RDV.SAT_CONTRACT_IAS_UNIVERIS SLC 
		ON SLC.HK_HUB = LR.HK_HUB_CONTRACT  
	    AND SLC.MD_START_DT <= SLR.MD_START_DT
),
LATEST_VERSION_PRODUCT AS (
...
LATEST_VERSION_RDV_INVESTMENT_CONTRACT AS (
SELECT 
	SLR.HK_LINK,
	SLR.MD_START_DT,
	LC.HK_HUB_REGISTERED_REPRESENTATIVE,
...
LATEST_VERSION_SHARE AS (
	...
	COALESCE (COMM_SHARE.MD_ACTIVE,'A') AS MD_ACTIVE,
	COALESCE (ROW_NUMBER() OVER (PARTITION BY SLT.HK_LINK,COMM_SHARE.HK_LINK ORDER BY COMM_SHARE.MD_START_DT DESC ),1) AS RANK_SHARE
	FROM TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_UNIVERIS SLT
	INNER JOIN TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR LT
    	ON  SLT.HK_LINK=LT.HK_LINK
    LEFT JOIN LATEST_VERSION_RDV_INVESTMENT_CONTRACT INVESTMENT_CONTRACT_RR
    	ON INVESTMENT_CONTRACT_RR.HK_LINK = SLT.HK_LINK 
    	AND  INVESTMENT_CONTRACT_RR.MD_ACTIVE = 'A' AND INVESTMENT_CONTRACT_RR.RANK_CONTRACT_RR = 1 
	LEFT JOIN 	( SELECT LCS.HK_LINK,LCS.HK_HUB_REGISTERED_REPRESENTATIVE,CS.MD_START_DT,LCS.HK_HUB_PARTY_ROLE_ADVISOR,LCS.MASTER_CODE,CS.COMMISSIONPCT,CS.MD_ACTIVE
	        	FROM SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE LCS 
	        	INNER JOIN SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE CS 
...
SELECT  
SHA1(UPPER(CONCAT(COALESCE(TRIM(SLR.MD_SRC_SYSTEM), '#NULL#'), '|' , 
COALESCE(TRIM(TRANSACTION_ID), '#NULL#'), '|' , 
COALESCE(TRIM(UNIVERIS_CLIENT_ID), '#NULL#'), '|' , 
COALESCE(TRIM(MASTER_CODE), '#NULL#'), '|' , 
'#NULL#', '|',  -- CONTRACT_ID
...
LEFT JOIN LATEST_VERSION_CONTRACT SC
    ON SC.HK_LINK = SLR.HK_LINK 
    AND  SC.MD_ACTIVE = 'A' AND SC.RANK_CONTRACT = 1
WHERE SLR.SPR_CTGY IN ('PUR', 'PAC', 'RED', 'AWD', 'SWI', 'SWO', 'TIN', 'TOT', 'XIN', 'XOT')
AND PR.SYMBOL NOT IN ('MRC001', 'IAAFCCA', 'INVCCA');
create or replace view VW_TRANSLINK_FINANCIAL_TRANSACTION(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
...
SELECT
    ...
    S.IND_EXCLUDE,
    S.MD_ACTIVE
FROM DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.REF_MANUAL_ADVISOR_RVP_IAS R                    
INNER JOIN DB_IAWT_DEV_DWH.STEWARDSHIP_RDV.SAT_REF_MANUAL_ADVISOR_RVP_IAS S
ON R.HK_HUB = S.HK_HUB
QUALIFY ROW_NUMBER() OVER (PARTITION BY R.REPID ORDER BY S.MD_START_DT DESC)=1
),
REVERSALS_BK AS
...
FROM
    DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION Y
INNER JOIN
(
SELECT DISTINCT
...
FROM DB_IAWT_DEV_DWH.TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR L
INNER JOIN
DB_IAWT_DEV_DWH.TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK SL 
ON
...
(
SELECT
-- We added Distinct because we have duplicates in the WT and this normal because we are splitting transactions by the share
DISTINCT
...
CONTRACT_ID,
Tran_Txn_Reference_ID
FROM DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION
WHERE Tran_Entry_Description in ('VALUE', 'VALEUR')  
),
-- Removed the accountid and picking the latest price based on SYMBOL, MARKET, PROCESSDATE to include the missing transactions
Pos AS (
    SELECT
        DISTINCT
        UNITOFMEASURE, SYMBOL, MARKET, PROCESSDATE, CLOSEPRICE, PRICECURRENCY,BIDPRICE,ASKPRICE
    FROM  DB_IAWT_DEV_DWH.TRANSACTIONS_RDV.TRANSLINK_POSITION_PRICE_IAS_IAVM P
    WHERE
        COALESCE(TO_VARCHAR(TRY_TO_NUMBER(P.ACCOUNTID)),'') <> P.ACCOUNTID
),
POS_CLOSEST_PRICE_TRADE_DATE AS (
    SELECT T.HK_LINK, MAX(P.PROCESSDATE) AS PROCESS_DATE
    FROM Pos P
    INNER JOIN DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION T
...
(
    ...
    FROM DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION T
...
SELECT
    ...
    CONTRACT_ID,
    INVESTMENT_PRODUCT_ID,
    PLN_MNEM,ACCOUNT_RAP_CODE, RETAIL_PLAN, ASC_1_RESP_PLAN_TYPES, Trade_date,
    Gross_amount, Transaction_type, ORD_TRANSACTION_TYPE, CASH_FLOW, CASHFLOW_TYPE, Administratory_type,  
    number_of_transactions, DEPARTED_ADVISOR_IND, DAYS_LAST_PRICED,
    DEPARTED_ADVISOR_MASTER_CODE
FROM
(
SELECT
    ...
    T.TRAN_TRADING_TRADE_DATE AS Trade_date,
    ...
    ,   
     CASE WHEN  T.TRAN_TRADING_GROSS_AMT != 0
      ...
      WHEN  T.Tran_Entry_Description not in ('', 'VALUE', 'VALEUR') 
          ...
          THEN  T.TRAN_TRADING_GROSS_AMT*-1
     ELSE 0 END    
     ) * COALESCE(T.COMMISSIONPCT,100) * 0.01 AS Gross_amount, 
    CASE
    ...
    CASE WHEN
         ...
         AND CASH_FLOW='Yes' AND Gross_amount >= 0)
         OR
    ...
    T.ADMINISTRATORY_TYPE AS Administratory_type,
    DECODE(R.REVERSAL_IND,TRUE,-1,1) AS number_of_transactions,
...
FROM DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION T
LEFT JOIN DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE Y ON
...
LEFT JOIN DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE X ON
...
FROM DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION TR
LEFT JOIN DB_IAWT_DEV_DWH.TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE OT ON
...
create or replace view VW_TRANSLINK_FINANCIAL_TRANSACTION_PERFORMANCE(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
...
(SELECT
	...
	TRUE AS REVERSAL_IND
FROM 
	TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION Y
INNER JOIN 
(
SELECT DISTINCT 
L.REGISTERED_REPRESENTATIVE_ID,L.CONTRACT_ID,SL.TRAN_ENTRY_DESCRIPTION,SL.TRAN_TRADING_NET_AMT,SL.TRAN_TRADING_TRADE_DATE
FROM TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR L
INNER JOIN 
TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK SL 
ON 
L.HK_LINK=SL.HK_LINK
) N 
     ON
...
CONTRACT_ID,
Tran_Txn_Reference_ID
FROM TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION
WHERE Tran_Entry_Description in ('VALUE', 'VALEUR')  
),
-- Removed the accountid and picking the latest price based on SYMBOL, MARKET, PROCESSDATE to include the missing transactions
Pos AS (
   ...
   from  TRANSACTIONS_RDV.TRANSLINK_POSITION_PRICE_IAS_IAVM P
    inner join TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION T
    ON P.symbol = T.TI_Symbol
       and P.market = T.TI_Primary_Market
   --where  SYMBOL != ''
   Where TO_VARCHAR(TRY_TO_NUMBER(P.ACCOUNTID)) <> P.ACCOUNTID
)
SELECT 
  	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
...
,
     CASE WHEN 	T.TRAN_TRADING_GROSS_AMT != 0 
          ...
          WHEN 	COALESCE(POS_pdt.unitOfMeasure,-1) !=-1
         		...
         		AND COALESCE(NULLIF(POS_pdt.CLOSEPRICE,0), NULLIF(POS_pdt.BIDPRICE,0), NULLIF(POS_pdt.ASKPRICE,0), -1) !=-1
     	  THEN 
		         DATEDIFF( days, Pos_pdt.PROCESSDATE,  T.TRAN_PROCESS_DATE)  
	 ELSE NULL END AS DAYS_LAST_PRICED_PROCESS_DATE		 
,
     CASE WHEN DAYS_LAST_PRICED_TRADE_DATE >= DAYS_LAST_PRICED_PROCESS_DATE THEN DAYS_LAST_PRICED_PROCESS_DATE ELSE DAYS_LAST_PRICED_TRADE_DATE END AS DAYS_LAST_PRICED

FROM TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION T
LEFT JOIN TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE Y ON
(DECODE(TRUE,TRAN_ENTRY_DESCRIPTION LIKE 'CXL%',SUBSTRING(TRAN_ENTRY_DESCRIPTION,4),TRAN_ENTRY_DESCRIPTION)= Y.IBMSOURCE AND Y.LEVEL =1)

LEFT JOIN TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE X ON
(TRAN_ENTRY_DESCRIPTION= X.IBMSOURCE AND X.LEVEL =1)

LEFT JOIN /*REMOVE DUPLICATION IN LEVEL 2 FOR MAPPING_OPER_TYPE*/
(SELECT TR.TRANSACTION_ID, OT.ISCASHFLOW, ROW_NUMBER() OVER(PARTITION BY TR.TRANSACTION_ID ORDER BY OT.ISCASHFLOW DESC) AS RN /*IF WE HAVE DIFFERENT VALUES FOR ISCASHFLOW FOR SAME TRAN WE PRIORITIZE TRUE VALUE*/
FROM TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION TR

LEFT JOIN TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE OT ON 
(DECODE(TRUE,TR.TRAN_ENTRY_DESCRIPTION LIKE 'CXL%',SUBSTRING(TR.TRAN_ENTRY_DESCRIPTION,4),TR.TRAN_ENTRY_DESCRIPTION) RLIKE REPLACE(REPLACE(REPLACE(REPLACE(OT.IBMSOURCE,'*','.*'),'?','.'),'#','\\d'),'@','[a-zA-Z]') AND OT.LEVEL =2)) Z
ON T.TRANSACTION_ID = Z.TRANSACTION_ID AND Z.RN= 1
...
LEFT JOIN pos POS
 ON  --POS.processDate = TRANSACTIONS_BDV.UF_IAWT_GET_CLOSEST_PRICE_DATE (T.TI_Primary_Market, T.TI_Symbol ,T.TRAN_TRADING_TRADE_DATE)    -- Jhed input to TI_Primary_Market
 POS.processDate <= T.TRAN_TRADING_TRADE_DATE    -- Jhed input to TI_Primary_Market
 and POS.symbol = T.TI_Symbol 
 and POS.market = T.TI_Primary_Market 

LEFT JOIN pos POS_pdt
 --ON  POS_pdt.processDate = TRANSACTIONS_BDV.UF_IAWT_GET_CLOSEST_PRICE_DATE (T.TI_Primary_Market, T.TI_Symbol ,T.TRAN_PROCESS_DATE) 
ON POS_pdt.processDate <= T.TRAN_PROCESS_DATE
 and POS_pdt.symbol = T.TI_Symbol 
 and POS_pdt.market = T.TI_Primary_Market 
-- ADD EXCLUSION
...
-- EXCLUDE RVP ADVISOR
AND E.REPID IS NULL 
--AND hk_link = 'a80cad6a33933de7206cc7ef1168b8070e9443af'
QUALIFY ROW_NUMBER() OVER (PARTITION BY T.hk_link ORDER BY  CASE WHEN COALESCE (pos.PROCESSDATE,'2000-01-01') > COALESCE (POS_pdt.PROCESSDATE,'2000-01-01') THEN pos.PROCESSDATE ELSE POS_pdt.PROCESSDATE END  DESC)=1
--QUALIFY ROW_NUMBER() OVER (PARTITION BY T.hk_link ORDER by pos.PROCESSDATE DESC, POS_pdt.PROCESSDATE  DESC)=1
);
create or replace view VW_TRANSLINK_FINANCIAL_TRANSACTION_PERFORMANCE_02(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
...
SELECT
    ...
    number_of_transactions, --DEPARTED_ADVISOR_IND,
...
LEFT JOIN POS_CLOSEST_PRICE_TRADE_DATE C_TD
ON T.HK_LINK = C_TD.HK_LINK
    
LEFT JOIN pos POS

ON  POS.processDate = C_TD.PROCESS_DATE    -- Jhed input to TI_Primary_Market

and POS.symbol = T.TI_Symbol

 and POS.market = T.TI_Primary_Market

LEFT JOIN POS_CLOSEST_PRICE_PROCESS_DATE C_PD
ON T.HK_LINK = C_PD.HK_LINK

LEFT JOIN pos POS_pdt

ON  POS_pdt.processDate = C_PD.PROCESS_DATE
...
create or replace view VW_TRANSLINK_FINANCIAL_TRANSACTION_PERFORMANCE_03(
	HK_LINK,
	HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
	HK_HUB_PARTY_ROLE_ADVISOR,
	HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES,
...
Pos AS (
	...
	INNER JOIN TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION T
		...
		AND P.market = T.TI_Primary_Market
	WHERE 
		TO_VARCHAR(TRY_TO_NUMBER(P.ACCOUNTID)) <> P.ACCOUNTID
),
POS_CLOSEST_PRICE_TRADE_DATE AS (
    SELECT T.HK_LINK, MAX(P.PROCESSDATE) AS PROCESS_DATE
    FROM Pos P
...
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_MAP_OPER_TYPE_TO_BDV_WT_REF_MAPP_OPER_TYPE"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE WHERE 1=1'';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE 
(	HK_HUB,
	MD_SOURCE,
	MD_SRC_SYSTEM,
	MD_EXTRACT_DT,
...
FROM (
	SELECT * 
			FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.SAT_REF_MAPPING_OPER_TYPE_IAS) SAT
		JOIN (
		SELECT *
				FROM (
					SELECT *
					...
					FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.SAT_REF_MAPPING_OPER_TYPE_IAS
					) SATHUB
				WHERE SATHUB.RN = 1 AND SATHUB.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''') 
		)LV ON LV.HK_HUB = SAT.HK_HUB
	JOIN DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.REF_MAPPING_OPER_TYPE HUB ON SAT.HK_HUB = HUB.HK_HUB 
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_MAP_OPER_TYPE_TO_BDV_WT_REF_MAPP_OPER_TYPE_IAPW"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT hub.HK_HUB	 	
	...
	,sat.ISCASHFLOW
	FROM (
	SELECT * FROM DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.SAT_REF_MAPPING_OPER_TYPE_IAS WHERE MD_ACTIVE = ''''A'''') sat
	JOIN DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.REF_MAPPING_OPER_TYPE hub ON sat.HK_HUB = hub.HK_HUB
              '';
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRANSACTIONS_INVESTIA_UNIVERIS_TO_BDV_WT_LINK_FINANCIAL_TRANSACTION_INVESTIA_UNIVERIS"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT
	...
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_TRANSACTION_TYPE_001(rdv3.SPR_CTGY,rdv3.TRX_MNEM_ENG)[''''o_TRANSACTION_TYPE'''']
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_TRANSACTION_TYPE_001(rdv3.SPR_CTGY,rdv3.TRX_MNEM_ENG)[''''o_TRANSACTION_TYPE'''']	
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_CASH_FLOW_002(rdv3.TRX_MNEM_ENG)
	,BUSINESS_RULES.TRANSACTIONS.UDF_CONV_BR_UNIVERIS_TRANSACTIONS_CASH_FLOW_003((rdv3.TRX_MNEM_ENG),(rdv3.TRX_GROSS* (CASE WHEN bdv02.COMMISSIONPCT IS NULL THEN 1 ELSE bdv02.COMMISSIONPCT/100 END)))
	,bdv04.ADMINISTRATOR_TYPE
	FROM (
		SELECT *
...
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRANSACTIONS_TO_BDV_WT_LINK_TRANSACTIONS"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
UPD_QUERY STRING;
BEGIN
TRUNC_QUERY := ''TRUNCATE TABLE DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_LINK_FINANCIAL_TRANSACTION_INVESTIA_UNIVERIS'';
INS_QUERY := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_LINK_FINANCIAL_TRANSACTION_INVESTIA_UNIVERIS(
HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER,
HK_HUB_PARTY_ROLE_ADVISOR,
...
CASH_FLOW_TYPE,
ADMINISTRATORY_TYPE
FROM DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.VW_INITIAL_LOADING_INVESTIA_WT_TRANSLINK_FINANCIAL_TRANSACTION)'';

UPD_QUERY := ''UPDATE DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_LINK_FINANCIAL_TRANSACTION_INVESTIA_UNIVERIS
SET
HK_LINK=
SHA1(UPPER(CONCAT(COALESCE(TRIM(MD_SRC_SYSTEM), ''''NULL''''), ''''|'''' ,
COALESCE(TRIM(TRANSACTION_ID), ''''NULL''''), ''''|'''' ,
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRANSACTIONS_TO_BDV_WT_LINK_TRANSACTIONS"("ENV" VARCHAR(1000), "I_DATA_START_DATE" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION WHERE 1=1 '';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION (
HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER	
,HK_HUB_PARTY_ROLE_ADVISOR
,HK_HUB_INVESTMENT_SAVING_PROGRAM_TYPES	
,HK_HUB_INVESTMENT_PRODUCT_TYPE
...
SELECT
	...
	FROM (
	SELECT *
			FROM DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_RDV.SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK WHERE MD_START_DT = TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD''''))rdv 
		JOIN DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_RDV.LINK_FINANCIAL_TRANSACTION_RR trdv 
		ON rdv.HK_LINK = trdv.HK_LINK
		LEFT JOIN
		(
			SELECT bdv2.HK_HUB_PARTY_ROLE_ADVISOR, bdv2.MASTER_CODE,bdv2.HK_HUB_REGISTERED_REPRESENTATIVE, sbdv.COMMISSIONPCT
			FROM (
				SELECT *
				FROM DB_IAWT_''||ENV||''_DWH.SHARED_BDV.SAT_LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE
				) sbdv
			JOIN (
				...
				WHERE SATHUB.RN = 1 AND SATHUB.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''')
				) bdvcv ON bdvcv.HK_LINK = sbdv.HK_LINK
			JOIN DB_IAWT_''||ENV||''_DWH.SHARED_BDV.LINK_PARTY_RELATIONSHIP_COMMISSION_SHARE bdv2 ON bdv2.HK_LINK = sbdv.HK_LINK
		...
		(
			...
			JOIN (
				...
				WHERE SATHUB1.RN1 = 1 AND SATHUB1.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''')
				) rdv2lv ON rdv2lv.HK_HUB = rdv2.HK_HUB
			JOIN DB_IAWT_''||ENV||''_DWH.SHARED_BDV.LINK_INVESTMENT_CONTRACT bdv ON bdv.HK_HUB_CONTRACT = rdv2.HK_HUB
		...
		LEFT JOIN DB_IAWT_''||ENV||''_DWH.SHARED_BDV.TRANSLINK_EXCHANGE_RATE sbdv2 ON sbdv2.EXCHANGE_DATE = rdv.TRAN_TRADING_TRADE_DATE
		LEFT JOIN
		(
			...
			JOIN (
				...
				WHERE SATHUB2.RN2 = 1 AND SATHUB2.MD_START_DT <= TO_DATE(''||i_DATA_START_DATE||'', ''''YYYY-MM-DD'''')
				) ssbdv4 ON ssbdv4.HK_LINK = ssbdv3.HK_LINK
			JOIN DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_BDV.LINK_SERVICING_CODES sbdv3 ON sbdv3.HK_LINK = ssbdv3.HK_LINK
		...
		WHERE rdv.MD_ACTIVE = ''''A''''	
			 '';
INS_UPDATE :='' UPDATE DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION
SET 
	HK_LINK=
	SHA1(UPPER(CONCAT(COALESCE(TRIM(MD_SRC_SYSTEM), ''''#NULL#''''), ''''|'''' ,
	COALESCE(TRIM(TRANSACTION_ID), ''''#NULL#''''), ''''|'''' ,
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRANSACTIONS_TO_BDV_WT_LINK_TRANSACTIONS_IAPW"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
SELECT src.HK_HUB_PARTY_ROLE_ACCOUNT_HOLDER	
	...
	FROM DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.VW_INITIAL_LOADING_WT_TRANSLINK_FINANCIAL_TRANSACTION src	
              '';
INS_UPDATE :='' UPDATE DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_TRANSLINK_FINANCIAL_TRANSACTION
SET 
	HK_LINK=
...
END
';
CREATE OR REPLACE PROCEDURE "SP_CONV_LOADBDV_RDV_TRANSACTIONS_TO_BDV_WT_LINK_TRANSACTIONS_UNIVERIS"("ENV" VARCHAR(1000))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
,src.CASH_FLOW_TYPE	
,src.ADMINISTRATORY_TYPE
	FROM DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.VW_INITIAL_UNI_LOADING_WT_TRANSLINK_FINANCIAL_TRANSACTION src
             '';
INS_UPDATE :='' UPDATE DB_IAWT_''||ENV||''_DWH.TRANSACTIONS_BDV.WT_LINK_FINANCIAL_TRANSACTION_UNIVERIS
SET 
	HK_LINK=
...
END
';
use schema  TRANSACTIONS_RDV;

create or replace TABLE LINK_FINANCIAL_TRANSACTION_RR (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	HK_HUB_CONTRACT VARCHAR(40) COMMENT 'Hash key for PARTY_ROLE_ACCOUNT_HOLDER',
	HK_HUB_REGISTERED_REPRESENTATIVE VARCHAR(40) COMMENT 'Hash key for the REGISTERED_REPRESENTATIVE_COMMISSION',
	HK_HUB_INVESTMENT_PRODUCT_TYPE VARCHAR(40) COMMENT 'Hash key for the REF_MAPPING_PRODUCT_TYPE',
...
create or replace TABLE LINK_FINANCIAL_TRANSACTION_RR_BKUP (
	HK_LINK VARCHAR(40),
	HK_HUB_CONTRACT VARCHAR(40),
	...
	TRANSACTION_ID VARCHAR(100),
	CONTRACT_ID VARCHAR(100),
	REGISTERED_REPRESENTATIVE_ID VARCHAR(50),
	INVESTMENT_PRODUCT_ID VARCHAR(50),
	UNIVERIS_PLAN_ID NUMBER(38,0),
	UNIVERIS_CLIENT_ID NUMBER(38,0)
);
create or replace TABLE SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_CMSDT (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(64) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_NBIN_IAVMBK_BKUP (
	HK_LINK VARCHAR(40),
	MD_START_DT TIMESTAMP_NTZ(9),
	MD_HASHDIFF VARCHAR(64),
	MD_CREATION_DT TIMESTAMP_NTZ(9),
	...
	MD_ACTIVE VARCHAR(1),
	TI_ALTERNATE_TI_TYPE VARCHAR(50),
	TRAN_ENTRY_DESCRIPTION VARCHAR(50),
	TRAN_USER_DESCRIPTION VARCHAR(50),
	TRAN_TRADING_TYPE VARCHAR(10),
	TRAN_TRADING_GROSS_AMT NUMBER(38,2),
	TRAN_TRADING_CURRENCY VARCHAR(10),
	TRAN_TRADING_NET_AMT NUMBER(38,2),
	TRAN_TRADING_TRADE_DATE DATE,
	TRAN_TRADING_SETT_DATE DATE,
	TRAN_PROCESS_DATE DATE,
	TI_SYMBOL VARCHAR(50),
	TRAN_QTY NUMBER(38,4),
	TI_PRIMARY_MARKET VARCHAR(50),
	TRAN_TXN_REFERENCE_ID VARCHAR(50),
	TRAN_AMOUNT_2 NUMBER(38,2),
	TI_UNDERLYING_CDN_PRICE NUMBER(38,8),
	TI_BASIS_POINT NUMBER(38,5),
	TI_FACE_VALUE NUMBER(38,5),
	TI_ISSUE_PRICE NUMBER(38,5),
	STRIKE_PRICE NUMBER(38,8),
	TI_UNDERLYING_USD_PRICE NUMBER(38,8)
);
create or replace TABLE SAT_LINK_FINANCIAL_TRANSACTION_RR_IAS_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE SAT_LINK_FINANCIAL_TRANSACTION_RR_INVESTIA_UNIVERIS (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Hub',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_HASHDIFF VARCHAR(40) COMMENT 'Represents the whole set of hashed attributes to be historized for an occurrence',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
...
create or replace TABLE TRANSLINK_POSITION_PRICE_IAS_IAVM (
	HK_LINK VARCHAR(40) COMMENT 'Hash key for the Link',
	MD_START_DT TIMESTAMP_NTZ(9) COMMENT 'Start Date of the image/version',
	MD_CREATION_DT TIMESTAMP_NTZ(9) COMMENT 'Creation Date Time of the occurrence',
	MD_CREATION_AUDIT_ID VARCHAR(1000) COMMENT 'Task execution ID',
...
BEGIN
i_DATA_START_DATE :=CHAR(39)||i_DATA_START_DATE||CHAR(39);
INS_PRE_DEL := ''DELETE FROM DB_IAWT_''||ENV||''_DWH_TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE WHERE 1=1'';
INS_INSERT := ''
INSERT INTO DB_IAWT_''||ENV||''_DWH_TRANSACTIONS_BDV.WT_REF_MAPPING_OPER_TYPE 
(	HK_HUB,
	MD_CREATION_DT,
	MD_CREATION_AUDIT_ID,
	MD_SOURCE,
...
FROM (
	...
	LEFT JOIN DB_IAWT_''||ENV||''_DWH.STEWARDSHIP_RDV.REF_MAPPING_OPER_TYPE HUB ON SAT.HK_HUB = HUB.HK_HUB 
	WHERE SAT.MD_ACTIVE = ''''A''''
              '';
EXECUTE IMMEDIATE :INS_PRE_DEL;
EXECUTE IMMEDIATE :INS_INSERT;
...
CREATE OR REPLACE PROCEDURE DB_IAWT_DEV_DWH.SHARED_BDV.SP_CONV_M_LOADBDV_RDV_HOLDINGS_TO_BDV_WT_SAT_CONTRACT_AUA_SEG_COMPUTE(ENV VARCHAR(1000), DATA_START_DATE VARCHAR(20))
RETURNS VARCHAR(10000)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS $$
var pre_sql_command ="TRUNCATE TABLE DB_IAWT_"+ENV+"_DWH.SHARED_BDV.WT_SAT_CONTRACT_AUA_SEG_COMPUTE;";
var sql_command ="INSERT INTO DB_IAWT_"+ENV+"_DWH.SHARED_BDV.WT_SAT_CONTRACT_AUA_SEG_COMPUTE( HK_HUB, MD_START_DT, MD_CREATION_DT, MD_CREATION_AUDIT_ID, MD_SOURCE, MD_SRC_SYSTEM, MD_EXTRACT_DT, ACCOUNT_AUA_SEGMENT, ACCOUNT_AUA_SEGMENT_ORDER) (WITH LV AS ( SELECT HK_LINK AS LV_HK_LINK, MAX(MD_START_DT) AS O_MAX_DATE_LV FROM DB_IAWT_"+ENV+"_DWH.HOLDINGS_BDV.SAT_LINK_INVESTMENT SLI WHERE MD_START_DT = TO_DATE('"+DATA_START_DATE+"','YYYY-MM-DD') GROUP BY HK_LINK ), JNR_SatLink_Investment_SelfJoin AS ( SELECT A.LV_HK_LINK, C.O_MAX_DATE_LV, B.ACCOUNT_PROGRAM_TYPE, B.ADMINISTRATORY_TYPE, B.AUA, B.AUM, B.AUM_CLARINGTON, B.AUM_IA, B.BALANCE_DATE, B.CASH_POSITION, B.HK_LINK, B.HOLDING_VALUE, B.MD_ACTIVE, B.MD_CREATION_AUDIT_ID, B.MD_CREATION_DT, B.MD_EXTRACT_DT, B.MD_HASHDIFF, B.MD_SOURCE, B.MD_SRC_SYSTEM, B.MD_START_DT, B.PLN_SYSID, B.PROGRAM_TYPE, B.RR_CD FROM DB_IAWT_"+ENV+"_DWH.HOLDINGS_BDV.SAT_LINK_INVESTMENT B LEFT JOIN LV A ON A.LV_HK_LINK = B.HK_LINK LEFT JOIN LV C ON C.O_MAX_DATE_LV = B.MD_START_DT WHERE B.MD_ACTIVE = 'A' ), JNR_SatLink_Investment_InnerJoin_Link_Investment AS ( SELECT A.HK_HUB_CONTRACT AS 			LINK_INVESTMENT_HK_HUB_CONTRACT, A.HK_LINK AS 					LINK_INVESTMENT_HK_LINK, A.MASTER_CODE AS 				LINK_INVESTMENT_MASTER_CODE, B.LV_HK_LINK AS 				LV_HK_LINK, B.O_MAX_DATE_LV AS 				O_MAX_DATE_LV, B.ACCOUNT_PROGRAM_TYPE AS 		SAT_LINK_INVESTMENT_ACCOUNT_PROGRAM_TYPE, B.ADMINISTRATORY_TYPE AS 		SAT_LINK_INVESTMENT_ADMINISTRATORY_TYPE, B.AUA AS 						SAT_LINK_INVESTMENT_AUA, B.AUM AS 						SAT_LINK_INVESTMENT_AUM, B.AUM_CLARINGTON AS 			SAT_LINK_INVESTMENT_AUM_CLARINGTON, B.AUM_IA AS 					SAT_LINK_INVESTMENT_AUM_IA, B.BALANCE_DATE AS 				SAT_LINK_INVESTMENT_BALANCE_DATE, B.CASH_POSITION AS 				SAT_LINK_INVESTMENT_CASH_POSITION, B.HK_LINK AS 					SAT_LINK_INVESTMENT_HK_LINK, B.HOLDING_VALUE AS 				SAT_LINK_INVESTMENT_HOLDING_VALUE, B.MD_ACTIVE AS 					SAT_LINK_INVESTMENT_MD_ACTIVE, B.MD_CREATION_AUDIT_ID AS 		SAT_LINK_INVESTMENT_MD_CREATION_AUDIT_ID, B.MD_CREATION_DT AS 			SAT_LINK_INVESTMENT_MD_CREATION_DT, B.MD_EXTRACT_DT AS 				SAT_LINK_INVESTMENT_MD_EXTRACT_DT, B.MD_HASHDIFF AS 				SAT_LINK_INVESTMENT_MD_HASHDIFF, B.MD_SOURCE AS 					SAT_LINK_INVESTMENT_MD_SOURCE, B.MD_SRC_SYSTEM AS 				SAT_LINK_INVESTMENT_MD_SRC_SYSTEM, B.MD_START_DT AS 				SAT_LINK_INVESTMENT_MD_START_DT, B.PLN_SYSID AS 					SAT_LINK_INVESTMENT_PLN_SYSID, B.PROGRAM_TYPE AS 				SAT_LINK_INVESTMENT_PROGRAM_TYPE, B.RR_CD AS 						SAT_LINK_INVESTMENT_RR_CD FROM JNR_SatLink_Investment_SelfJoin B LEFT JOIN DB_IAWT_"+ENV+"_DWH.HOLDINGS_BDV.LINK_INVESTMENT A ON B.HK_LINK = A.HK_LINK ), SAT_CONTRACT_COMPUTE_LV AS ( SELECT HK_HUB AS SLV_HK_HUB, MAX(MD_START_DT) AS SLV_O_MAX_MD_START_DT FROM DB_IAWT_"+ENV+"_DWH.SHARED_BDV.WT_SAT_CONTRACT_COMPUTE WHERE MD_START_DT = TO_DATE('"+DATA_START_DATE+"','YYYY-MM-DD') GROUP BY HK_HUB ), JNR_SatLink_Investment_SelfJoin1 AS ( SELECT A.SLV_HK_HUB AS 						SLV_HK_HUB,	 C.SLV_O_MAX_MD_START_DT				SLV_O_MAX_MD_START_DT, B.ACCOUNT_IND AS 						SAT_CONTRACT_COMPUTE_ACCOUNT_IND,	 B.ACCOUNT_TYPE AS 					SAT_CONTRACT_COMPUTE_ACCOUNT_TYPE,	 B.ACCUMULATION_TYPE AS 				SAT_CONTRACT_COMPUTE_ACCUMULATION_TYPE,	 B.GROUP_TYPE_CODE AS 					SAT_CONTRACT_COMPUTE_GROUP_TYPE_CODE,	 B.HK_HUB AS 							SAT_CONTRACT_COMPUTE_HK_HUB,	 B.MD_ACTIVE AS 						SAT_CONTRACT_COMPUTE_MD_ACTIVE,	 B.MD_CREATION_AUDIT_ID AS 			SAT_CONTRACT_COMPUTE_MD_CREATION_AUDIT_ID,	 B.MD_CREATION_DT AS 					SAT_CONTRACT_COMPUTE_MD_CREATION_DT,	 B.MD_EXTRACT_DT AS 					SAT_CONTRACT_COMPUTE_MD_EXTRACT_DT,	 B.MD_HASHDIFF AS 						SAT_CONTRACT_COMPUTE_MD_HASHDIFF,	 B.MD_SOURCE AS 						SAT_CONTRACT_COMPUTE_MD_SOURCE,	 B.MD_SRC_SYSTEM AS 					SAT_CONTRACT_COMPUTE_MD_SRC_SYSTEM,	 B.MD_START_DT AS 						SAT_CONTRACT_COMPUTE_MD_START_DT,	 B.PLAN_CODE AS 						SAT_CONTRACT_COMPUTE_PLAN_CODE,	 B.PLAN_LABEL AS 						SAT_CONTRACT_COMPUTE_PLAN_LABEL	 FROM DB_IAWT_"+ENV+"_DWH.SHARED_BDV.SAT_CONTRACT_COMPUTE B  LEFT JOIN SAT_CONTRACT_COMPUTE_LV A  ON A.SLV_HK_HUB = B.HK_HUB LEFT JOIN SAT_CONTRACT_COMPUTE_LV C ON C.SLV_O_MAX_MD_START_DT = B.MD_START_DT WHERE B.MD_ACTIVE = 'A' ), EXP_METADATA AS ( SELECT LINK_INVESTMENT_HK_HUB_CONTRACT, TO_DATE('"+DATA_START_DATE+"','YYYY-MM-DD') AS 		o_DATA_START_DATE, CURRENT_TIMESTAMP AS 						o_MD_CREATION_DATE, '-1' AS 									o_MD_CREATION_AUDIT_ID, MAX(SAT_LINK_INVESTMENT_MD_SOURCE) AS 		o_MAX_MD_SOURCE, MAX(SAT_LINK_INVESTMENT_MD_SRC_SYSTEM) AS 	o_MAX_MD_SRC_SYSTEM, MAX(Sat_Link_Investment_MD_EXTRACT_DT) AS 	o_MAX_MD_EXTRACT_DT, SUM(CASE WHEN SAT_LINK_INVESTMENT_AUA IS NULL THEN '0' ELSE SAT_LINK_INVESTMENT_AUA END) AS o_Account_SUM_AUA FROM JNR_SatLink_Investment_InnerJoin_Link_Investment B  LEFT JOIN JNR_SatLink_Investment_SelfJoin1 A  ON B.LINK_INVESTMENT_HK_HUB_CONTRACT = A.SAT_CONTRACT_COMPUTE_HK_HUB GROUP BY LINK_INVESTMENT_HK_HUB_CONTRACT ) SELECT LINK_INVESTMENT_HK_HUB_CONTRACT, o_DATA_START_DATE, o_MD_CREATION_DATE, o_MD_CREATION_AUDIT_ID, o_MAX_MD_SOURCE, o_MAX_MD_SRC_SYSTEM, o_MAX_MD_EXTRACT_DT, SHARED_BDV.SP_CONV_BR_ALL_ACCOUNT_AUA_SEGMENTATION_002(o_Account_SUM_AUA)['o_ACCOUNT_AUA_SEGMENT'], SHARED_BDV.SP_CONV_BR_ALL_ACCOUNT_AUA_SEGMENTATION_002(o_Account_SUM_AUA)['o_ACCOUNT_AUA_SEGMENT_ORDER'] FROM EXP_METADATA);";
try {
...
CREATE OR REPLACE FUNCTION DB_IAWT_DEV_DWH.SHARED_BDV.SP_CONV_BR_ALL_ACCOUNT_AUA_SEGMENTATION_002(I_ACCOUNT_SUM_AUA FLOAT)
RETURNS OBJECT
LANGUAGE JAVASCRIPT
AS '  
